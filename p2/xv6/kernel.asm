...
80100046:	e8 c5 3b 00 00       	call   80103c10 <acquire>
...
8010007c:	e8 f4 3b 00 00       	call   80103c75 <release>
      acquiresleep(&b->lock);
80100081:	8d 43 0c             	lea    0xc(%ebx),%eax
80100084:	89 04 24             	mov    %eax,(%esp)
80100087:	e8 70 39 00 00       	call   801039fc <acquiresleep>
      return b;
...
801000ca:	e8 a6 3b 00 00       	call   80103c75 <release>
      acquiresleep(&b->lock);
801000cf:	8d 43 0c             	lea    0xc(%ebx),%eax
801000d2:	89 04 24             	mov    %eax,(%esp)
801000d5:	e8 22 39 00 00       	call   801039fc <acquiresleep>
      return b;
...
80100105:	e8 ca 39 00 00       	call   80103ad4 <initlock>
...
80100143:	e8 81 38 00 00       	call   801039c9 <initsleeplock>
...
801001a8:	e8 d9 38 00 00       	call   80103a86 <holdingsleep>
...
801001e4:	e8 9d 38 00 00       	call   80103a86 <holdingsleep>
...
801001f4:	e8 52 38 00 00       	call   80103a4b <releasesleep>

  acquire(&bcache.lock);
801001f9:	c7 04 24 c0 a5 10 80 	movl   $0x8010a5c0,(%esp)
80100200:	e8 0b 3a 00 00       	call   80103c10 <acquire>
  b->refcnt--;
...
8010024c:	e8 24 3a 00 00       	call   80103c75 <release>
}
...
8010028a:	e8 81 39 00 00       	call   80103c10 <acquire>
  while(n > 0){
...
801002d1:	e8 9f 39 00 00       	call   80103c75 <release>
        ilock(ip);
...
80100331:	e8 3f 39 00 00       	call   80103c75 <release>
  ilock(ip);
...
80100373:	e8 93 02 00 00       	call   8010060b <cprintf>
  cprintf("\n");
80100378:	c7 04 24 7f 6e 10 80 	movl   $0x80106e7f,(%esp)
...
8010038f:	e8 5b 37 00 00       	call   80103aef <getcallerpcs>
  for(i=0; i<10; i++)
...
801004ba:	e8 78 38 00 00       	call   80103d37 <memmove>
    pos -= 80;
...
801004d9:	e8 de 37 00 00       	call   80103cbc <memset>
...
80100506:	e8 d8 4b 00 00       	call   801050e3 <uartputc>
...
8010051f:	e8 bf 4b 00 00       	call   801050e3 <uartputc>
80100524:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
8010052b:	e8 b3 4b 00 00       	call   801050e3 <uartputc>
80100530:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
80100537:	e8 a7 4b 00 00       	call   801050e3 <uartputc>
...
801005ca:	e8 41 36 00 00       	call   80103c10 <acquire>
  for(i = 0; i < n; i++)
...
801005f1:	e8 7f 36 00 00       	call   80103c75 <release>
  ilock(ip);
...
80100638:	e8 d3 35 00 00       	call   80103c10 <acquire>
...
80100734:	e8 3c 35 00 00       	call   80103c75 <release>
...
8010074f:	e8 bc 34 00 00       	call   80103c10 <acquire>
  while((c = getc()) >= 0){
...
80100873:	e8 fd 33 00 00       	call   80103c75 <release>
  if(doprocdump) {
...
8010089e:	e8 31 32 00 00       	call   80103ad4 <initlock>
...
80100970:	75 b2                	jne    80100924 <exec+0x52>
  if((pgdir = setupkvm()) == 0)
80100972:	e8 2c 59 00 00       	call   801062a3 <setupkvm>
...
80100a06:	e8 3e 57 00 00       	call   80106149 <allocuvm>
...
80100a38:	e8 da 55 00 00       	call   80106017 <loaduvm>
...
80100a74:	e8 d0 56 00 00       	call   80106149 <allocuvm>
...
80100a9d:	e8 91 57 00 00       	call   80106233 <freevm>
...
80100abc:	e8 67 58 00 00       	call   80106328 <clearpteu>
...
80100ae2:	e8 77 33 00 00       	call   80103e5e <strlen>
...
80100af4:	e8 65 33 00 00       	call   80103e5e <strlen>
80100af9:	83 c0 01             	add    $0x1,%eax
80100afc:	50                   	push   %eax
80100afd:	ff 36                	pushl  (%esi)
80100aff:	57                   	push   %edi
80100b00:	ff b5 ec fe ff ff    	pushl  -0x114(%ebp)
80100b06:	e8 6b 59 00 00       	call   80106476 <copyout>
...
80100b66:	e8 0b 59 00 00       	call   80106476 <copyout>
...
80100ba3:	e8 7b 32 00 00       	call   80103e23 <safestrcpy>
...
80100bd1:	e8 c0 52 00 00       	call   80105e96 <switchuvm>
  freevm(oldpgdir);
80100bd6:	89 1c 24             	mov    %ebx,(%esp)
80100bd9:	e8 55 56 00 00       	call   80106233 <freevm>
  return 0;
...
80100c23:	e8 ac 2e 00 00       	call   80103ad4 <initlock>
}
...
80100c39:	e8 d2 2f 00 00       	call   80103c10 <acquire>
...
80100c68:	e8 08 30 00 00       	call   80103c75 <release>
      return f;
...
80100c7f:	e8 f1 2f 00 00       	call   80103c75 <release>
  return 0;
...
80100c9d:	e8 6e 2f 00 00       	call   80103c10 <acquire>
  if(f->ref < 1)
...
80100cba:	e8 b6 2f 00 00       	call   80103c75 <release>
  return f;
}
...
80100ce2:	e8 29 2f 00 00       	call   80103c10 <acquire>
  if(f->ref < 1)
...
80100d03:	e8 6d 2f 00 00       	call   80103c75 <release>
    return;
...
80100d49:	e8 27 2f 00 00       	call   80103c75 <release>
  if(ff.type == FD_PIPE)
...
80100f8a:	e8 a8 2d 00 00       	call   80103d37 <memmove>
...
80100f9a:	e8 98 2d 00 00       	call   80103d37 <memmove>
    name[len] = 0;
...
80100fdf:	e8 d8 2c 00 00       	call   80103cbc <memset>
  log_write(bp);
...
8010119a:	e8 71 2a 00 00       	call   80103c10 <acquire>
...
801011e1:	e8 8f 2a 00 00       	call   80103c75 <release>
      return ip;
...
80101217:	e8 59 2a 00 00       	call   80103c75 <release>
  return ip;
...
80101255:	e8 dd 2a 00 00       	call   80103d37 <memmove>
  brelse(bp);
...
801012fd:	e8 d2 27 00 00       	call   80103ad4 <initlock>
  for(i = 0; i < NINODE; i++) {
...
80101322:	e8 a2 26 00 00       	call   801039c9 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801013f1:	e8 c6 28 00 00       	call   80103cbc <memset>
      dip->type = type;
...
80101480:	e8 b2 28 00 00       	call   80103d37 <memmove>
  log_write(bp);
...
80101560:	e8 ab 26 00 00       	call   80103c10 <acquire>
  ip->ref++;
...
80101575:	e8 fb 26 00 00       	call   80103c75 <release>
}
...
8010159a:	e8 5d 24 00 00       	call   801039fc <acquiresleep>
  if(ip->valid == 0){
...
80101614:	e8 1e 27 00 00       	call   80103d37 <memmove>
    brelse(bp);
...
80101656:	e8 2b 24 00 00       	call   80103a86 <holdingsleep>
...
8010166c:	e8 da 23 00 00       	call   80103a4b <releasesleep>
}
...
80101698:	e8 5f 23 00 00       	call   801039fc <acquiresleep>
...
801016b1:	e8 95 23 00 00       	call   80103a4b <releasesleep>
  acquire(&icache.lock);
801016b6:	c7 04 24 e0 f9 10 80 	movl   $0x8010f9e0,(%esp)
801016bd:	e8 4e 25 00 00       	call   80103c10 <acquire>
  ip->ref--;
...
801016d2:	e8 9e 25 00 00       	call   80103c75 <release>
}
...
801016ea:	e8 21 25 00 00       	call   80103c10 <acquire>
    int r = ip->ref;
801016ef:	8b 7b 08             	mov    0x8(%ebx),%edi
    release(&icache.lock);
801016f2:	c7 04 24 e0 f9 10 80 	movl   $0x8010f9e0,(%esp)
801016f9:	e8 77 25 00 00       	call   80103c75 <release>
    if(r == 1){
...
8010182a:	e8 08 25 00 00       	call   80103d37 <memmove>
    brelse(bp);
...
80101926:	e8 0c 24 00 00       	call   80103d37 <memmove>
    log_write(bp);
...
801019a9:	e8 f0 23 00 00       	call   80103d9e <strncmp>
}
801019ae:	c9                   	leave  
801019af:	c3                   	ret    
...
80101ba9:	e8 2d 22 00 00       	call   80103ddb <strncpy>
  de.inum = inum;
...
80101bd7:	68 78 6c 10 80       	push   $0x80106c78
...
80101d10:	e8 bf 1d 00 00       	call   80103ad4 <initlock>
...
80101d80:	e8 8b 1e 00 00       	call   80103c10 <acquire>
...
80101dcb:	e8 a5 1e 00 00       	call   80103c75 <release>
...
80101de2:	e8 8e 1e 00 00       	call   80103c75 <release>
    return;
...
80101e1a:	e8 67 1c 00 00       	call   80103a86 <holdingsleep>
...
80101e47:	e8 c4 1d 00 00       	call   80103c10 <acquire>
...
80101ec3:	e8 ad 1d 00 00       	call   80103c75 <release>
}
...
80101fd6:	e8 e1 1c 00 00       	call   80103cbc <memset>
...
80102017:	e8 f4 1b 00 00       	call   80103c10 <acquire>
8010201c:	83 c4 10             	add    $0x10,%esp
8010201f:	eb c6                	jmp    80101fe7 <kfree+0x43>
    release(&kmem.lock);
80102021:	83 ec 0c             	sub    $0xc,%esp
80102024:	68 40 16 11 80       	push   $0x80111640
80102029:	e8 47 1c 00 00       	call   80103c75 <release>
...
80102079:	e8 56 1a 00 00       	call   80103ad4 <initlock>
  kmem.use_lock = 0;
...
80102150:	0f b6 8a a0 68 10 80 	movzbl -0x7fef9760(%edx),%ecx
80102157:	0b 0d b4 95 10 80    	or     0x801095b4,%ecx
  shift ^= togglecode[data];
8010215d:	0f b6 82 a0 67 10 80 	movzbl -0x7fef9860(%edx),%eax
...
80102171:	8b 04 85 80 67 10 80 	mov    -0x7fef9880(,%eax,4),%eax
...
801021a9:	83 e2 7f             	and    $0x7f,%edx
    shift &= ~(shiftcode[data] | E0ESC);
801021ac:	0f b6 82 a0 68 10 80 	movzbl -0x7fef9760(%edx),%eax
...
80102497:	e8 66 18 00 00       	call   80103d02 <memcmp>
...
80102602:	e8 30 17 00 00       	call   80103d37 <memmove>
...
80102701:	e8 31 16 00 00       	call   80103d37 <memmove>
...
8010276f:	68 a0 69 10 80       	push   $0x801069a0
80102774:	68 80 16 11 80       	push   $0x80111680
80102779:	e8 56 13 00 00       	call   80103ad4 <initlock>
  readsb(dev, &sb);
...
801027b9:	e8 52 14 00 00       	call   80103c10 <acquire>
...
8010281e:	e8 52 14 00 00       	call   80103c75 <release>
}
...
80102834:	e8 d7 13 00 00       	call   80103c10 <acquire>
  log.outstanding -= 1;
...
8010286e:	e8 02 14 00 00       	call   80103c75 <release>
  if(do_commit){
...
80102882:	68 a4 69 10 80       	push   $0x801069a4
...
801028ab:	e8 60 13 00 00       	call   80103c10 <acquire>
    log.committing = 0;
...
801028cd:	e8 a3 13 00 00       	call   80103c75 <release>
...
80102909:	e8 02 13 00 00       	call   80103c10 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102934:	68 b3 69 10 80       	push   $0x801069b3
80102939:	e8 0a da ff ff       	call   80100348 <panic>
    panic("log_write outside of trans");
8010293e:	83 ec 0c             	sub    $0xc,%esp
80102941:	68 c9 69 10 80       	push   $0x801069c9
...
80102964:	e8 0c 13 00 00       	call   80103c75 <release>
}
...
80102992:	e8 a0 13 00 00       	call   80103d37 <memmove>
...
80102a23:	68 e4 69 10 80       	push   $0x801069e4
80102a28:	e8 de db ff ff       	call   8010060b <cprintf>
  idtinit();       // load idt register
80102a2d:	e8 49 24 00 00       	call   80104e7b <idtinit>
...
80102a4d:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102a50:	e8 2f 34 00 00       	call   80105e84 <switchkvm>
  seginit();
80102a55:	e8 de 32 00 00       	call   80105d38 <seginit>
  lapicinit();
...
80102aa7:	e8 7d 26 00 00       	call   80105129 <uartinit>
  pinit();         // process table
80102aac:	e8 b4 06 00 00       	call   80103165 <pinit>
  tvinit();        // trap vectors
80102ab1:	e8 14 23 00 00       	call   80104dca <tvinit>
  binit();         // buffer cache
...
80102b27:	68 f8 69 10 80       	push   $0x801069f8
80102b2c:	53                   	push   %ebx
80102b2d:	e8 d0 11 00 00       	call   80103d02 <memcmp>
...
80102bec:	68 fd 69 10 80       	push   $0x801069fd
80102bf1:	56                   	push   %esi
80102bf2:	e8 0b 11 00 00       	call   80103d02 <memcmp>
...
80102c88:	68 02 6a 10 80       	push   $0x80106a02
...
80102cc7:	ff 24 85 3c 6a 10 80 	jmp    *-0x7fef95c4(,%eax,4)
      continue;
    case MPIOAPIC:
...
80102d15:	68 1c 6a 10 80       	push   $0x80106a1c
...
80102dd1:	68 50 6a 10 80       	push   $0x80106a50
80102dd6:	50                   	push   %eax
80102dd7:	e8 f8 0c 00 00       	call   80103ad4 <initlock>
  (*f0)->type = FD_PIPE;
...
80102e2d:	e8 de 0d 00 00       	call   80103c10 <acquire>
  if(writable){
...
80102e6d:	e8 03 0e 00 00       	call   80103c75 <release>
...
80102e9c:	e8 d4 0d 00 00       	call   80103c75 <release>
    kfree((char*)p);
...
80102ebd:	e8 4e 0d 00 00       	call   80103c10 <acquire>
  for(i = 0; i < n; i++){
...
80102f24:	e8 4c 0d 00 00       	call   80103c75 <release>
        return -1;
...
80102f6d:	e8 03 0d 00 00       	call   80103c75 <release>
  return n;
...
80102f89:	e8 82 0c 00 00       	call   80103c10 <acquire>
...
80102fcd:	e8 a3 0c 00 00       	call   80103c75 <release>
      return -1;
...
80103024:	e8 4c 0c 00 00       	call   80103c75 <release>
  return i;
...
8010306d:	e8 9e 0b 00 00       	call   80103c10 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
...
80103095:	e8 db 0b 00 00       	call   80103c75 <release>
  return 0;
...
801030c4:	e8 ac 0b 00 00       	call   80103c75 <release>
...
801030e1:	c7 80 b0 0f 00 00 bf 	movl   $0x80104dbf,0xfb0(%eax)
801030e8:	4d 10 80 
  sp -= sizeof *p->context;
...
801030fb:	e8 bc 0b 00 00       	call   80103cbc <memset>
...
8010312d:	e8 43 0b 00 00       	call   80103c75 <release>
  if (first) {
...
8010316b:	68 55 6a 10 80       	push   $0x80106a55
80103170:	68 20 1d 11 80       	push   $0x80111d20
80103175:	e8 5a 09 00 00       	call   80103ad4 <initlock>
}
...
801031b7:	68 38 6b 10 80       	push   $0x80106b38
801031bc:	e8 87 d1 ff ff       	call   80100348 <panic>
  panic("unknown apicid\n");
801031c1:	83 ec 0c             	sub    $0xc,%esp
801031c4:	68 5c 6a 10 80       	push   $0x80106a5c
...
801031fa:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801031fd:	e8 31 09 00 00       	call   80103b33 <pushcli>
  c = mycpu();
80103202:	e8 78 ff ff ff       	call   8010317f <mycpu>
  p = c->proc;
80103207:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010320d:	e8 5e 09 00 00       	call   80103b70 <popcli>
}
...
8010322d:	e8 71 30 00 00       	call   801062a3 <setupkvm>
...
8010324b:	e8 5e 2d 00 00       	call   80105fae <inituvm>
  p->sz = PGSIZE;
...
80103260:	e8 57 0a 00 00       	call   80103cbc <memset>
...
801032b3:	68 85 6a 10 80       	push   $0x80106a85
801032b8:	50                   	push   %eax
801032b9:	e8 65 0b 00 00       	call   80103e23 <safestrcpy>
  p->cwd = namei("/");
801032be:	c7 04 24 8e 6a 10 80 	movl   $0x80106a8e,(%esp)
...
801032f7:	68 6c 6a 10 80       	push   $0x80106a6c
...
80103324:	e8 8e 2d 00 00       	call   801060b7 <deallocuvm>
...
80103341:	e8 03 2e 00 00       	call   80106149 <allocuvm>
...
80103353:	e8 3e 2b 00 00       	call   80105e96 <switchuvm>
  return 0;
...
80103398:	e8 b7 2f 00 00       	call   80106354 <copyuvm>
...
801034a8:	e8 e9 29 00 00       	call   80105e96 <switchuvm>
      p->state = RUNNING;
...
801034be:	e8 b3 09 00 00       	call   80103e76 <swtch>
      switchkvm();
801034c3:	e8 bc 29 00 00       	call   80105e84 <switchkvm>
      c->proc = 0;
...
801034df:	e8 91 07 00 00       	call   80103c75 <release>
    sti();
...
801034f0:	e8 1b 07 00 00       	call   80103c10 <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103513:	e8 b8 06 00 00       	call   80103bd0 <holding>
...
80103554:	e8 1d 09 00 00       	call   80103e76 <swtch>
  mycpu()->intena = intena;
...
801035c0:	68 d0 6a 10 80       	push   $0x80106ad0
...
80103613:	e8 f8 05 00 00       	call   80103c10 <acquire>
...
8010365e:	68 dd 6a 10 80       	push   $0x80106add
...
80103673:	e8 98 05 00 00       	call   80103c10 <acquire>
...
80103690:	e8 e0 05 00 00       	call   80103c75 <release>
}
...
801036c1:	e8 4a 05 00 00       	call   80103c10 <acquire>
    release(lk);
801036c6:	89 1c 24             	mov    %ebx,(%esp)
801036c9:	e8 a7 05 00 00       	call   80103c75 <release>
...
801036fa:	e8 76 05 00 00       	call   80103c75 <release>
    acquire(lk);
801036ff:	89 1c 24             	mov    %ebx,(%esp)
80103702:	e8 09 05 00 00       	call   80103c10 <acquire>
...
80103714:	68 e9 6a 10 80       	push   $0x80106ae9
80103719:	e8 2a cc ff ff       	call   80100348 <panic>
    panic("sleep without lk");
8010371e:	83 ec 0c             	sub    $0xc,%esp
80103721:	68 ef 6a 10 80       	push   $0x80106aef
...
8010373f:	e8 cc 04 00 00       	call   80103c10 <acquire>
...
8010376e:	e8 c0 2a 00 00       	call   80106233 <freevm>
        p->pid = 0;
...
8010379a:	e8 d6 04 00 00       	call   80103c75 <release>
        return pid;
...
801037da:	e8 96 04 00 00       	call   80103c75 <release>
      return -1;
...
80103837:	e8 d4 03 00 00       	call   80103c10 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
8010386a:	e8 06 04 00 00       	call   80103c75 <release>
      return 0;
...
8010388d:	e8 e3 03 00 00       	call   80103c75 <release>
  return -1;
...
801038ce:	68 7f 6e 10 80       	push   $0x80106e7f
...
801038f2:	8b 04 85 60 6b 10 80 	mov    -0x7fef94a0(,%eax,4),%eax
801038f9:	85 c0                	test   %eax,%eax
801038fb:	75 b3                	jne    801038b0 <procdump+0x14>
      state = "???";
801038fd:	b8 00 6b 10 80       	mov    $0x80106b00,%eax
...
80103915:	e8 d5 01 00 00       	call   80103aef <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
80103928:	68 41 65 10 80       	push   $0x80106541
...
80103952:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc* p;
  int nf = 0;
80103955:	b8 00 00 00 00       	mov    $0x0,%eax
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010395a:	b9 54 1d 11 80       	mov    $0x80111d54,%ecx
8010395f:	eb 17                	jmp    80103978 <getofilecnt+0x2a>
    if(p->pid == id){
      for(int i = 0; i < NOFILE; i++){
80103961:	83 c2 01             	add    $0x1,%edx
80103964:	83 fa 0f             	cmp    $0xf,%edx
80103967:	7f 0c                	jg     80103975 <getofilecnt+0x27>
        if(p->ofile[i]) nf++;
80103969:	83 7c 91 28 00       	cmpl   $0x0,0x28(%ecx,%edx,4)
8010396e:	74 f1                	je     80103961 <getofilecnt+0x13>
80103970:	83 c0 01             	add    $0x1,%eax
80103973:	eb ec                	jmp    80103961 <getofilecnt+0x13>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103975:	83 c1 7c             	add    $0x7c,%ecx
80103978:	81 f9 54 3c 11 80    	cmp    $0x80113c54,%ecx
8010397e:	73 0c                	jae    8010398c <getofilecnt+0x3e>
    if(p->pid == id){
80103980:	39 59 10             	cmp    %ebx,0x10(%ecx)
80103983:	75 f0                	jne    80103975 <getofilecnt+0x27>
      for(int i = 0; i < NOFILE; i++){
80103985:	ba 00 00 00 00       	mov    $0x0,%edx
8010398a:	eb d8                	jmp    80103964 <getofilecnt+0x16>
      }
    }
  }
  return nf;
...
8010398f <getofilenext>:

//return next file descriptor when create
int
getofilenext(int id)
{ 
8010398f:	55                   	push   %ebp
80103990:	89 e5                	mov    %esp,%ebp
80103992:	8b 4d 08             	mov    0x8(%ebp),%ecx
  struct proc* p;
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103995:	ba 54 1d 11 80       	mov    $0x80111d54,%edx
8010399a:	eb 03                	jmp    8010399f <getofilenext+0x10>
8010399c:	83 c2 7c             	add    $0x7c,%edx
8010399f:	81 fa 54 3c 11 80    	cmp    $0x80113c54,%edx
801039a5:	73 1b                	jae    801039c2 <getofilenext+0x33>
    if(p->pid == id){
801039a7:	39 4a 10             	cmp    %ecx,0x10(%edx)
801039aa:	75 f0                	jne    8010399c <getofilenext+0xd>
      for(int i = 0; i < NOFILE; i++){
801039ac:	b8 00 00 00 00       	mov    $0x0,%eax
801039b1:	83 f8 0f             	cmp    $0xf,%eax
801039b4:	7f e6                	jg     8010399c <getofilenext+0xd>
        if(p->ofile[i] == 0){
801039b6:	83 7c 82 28 00       	cmpl   $0x0,0x28(%edx,%eax,4)
801039bb:	74 0a                	je     801039c7 <getofilenext+0x38>
      for(int i = 0; i < NOFILE; i++){
801039bd:	83 c0 01             	add    $0x1,%eax
801039c0:	eb ef                	jmp    801039b1 <getofilenext+0x22>
	  return i;
	}
      }
    }
  ...
  return -1;
801039c2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
801039c7:	5d                   	pop    %ebp
801039c8:	c3                   	ret    

801039c9 <initsleeplock>:
#include "spinlock.h"
#include "sleeplock.h"
...
801039d0:	8b 5d 08             	mov    0x8(%ebp),%ebx
  initlock(&lk->lk, "sleep lock");
801039d3:	68 78 6b 10 80       	push   $0x80106b78
801039d8:	8d 43 04             	lea    0x4(%ebx),%eax
801039db:	50                   	push   %eax
801039dc:	e8 f3 00 00 00       	call   80103ad4 <initlock>
  lk->name = name;
801039e1:	8b 45 0c             	mov    0xc(%ebp),%eax
801039e4:	89 43 38             	mov    %eax,0x38(%ebx)
  lk->locked = 0;
801039e7:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
801039ed:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
}
...
80103a01:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&lk->lk);
80103a04:	8d 73 04             	lea    0x4(%ebx),%esi
80103a07:	83 ec 0c             	sub    $0xc,%esp
80103a0a:	56                   	push   %esi
80103a0b:	e8 00 02 00 00       	call   80103c10 <acquire>
  while (lk->locked) {
80103a10:	83 c4 10             	add    $0x10,%esp
80103a13:	eb 0d                	jmp    80103a22 <acquiresleep+0x26>
    sleep(lk, &lk->lk);
80103a15:	83 ec 08             	sub    $0x8,%esp
80103a18:	56                   	push   %esi
80103a19:	53                   	push   %ebx
80103a1a:	e8 7b fc ff ff       	call   8010369a <sleep>
80103a1f:	83 c4 10             	add    $0x10,%esp
  while (lk->locked) {
80103a22:	83 3b 00             	cmpl   $0x0,(%ebx)
80103a25:	75 ee                	jne    80103a15 <acquiresleep+0x19>
  }
  lk->locked = 1;
80103a27:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80103a2d:	e8 c4 f7 ff ff       	call   801031f6 <myproc>
80103a32:	8b 40 10             	mov    0x10(%eax),%eax
80103a35:	89 43 3c             	mov    %eax,0x3c(%ebx)
  release(&lk->lk);
80103a38:	83 ec 0c             	sub    $0xc,%esp
80103a3b:	56                   	push   %esi
80103a3c:	e8 34 02 00 00       	call   80103c75 <release>
}
...
80103a5a:	e8 b1 01 00 00       	call   80103c10 <acquire>
  lk->locked = 0;
80103a5f:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
80103a65:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  wakeup(lk);
80103a6c:	89 1c 24             	mov    %ebx,(%esp)
80103a6f:	e8 8b fd ff ff       	call   801037ff <wakeup>
  release(&lk->lk);
80103a74:	89 34 24             	mov    %esi,(%esp)
80103a77:	e8 f9 01 00 00       	call   80103c75 <release>
}
...
80103a8b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  int r;
  
  acquire(&lk->lk);
80103a8e:	8d 73 04             	lea    0x4(%ebx),%esi
80103a91:	83 ec 0c             	sub    $0xc,%esp
80103a94:	56                   	push   %esi
80103a95:	e8 76 01 00 00       	call   80103c10 <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
80103a9a:	83 c4 10             	add    $0x10,%esp
80103a9d:	83 3b 00             	cmpl   $0x0,(%ebx)
80103aa0:	75 17                	jne    80103ab9 <holdingsleep+0x33>
80103aa2:	bb 00 00 00 00       	mov    $0x0,%ebx
  release(&lk->lk);
80103aa7:	83 ec 0c             	sub    $0xc,%esp
80103aaa:	56                   	push   %esi
80103aab:	e8 c5 01 00 00       	call   80103c75 <release>
  return r;
}
...
80103ab8:	c3                   	ret    
  r = lk->locked && (lk->pid == myproc()->pid);
80103ab9:	8b 5b 3c             	mov    0x3c(%ebx),%ebx
80103abc:	e8 35 f7 ff ff       	call   801031f6 <myproc>
80103ac1:	3b 58 10             	cmp    0x10(%eax),%ebx
80103ac4:	74 07                	je     80103acd <holdingsleep+0x47>
80103ac6:	bb 00 00 00 00       	mov    $0x0,%ebx
80103acb:	eb da                	jmp    80103aa7 <holdingsleep+0x21>
80103acd:	bb 01 00 00 00       	mov    $0x1,%ebx
80103ad2:	eb d3                	jmp    80103aa7 <holdingsleep+0x21>
...
80103add:	89 50 04             	mov    %edx,0x4(%eax)
  lk->locked = 0;
80103ae0:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->cpu = 0;
80103ae6:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
80103aed:	5d                   	pop    %ebp
80103aee:	c3                   	ret    

80103aef <getcallerpcs>:
}
...
80103af3:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  uint *ebp;
  int i;

  ebp = (uint*)v - 2;
80103af6:	8b 45 08             	mov    0x8(%ebp),%eax
80103af9:	8d 50 f8             	lea    -0x8(%eax),%edx
  for(i = 0; i < 10; i++){
80103afc:	b8 00 00 00 00       	mov    $0x0,%eax
80103b01:	83 f8 09             	cmp    $0x9,%eax
80103b04:	7f 25                	jg     80103b2b <getcallerpcs+0x3c>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80103b06:	8d 9a 00 00 00 80    	lea    -0x80000000(%edx),%ebx
80103b0c:	81 fb fe ff ff 7f    	cmp    $0x7ffffffe,%ebx
80103b12:	77 17                	ja     80103b2b <getcallerpcs+0x3c>
      break;
    pcs[i] = ebp[1];     // saved %eip
80103b14:	8b 5a 04             	mov    0x4(%edx),%ebx
80103b17:	89 1c 81             	mov    %ebx,(%ecx,%eax,4)
    ebp = (uint*)ebp[0]; // saved %ebp
80103b1a:	8b 12                	mov    (%edx),%edx
  for(i = 0; i < 10; i++){
80103b1c:	83 c0 01             	add    $0x1,%eax
80103b1f:	eb e0                	jmp    80103b01 <getcallerpcs+0x12>
  }
  for(; i < 10; i++)
    pcs[i] = 0;
80103b21:	c7 04 81 00 00 00 00 	movl   $0x0,(%ecx,%eax,4)
  for(; i < 10; i++)
80103b28:	83 c0 01             	add    $0x1,%eax
80103b2b:	83 f8 09             	cmp    $0x9,%eax
80103b2e:	7e f1                	jle    80103b21 <getcallerpcs+0x32>
}
80103b30:	5b                   	pop    %ebx
80103b31:	5d                   	pop    %ebp
80103b32:	c3                   	ret    
...
80103b3c:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
80103b3d:	e8 3d f6 ff ff       	call   8010317f <mycpu>
80103b42:	83 b8 a4 00 00 00 00 	cmpl   $0x0,0xa4(%eax)
80103b49:	74 12                	je     80103b5d <pushcli+0x2a>
    mycpu()->intena = eflags & FL_IF;
  mycpu()->ncli += 1;
80103b4b:	e8 2f f6 ff ff       	call   8010317f <mycpu>
80103b50:	83 80 a4 00 00 00 01 	addl   $0x1,0xa4(%eax)
}
80103b57:	83 c4 04             	add    $0x4,%esp
80103b5a:	5b                   	pop    %ebx
80103b5b:	5d                   	pop    %ebp
80103b5c:	c3                   	ret    
    mycpu()->intena = eflags & FL_IF;
80103b5d:	e8 1d f6 ff ff       	call   8010317f <mycpu>
80103b62:	81 e3 00 02 00 00    	and    $0x200,%ebx
80103b68:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
80103b6e:	eb db                	jmp    80103b4b <pushcli+0x18>
...
80103b7b:	75 28                	jne    80103ba5 <popcli+0x35>
  ...
  if(--mycpu()->ncli < 0)
80103b7d:	e8 fd f5 ff ff       	call   8010317f <mycpu>
...
80103b95:	e8 e5 f5 ff ff       	call   8010317f <mycpu>
...
80103ba8:	68 83 6b 10 80       	push   $0x80106b83
80103bad:	e8 96 c7 ff ff       	call   80100348 <panic>
    panic("popcli");
80103bb2:	83 ec 0c             	sub    $0xc,%esp
80103bb5:	68 9a 6b 10 80       	push   $0x80106b9a
...
80103bd7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
80103bda:	e8 54 ff ff ff       	call   80103b33 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
80103bdf:	83 3b 00             	cmpl   $0x0,(%ebx)
80103be2:	75 12                	jne    80103bf6 <holding+0x26>
80103be4:	bb 00 00 00 00       	mov    $0x0,%ebx
  popcli();
80103be9:	e8 82 ff ff ff       	call   80103b70 <popcli>
}
80103bee:	89 d8                	mov    %ebx,%eax
80103bf0:	83 c4 04             	add    $0x4,%esp
80103bf3:	5b                   	pop    %ebx
80103bf4:	5d                   	pop    %ebp
80103bf5:	c3                   	ret    
  r = lock->locked && lock->cpu == mycpu();
80103bf6:	8b 5b 08             	mov    0x8(%ebx),%ebx
80103bf9:	e8 81 f5 ff ff       	call   8010317f <mycpu>
80103bfe:	39 c3                	cmp    %eax,%ebx
80103c00:	74 07                	je     80103c09 <holding+0x39>
80103c02:	bb 00 00 00 00       	mov    $0x0,%ebx
80103c07:	eb e0                	jmp    80103be9 <holding+0x19>
80103c09:	bb 01 00 00 00       	mov    $0x1,%ebx
80103c0e:	eb d9                	jmp    80103be9 <holding+0x19>
...
80103c17:	e8 17 ff ff ff       	call   80103b33 <pushcli>
  if(holding(lk))
80103c1c:	83 ec 0c             	sub    $0xc,%esp
80103c1f:	ff 75 08             	pushl  0x8(%ebp)
80103c22:	e8 a9 ff ff ff       	call   80103bd0 <holding>
80103c27:	83 c4 10             	add    $0x10,%esp
80103c2a:	85 c0                	test   %eax,%eax
80103c2c:	75 3a                	jne    80103c68 <acquire+0x58>
  while(xchg(&lk->locked, 1) != 0)
80103c2e:	8b 55 08             	mov    0x8(%ebp),%edx
  asm volatile("lock; xchgl %0, %1" :
80103c31:	b8 01 00 00 00       	mov    $0x1,%eax
80103c36:	f0 87 02             	lock xchg %eax,(%edx)
80103c39:	85 c0                	test   %eax,%eax
80103c3b:	75 f1                	jne    80103c2e <acquire+0x1e>
  __sync_synchronize();
80103c3d:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  lk->cpu = mycpu();
80103c42:	8b 5d 08             	mov    0x8(%ebp),%ebx
80103c45:	e8 35 f5 ff ff       	call   8010317f <mycpu>
80103c4a:	89 43 08             	mov    %eax,0x8(%ebx)
  getcallerpcs(&lk, lk->pcs);
80103c4d:	8b 45 08             	mov    0x8(%ebp),%eax
80103c50:	83 c0 0c             	add    $0xc,%eax
80103c53:	83 ec 08             	sub    $0x8,%esp
80103c56:	50                   	push   %eax
80103c57:	8d 45 08             	lea    0x8(%ebp),%eax
80103c5a:	50                   	push   %eax
80103c5b:	e8 8f fe ff ff       	call   80103aef <getcallerpcs>
}
80103c60:	83 c4 10             	add    $0x10,%esp
80103c63:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80103c66:	c9                   	leave  
80103c67:	c3                   	ret    
    panic("acquire");
80103c68:	83 ec 0c             	sub    $0xc,%esp
80103c6b:	68 a1 6b 10 80       	push   $0x80106ba1
80103c70:	e8 d3 c6 ff ff       	call   80100348 <panic>
...
80103c80:	e8 4b ff ff ff       	call   80103bd0 <holding>
80103c85:	83 c4 10             	add    $0x10,%esp
80103c88:	85 c0                	test   %eax,%eax
80103c8a:	74 23                	je     80103caf <release+0x3a>
  lk->pcs[0] = 0;
80103c8c:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
80103c93:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
80103c9a:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
80103c9f:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  popcli();
80103ca5:	e8 c6 fe ff ff       	call   80103b70 <popcli>
}
...
80103cb2:	68 a9 6b 10 80       	push   $0x80106ba9
80103cb7:	e8 8c c6 ff ff       	call   80100348 <panic>
...
80103cbf:	57                   	push   %edi
80103cc0:	53                   	push   %ebx
80103cc1:	8b 55 08             	mov    0x8(%ebp),%edx
80103cc4:	8b 4d 10             	mov    0x10(%ebp),%ecx
  if ((int)dst%4 == 0 && n%4 == 0){
80103cc7:	f6 c2 03             	test   $0x3,%dl
80103cca:	75 05                	jne    80103cd1 <memset+0x15>
80103ccc:	f6 c1 03             	test   $0x3,%cl
80103ccf:	74 0e                	je     80103cdf <memset+0x23>
  asm volatile("cld; rep stosb" :
80103cd1:	89 d7                	mov    %edx,%edi
80103cd3:	8b 45 0c             	mov    0xc(%ebp),%eax
80103cd6:	fc                   	cld    
80103cd7:	f3 aa                	rep stos %al,%es:(%edi)
    c &= 0xFF;
...
80103cd9:	89 d0                	mov    %edx,%eax
80103cdb:	5b                   	pop    %ebx
80103cdc:	5f                   	pop    %edi
80103cdd:	5d                   	pop    %ebp
80103cde:	c3                   	ret    
    c &= 0xFF;
80103cdf:	0f b6 7d 0c          	movzbl 0xc(%ebp),%edi
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80103ce3:	c1 e9 02             	shr    $0x2,%ecx
80103ce6:	89 f8                	mov    %edi,%eax
80103ce8:	c1 e0 18             	shl    $0x18,%eax
80103ceb:	89 fb                	mov    %edi,%ebx
80103ced:	c1 e3 10             	shl    $0x10,%ebx
80103cf0:	09 d8                	or     %ebx,%eax
80103cf2:	89 fb                	mov    %edi,%ebx
80103cf4:	c1 e3 08             	shl    $0x8,%ebx
80103cf7:	09 d8                	or     %ebx,%eax
80103cf9:	09 f8                	or     %edi,%eax
  asm volatile("cld; rep stosl" :
80103cfb:	89 d7                	mov    %edx,%edi
80103cfd:	fc                   	cld    
80103cfe:	f3 ab                	rep stos %eax,%es:(%edi)
80103d00:	eb d7                	jmp    80103cd9 <memset+0x1d>
...
80103d0a:	8b 55 0c             	mov    0xc(%ebp),%edx
80103d0d:	8b 45 10             	mov    0x10(%ebp),%eax
  const uchar *s1, *s2;

  s1 = v1;
  s2 = v2;
  while(n-- > 0){
80103d10:	8d 70 ff             	lea    -0x1(%eax),%esi
80103d13:	85 c0                	test   %eax,%eax
80103d15:	74 1c                	je     80103d33 <memcmp+0x31>
    if(*s1 != *s2)
80103d17:	0f b6 01             	movzbl (%ecx),%eax
80103d1a:	0f b6 1a             	movzbl (%edx),%ebx
80103d1d:	38 d8                	cmp    %bl,%al
80103d1f:	75 0a                	jne    80103d2b <memcmp+0x29>
      return *s1 - *s2;
    s1++, s2++;
80103d21:	83 c1 01             	add    $0x1,%ecx
80103d24:	83 c2 01             	add    $0x1,%edx
  while(n-- > 0){
80103d27:	89 f0                	mov    %esi,%eax
80103d29:	eb e5                	jmp    80103d10 <memcmp+0xe>
      return *s1 - *s2;
80103d2b:	0f b6 c0             	movzbl %al,%eax
80103d2e:	0f b6 db             	movzbl %bl,%ebx
80103d31:	29 d8                	sub    %ebx,%eax
  }
...
80103d3f:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80103d42:	8b 55 10             	mov    0x10(%ebp),%edx
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
80103d45:	39 c1                	cmp    %eax,%ecx
80103d47:	73 3a                	jae    80103d83 <memmove+0x4c>
80103d49:	8d 1c 11             	lea    (%ecx,%edx,1),%ebx
80103d4c:	39 c3                	cmp    %eax,%ebx
80103d4e:	76 37                	jbe    80103d87 <memmove+0x50>
    s += n;
    d += n;
80103d50:	8d 0c 10             	lea    (%eax,%edx,1),%ecx
    while(n-- > 0)
80103d53:	eb 0d                	jmp    80103d62 <memmove+0x2b>
      *--d = *--s;
80103d55:	83 eb 01             	sub    $0x1,%ebx
80103d58:	83 e9 01             	sub    $0x1,%ecx
80103d5b:	0f b6 13             	movzbl (%ebx),%edx
80103d5e:	88 11                	mov    %dl,(%ecx)
    while(n-- > 0)
80103d60:	89 f2                	mov    %esi,%edx
80103d62:	8d 72 ff             	lea    -0x1(%edx),%esi
80103d65:	85 d2                	test   %edx,%edx
80103d67:	75 ec                	jne    80103d55 <memmove+0x1e>
80103d69:	eb 14                	jmp    80103d7f <memmove+0x48>
  } else
    while(n-- > 0)
      *d++ = *s++;
80103d6b:	0f b6 11             	movzbl (%ecx),%edx
80103d6e:	88 13                	mov    %dl,(%ebx)
80103d70:	8d 5b 01             	lea    0x1(%ebx),%ebx
80103d73:	8d 49 01             	lea    0x1(%ecx),%ecx
    while(n-- > 0)
80103d76:	89 f2                	mov    %esi,%edx
80103d78:	8d 72 ff             	lea    -0x1(%edx),%esi
80103d7b:	85 d2                	test   %edx,%edx
80103d7d:	75 ec                	jne    80103d6b <memmove+0x34>
...
80103d81:	5d                   	pop    %ebp
80103d82:	c3                   	ret    
80103d83:	89 c3                	mov    %eax,%ebx
80103d85:	eb f1                	jmp    80103d78 <memmove+0x41>
80103d87:	89 c3                	mov    %eax,%ebx
80103d89:	eb ed                	jmp    80103d78 <memmove+0x41>
...
80103d8e:	ff 75 10             	pushl  0x10(%ebp)
80103d91:	ff 75 0c             	pushl  0xc(%ebp)
80103d94:	ff 75 08             	pushl  0x8(%ebp)
80103d97:	e8 9b ff ff ff       	call   80103d37 <memmove>
}
80103d9c:	c9                   	leave  
80103d9d:	c3                   	ret    
...
80103da8:	8b 45 10             	mov    0x10(%ebp),%eax
  while(n > 0 && *p && *p == *q)
80103dab:	eb 09                	jmp    80103db6 <strncmp+0x18>
    n--, p++, q++;
80103dad:	83 e8 01             	sub    $0x1,%eax
80103db0:	83 c2 01             	add    $0x1,%edx
80103db3:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
80103db6:	85 c0                	test   %eax,%eax
80103db8:	74 0b                	je     80103dc5 <strncmp+0x27>
80103dba:	0f b6 1a             	movzbl (%edx),%ebx
80103dbd:	84 db                	test   %bl,%bl
80103dbf:	74 04                	je     80103dc5 <strncmp+0x27>
80103dc1:	3a 19                	cmp    (%ecx),%bl
80103dc3:	74 e8                	je     80103dad <strncmp+0xf>
  if(n == 0)
80103dc5:	85 c0                	test   %eax,%eax
80103dc7:	74 0b                	je     80103dd4 <strncmp+0x36>
    return 0;
  return (uchar)*p - (uchar)*q;
80103dc9:	0f b6 02             	movzbl (%edx),%eax
80103dcc:	0f b6 11             	movzbl (%ecx),%edx
80103dcf:	29 d0                	sub    %edx,%eax
}
80103dd1:	5b                   	pop    %ebx
80103dd2:	5d                   	pop    %ebp
80103dd3:	c3                   	ret    
    return 0;
80103dd4:	b8 00 00 00 00       	mov    $0x0,%eax
80103dd9:	eb f6                	jmp    80103dd1 <strncmp+0x33>
...
80103de1:	8b 5d 0c             	mov    0xc(%ebp),%ebx
80103de4:	8b 4d 10             	mov    0x10(%ebp),%ecx
  char *os;

  os = s;
  while(n-- > 0 && (*s++ = *t++) != 0)
80103de7:	8b 45 08             	mov    0x8(%ebp),%eax
80103dea:	eb 04                	jmp    80103df0 <strncpy+0x15>
80103dec:	89 fb                	mov    %edi,%ebx
80103dee:	89 f0                	mov    %esi,%eax
80103df0:	8d 51 ff             	lea    -0x1(%ecx),%edx
80103df3:	85 c9                	test   %ecx,%ecx
80103df5:	7e 1d                	jle    80103e14 <strncpy+0x39>
80103df7:	8d 7b 01             	lea    0x1(%ebx),%edi
80103dfa:	8d 70 01             	lea    0x1(%eax),%esi
80103dfd:	0f b6 1b             	movzbl (%ebx),%ebx
80103e00:	88 18                	mov    %bl,(%eax)
80103e02:	89 d1                	mov    %edx,%ecx
80103e04:	84 db                	test   %bl,%bl
80103e06:	75 e4                	jne    80103dec <strncpy+0x11>
80103e08:	89 f0                	mov    %esi,%eax
80103e0a:	eb 08                	jmp    80103e14 <strncpy+0x39>
    ;
  while(n-- > 0)
    *s++ = 0;
80103e0c:	c6 00 00             	movb   $0x0,(%eax)
  while(n-- > 0)
80103e0f:	89 ca                	mov    %ecx,%edx
    *s++ = 0;
80103e11:	8d 40 01             	lea    0x1(%eax),%eax
  while(n-- > 0)
80103e14:	8d 4a ff             	lea    -0x1(%edx),%ecx
80103e17:	85 d2                	test   %edx,%edx
80103e19:	7f f1                	jg     80103e0c <strncpy+0x31>
  return os;
}
...
80103e2c:	8b 5d 0c             	mov    0xc(%ebp),%ebx
80103e2f:	8b 55 10             	mov    0x10(%ebp),%edx
  char *os;

  os = s;
  if(n <= 0)
80103e32:	85 d2                	test   %edx,%edx
80103e34:	7e 23                	jle    80103e59 <safestrcpy+0x36>
80103e36:	89 c1                	mov    %eax,%ecx
80103e38:	eb 04                	jmp    80103e3e <safestrcpy+0x1b>
    return os;
  while(--n > 0 && (*s++ = *t++) != 0)
80103e3a:	89 fb                	mov    %edi,%ebx
80103e3c:	89 f1                	mov    %esi,%ecx
80103e3e:	83 ea 01             	sub    $0x1,%edx
80103e41:	85 d2                	test   %edx,%edx
80103e43:	7e 11                	jle    80103e56 <safestrcpy+0x33>
80103e45:	8d 7b 01             	lea    0x1(%ebx),%edi
80103e48:	8d 71 01             	lea    0x1(%ecx),%esi
80103e4b:	0f b6 1b             	movzbl (%ebx),%ebx
80103e4e:	88 19                	mov    %bl,(%ecx)
80103e50:	84 db                	test   %bl,%bl
80103e52:	75 e6                	jne    80103e3a <safestrcpy+0x17>
80103e54:	89 f1                	mov    %esi,%ecx
    ;
  *s = 0;
80103e56:	c6 01 00             	movb   $0x0,(%ecx)
  return os;
}
80103e59:	5b                   	pop    %ebx
80103e5a:	5e                   	pop    %esi
...
80103e69:	eb 03                	jmp    80103e6e <strlen+0x10>
80103e6b:	83 c0 01             	add    $0x1,%eax
80103e6e:	80 3c 02 00          	cmpb   $0x0,(%edx,%eax,1)
80103e72:	75 f7                	jne    80103e6b <strlen+0xd>
    ;
  return n;
}
80103e74:	5d                   	pop    %ebp
...
swtch:
  movl 4(%esp), %eax
80103e76:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
80103e7a:	8b 54 24 08          	mov    0x8(%esp),%edx
...
80103e81:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
80103e82:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
80103e84:	89 d4                	mov    %edx,%esp
...
80103e92:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80103e95:	e8 5c f3 ff ff       	call   801031f6 <myproc>

  if(addr >= curproc->sz || addr+4 > curproc->sz)
80103e9a:	8b 00                	mov    (%eax),%eax
80103e9c:	39 d8                	cmp    %ebx,%eax
80103e9e:	76 19                	jbe    80103eb9 <fetchint+0x2e>
80103ea0:	8d 53 04             	lea    0x4(%ebx),%edx
80103ea3:	39 d0                	cmp    %edx,%eax
80103ea5:	72 19                	jb     80103ec0 <fetchint+0x35>
    return -1;
  *ip = *(int*)(addr);
80103ea7:	8b 13                	mov    (%ebx),%edx
80103ea9:	8b 45 0c             	mov    0xc(%ebp),%eax
80103eac:	89 10                	mov    %edx,(%eax)
  return 0;
80103eae:	b8 00 00 00 00       	mov    $0x0,%eax
}
80103eb3:	83 c4 04             	add    $0x4,%esp
80103eb6:	5b                   	pop    %ebx
80103eb7:	5d                   	pop    %ebp
80103eb8:	c3                   	ret    
    return -1;
80103eb9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103ebe:	eb f3                	jmp    80103eb3 <fetchint+0x28>
80103ec0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103ec5:	eb ec                	jmp    80103eb3 <fetchint+0x28>
...
80103ece:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80103ed1:	e8 20 f3 ff ff       	call   801031f6 <myproc>

  if(addr >= curproc->sz)
80103ed6:	39 18                	cmp    %ebx,(%eax)
80103ed8:	76 26                	jbe    80103f00 <fetchstr+0x39>
    return -1;
  *pp = (char*)addr;
80103eda:	8b 55 0c             	mov    0xc(%ebp),%edx
80103edd:	89 1a                	mov    %ebx,(%edx)
  ep = (char*)curproc->sz;
80103edf:	8b 10                	mov    (%eax),%edx
  for(s = *pp; s < ep; s++){
80103ee1:	89 d8                	mov    %ebx,%eax
80103ee3:	39 d0                	cmp    %edx,%eax
80103ee5:	73 0e                	jae    80103ef5 <fetchstr+0x2e>
    if(*s == 0)
80103ee7:	80 38 00             	cmpb   $0x0,(%eax)
80103eea:	74 05                	je     80103ef1 <fetchstr+0x2a>
  for(s = *pp; s < ep; s++){
80103eec:	83 c0 01             	add    $0x1,%eax
80103eef:	eb f2                	jmp    80103ee3 <fetchstr+0x1c>
      return s - *pp;
80103ef1:	29 d8                	sub    %ebx,%eax
80103ef3:	eb 05                	jmp    80103efa <fetchstr+0x33>
  }
  return -1;
80103ef5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
80103efa:	83 c4 04             	add    $0x4,%esp
80103efd:	5b                   	pop    %ebx
80103efe:	5d                   	pop    %ebp
80103eff:	c3                   	ret    
    return -1;
80103f00:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103f05:	eb f3                	jmp    80103efa <fetchstr+0x33>
...
80103f0d:	e8 e4 f2 ff ff       	call   801031f6 <myproc>
80103f12:	8b 50 18             	mov    0x18(%eax),%edx
80103f15:	8b 45 08             	mov    0x8(%ebp),%eax
80103f18:	c1 e0 02             	shl    $0x2,%eax
80103f1b:	03 42 44             	add    0x44(%edx),%eax
80103f1e:	83 ec 08             	sub    $0x8,%esp
80103f21:	ff 75 0c             	pushl  0xc(%ebp)
80103f24:	83 c0 04             	add    $0x4,%eax
80103f27:	50                   	push   %eax
80103f28:	e8 5e ff ff ff       	call   80103e8b <fetchint>
}
80103f2d:	c9                   	leave  
80103f2e:	c3                   	ret    
...
80103f37:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80103f3a:	e8 b7 f2 ff ff       	call   801031f6 <myproc>
80103f3f:	89 c6                	mov    %eax,%esi
 
  if(argint(n, &i) < 0)
80103f41:	83 ec 08             	sub    $0x8,%esp
80103f44:	8d 45 f4             	lea    -0xc(%ebp),%eax
80103f47:	50                   	push   %eax
80103f48:	ff 75 08             	pushl  0x8(%ebp)
80103f4b:	e8 b7 ff ff ff       	call   80103f07 <argint>
80103f50:	83 c4 10             	add    $0x10,%esp
80103f53:	85 c0                	test   %eax,%eax
80103f55:	78 24                	js     80103f7b <argptr+0x4c>
    return -1;
  if(size < 0 || (uint)i >= curproc->sz || (uint)i+size > curproc->sz)
80103f57:	85 db                	test   %ebx,%ebx
80103f59:	78 27                	js     80103f82 <argptr+0x53>
80103f5b:	8b 16                	mov    (%esi),%edx
80103f5d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103f60:	39 c2                	cmp    %eax,%edx
80103f62:	76 25                	jbe    80103f89 <argptr+0x5a>
80103f64:	01 c3                	add    %eax,%ebx
80103f66:	39 da                	cmp    %ebx,%edx
80103f68:	72 26                	jb     80103f90 <argptr+0x61>
    return -1;
  *pp = (char*)i;
...
80103f7a:	c3                   	ret    
    return -1;
80103f7b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103f80:	eb f2                	jmp    80103f74 <argptr+0x45>
    return -1;
80103f82:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103f87:	eb eb                	jmp    80103f74 <argptr+0x45>
80103f89:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103f8e:	eb e4                	jmp    80103f74 <argptr+0x45>
80103f90:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103f95:	eb dd                	jmp    80103f74 <argptr+0x45>
...
80103f9a:	83 ec 20             	sub    $0x20,%esp
  int addr;
  if(argint(n, &addr) < 0)
80103f9d:	8d 45 f4             	lea    -0xc(%ebp),%eax
80103fa0:	50                   	push   %eax
80103fa1:	ff 75 08             	pushl  0x8(%ebp)
80103fa4:	e8 5e ff ff ff       	call   80103f07 <argint>
80103fa9:	83 c4 10             	add    $0x10,%esp
80103fac:	85 c0                	test   %eax,%eax
80103fae:	78 13                	js     80103fc3 <argstr+0x2c>
    return -1;
  return fetchstr(addr, pp);
80103fb0:	83 ec 08             	sub    $0x8,%esp
80103fb3:	ff 75 0c             	pushl  0xc(%ebp)
80103fb6:	ff 75 f4             	pushl  -0xc(%ebp)
80103fb9:	e8 09 ff ff ff       	call   80103ec7 <fetchstr>
...
80103fc8:	eb f7                	jmp    80103fc1 <argstr+0x2a>
...
80103fce:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80103fd1:	e8 20 f2 ff ff       	call   801031f6 <myproc>
80103fd6:	89 c3                	mov    %eax,%ebx

  num = curproc->tf->eax;
80103fd8:	8b 40 18             	mov    0x18(%eax),%eax
80103fdb:	8b 40 1c             	mov    0x1c(%eax),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80103fde:	8d 50 ff             	lea    -0x1(%eax),%edx
80103fe1:	83 fa 16             	cmp    $0x16,%edx
80103fe4:	77 18                	ja     80103ffe <syscall+0x34>
80103fe6:	8b 14 85 e0 6b 10 80 	mov    -0x7fef9420(,%eax,4),%edx
80103fed:	85 d2                	test   %edx,%edx
80103fef:	74 0d                	je     80103ffe <syscall+0x34>
    curproc->tf->eax = syscalls[num]();
80103ff1:	ff d2                	call   *%edx
80103ff3:	8b 53 18             	mov    0x18(%ebx),%edx
80103ff6:	89 42 1c             	mov    %eax,0x1c(%edx)
  } else {
...
80103ffd:	c3                   	ret    
            curproc->pid, curproc->name, num);
80103ffe:	8d 53 6c             	lea    0x6c(%ebx),%edx
    cprintf("%d %s: unknown sys call %d\n",
80104001:	50                   	push   %eax
80104002:	52                   	push   %edx
80104003:	ff 73 10             	pushl  0x10(%ebx)
80104006:	68 b1 6b 10 80       	push   $0x80106bb1
8010400b:	e8 fb c5 ff ff       	call   8010060b <cprintf>
    curproc->tf->eax = -1;
80104010:	8b 43 18             	mov    0x18(%ebx),%eax
80104013:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
8010401a:	83 c4 10             	add    $0x10,%esp
}
8010401d:	eb da                	jmp    80103ff9 <syscall+0x2f>
...
80104022:	56                   	push   %esi
80104023:	53                   	push   %ebx
80104024:	83 ec 18             	sub    $0x18,%esp
80104027:	89 d6                	mov    %edx,%esi
80104029:	89 cb                	mov    %ecx,%ebx
  int fd;
  struct file *f;

  if(argint(n, &fd) < 0)
8010402b:	8d 55 f4             	lea    -0xc(%ebp),%edx
8010402e:	52                   	push   %edx
8010402f:	50                   	push   %eax
80104030:	e8 d2 fe ff ff       	call   80103f07 <argint>
80104035:	83 c4 10             	add    $0x10,%esp
80104038:	85 c0                	test   %eax,%eax
8010403a:	78 2e                	js     8010406a <argfd+0x4b>
    return -1;
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
8010403c:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80104040:	77 2f                	ja     80104071 <argfd+0x52>
80104042:	e8 af f1 ff ff       	call   801031f6 <myproc>
80104047:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010404a:	8b 44 90 28          	mov    0x28(%eax,%edx,4),%eax
8010404e:	85 c0                	test   %eax,%eax
80104050:	74 26                	je     80104078 <argfd+0x59>
    return -1;
  if(pfd)
80104052:	85 f6                	test   %esi,%esi
80104054:	74 02                	je     80104058 <argfd+0x39>
    *pfd = fd;
80104056:	89 16                	mov    %edx,(%esi)
  if(pf)
80104058:	85 db                	test   %ebx,%ebx
8010405a:	74 23                	je     8010407f <argfd+0x60>
    *pf = f;
8010405c:	89 03                	mov    %eax,(%ebx)
  return 0;
...
8010406f:	eb f2                	jmp    80104063 <argfd+0x44>
    return -1;
80104071:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104076:	eb eb                	jmp    80104063 <argfd+0x44>
80104078:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010407d:	eb e4                	jmp    80104063 <argfd+0x44>
  return 0;
8010407f:	b8 00 00 00 00       	mov    $0x0,%eax
80104084:	eb dd                	jmp    80104063 <argfd+0x44>
...
8010408d:	89 c3                	mov    %eax,%ebx
  int fd;
  struct proc *curproc = myproc();
8010408f:	e8 62 f1 ff ff       	call   801031f6 <myproc>

  for(fd = 0; fd < NOFILE; fd++){
80104094:	ba 00 00 00 00       	mov    $0x0,%edx
80104099:	83 fa 0f             	cmp    $0xf,%edx
8010409c:	7f 18                	jg     801040b6 <fdalloc+0x30>
    if(curproc->ofile[fd] == 0){
8010409e:	83 7c 90 28 00       	cmpl   $0x0,0x28(%eax,%edx,4)
801040a3:	74 05                	je     801040aa <fdalloc+0x24>
  for(fd = 0; fd < NOFILE; fd++){
801040a5:	83 c2 01             	add    $0x1,%edx
801040a8:	eb ef                	jmp    80104099 <fdalloc+0x13>
      curproc->ofile[fd] = f;
801040aa:	89 5c 90 28          	mov    %ebx,0x28(%eax,%edx,4)
      return fd;
    }
  }
  return -1;
}
801040ae:	89 d0                	mov    %edx,%eax
801040b0:	83 c4 04             	add    $0x4,%esp
801040b3:	5b                   	pop    %ebx
801040b4:	5d                   	pop    %ebp
801040b5:	c3                   	ret    
  return -1;
801040b6:	ba ff ff ff ff       	mov    $0xffffffff,%edx
801040bb:	eb f1                	jmp    801040ae <fdalloc+0x28>
...
801040c2:	83 ec 10             	sub    $0x10,%esp
801040c5:	89 c3                	mov    %eax,%ebx
  int off;
  struct dirent de;

  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
801040c7:	b8 20 00 00 00       	mov    $0x20,%eax
801040cc:	89 c6                	mov    %eax,%esi
801040ce:	39 43 58             	cmp    %eax,0x58(%ebx)
801040d1:	76 2e                	jbe    80104101 <isdirempty+0x44>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801040d3:	6a 10                	push   $0x10
801040d5:	50                   	push   %eax
801040d6:	8d 45 e8             	lea    -0x18(%ebp),%eax
801040d9:	50                   	push   %eax
801040da:	53                   	push   %ebx
801040db:	e8 93 d6 ff ff       	call   80101773 <readi>
801040e0:	83 c4 10             	add    $0x10,%esp
801040e3:	83 f8 10             	cmp    $0x10,%eax
801040e6:	75 0c                	jne    801040f4 <isdirempty+0x37>
      panic("isdirempty: readi");
    if(de.inum != 0)
801040e8:	66 83 7d e8 00       	cmpw   $0x0,-0x18(%ebp)
801040ed:	75 1e                	jne    8010410d <isdirempty+0x50>
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
801040ef:	8d 46 10             	lea    0x10(%esi),%eax
801040f2:	eb d8                	jmp    801040cc <isdirempty+0xf>
      panic("isdirempty: readi");
801040f4:	83 ec 0c             	sub    $0xc,%esp
801040f7:	68 40 6c 10 80       	push   $0x80106c40
801040fc:	e8 47 c2 ff ff       	call   80100348 <panic>
      return 0;
  }
  return 1;
...
80104112:	eb f2                	jmp    80104106 <isdirempty+0x49>
...
8010411a:	83 ec 44             	sub    $0x44,%esp
8010411d:	89 55 c4             	mov    %edx,-0x3c(%ebp)
80104120:	89 4d c0             	mov    %ecx,-0x40(%ebp)
80104123:	8b 7d 08             	mov    0x8(%ebp),%edi
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
80104126:	8d 55 d6             	lea    -0x2a(%ebp),%edx
80104129:	52                   	push   %edx
8010412a:	50                   	push   %eax
8010412b:	e8 c9 da ff ff       	call   80101bf9 <nameiparent>
80104130:	89 c6                	mov    %eax,%esi
80104132:	83 c4 10             	add    $0x10,%esp
80104135:	85 c0                	test   %eax,%eax
80104137:	0f 84 3a 01 00 00    	je     80104277 <create+0x163>
    return 0;
  ilock(dp);
8010413d:	83 ec 0c             	sub    $0xc,%esp
80104140:	50                   	push   %eax
80104141:	e8 3b d4 ff ff       	call   80101581 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
80104146:	83 c4 0c             	add    $0xc,%esp
80104149:	8d 45 e4             	lea    -0x1c(%ebp),%eax
8010414c:	50                   	push   %eax
8010414d:	8d 45 d6             	lea    -0x2a(%ebp),%eax
80104150:	50                   	push   %eax
80104151:	56                   	push   %esi
80104152:	e8 59 d8 ff ff       	call   801019b0 <dirlookup>
80104157:	89 c3                	mov    %eax,%ebx
80104159:	83 c4 10             	add    $0x10,%esp
8010415c:	85 c0                	test   %eax,%eax
8010415e:	74 3f                	je     8010419f <create+0x8b>
    iunlockput(dp);
80104160:	83 ec 0c             	sub    $0xc,%esp
80104163:	56                   	push   %esi
80104164:	e8 bf d5 ff ff       	call   80101728 <iunlockput>
    ilock(ip);
80104169:	89 1c 24             	mov    %ebx,(%esp)
8010416c:	e8 10 d4 ff ff       	call   80101581 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80104171:	83 c4 10             	add    $0x10,%esp
80104174:	66 83 7d c4 02       	cmpw   $0x2,-0x3c(%ebp)
80104179:	75 11                	jne    8010418c <create+0x78>
8010417b:	66 83 7b 50 02       	cmpw   $0x2,0x50(%ebx)
80104180:	75 0a                	jne    8010418c <create+0x78>
...
80104182:	89 d8                	mov    %ebx,%eax
80104184:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104187:	5b                   	pop    %ebx
80104188:	5e                   	pop    %esi
80104189:	5f                   	pop    %edi
8010418a:	5d                   	pop    %ebp
...
80104198:	bb 00 00 00 00       	mov    $0x0,%ebx
8010419d:	eb e3                	jmp    80104182 <create+0x6e>
  if((ip = ialloc(dp->dev, type)) == 0)
8010419f:	0f bf 45 c4          	movswl -0x3c(%ebp),%eax
801041a3:	83 ec 08             	sub    $0x8,%esp
801041a6:	50                   	push   %eax
801041a7:	ff 36                	pushl  (%esi)
801041a9:	e8 d0 d1 ff ff       	call   8010137e <ialloc>
801041ae:	89 c3                	mov    %eax,%ebx
801041b0:	83 c4 10             	add    $0x10,%esp
801041b3:	85 c0                	test   %eax,%eax
801041b5:	74 55                	je     8010420c <create+0xf8>
  ilock(ip);
801041b7:	83 ec 0c             	sub    $0xc,%esp
801041ba:	50                   	push   %eax
801041bb:	e8 c1 d3 ff ff       	call   80101581 <ilock>
  ip->major = major;
801041c0:	0f b7 45 c0          	movzwl -0x40(%ebp),%eax
801041c4:	66 89 43 52          	mov    %ax,0x52(%ebx)
  ip->minor = minor;
801041c8:	66 89 7b 54          	mov    %di,0x54(%ebx)
  ip->nlink = 1;
801041cc:	66 c7 43 56 01 00    	movw   $0x1,0x56(%ebx)
  iupdate(ip);
801041d2:	89 1c 24             	mov    %ebx,(%esp)
801041d5:	e8 46 d2 ff ff       	call   80101420 <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
801041da:	83 c4 10             	add    $0x10,%esp
801041dd:	66 83 7d c4 01       	cmpw   $0x1,-0x3c(%ebp)
801041e2:	74 35                	je     80104219 <create+0x105>
...
801041ef:	e8 3c d9 ff ff       	call   80101b30 <dirlink>
801041f4:	83 c4 10             	add    $0x10,%esp
801041f7:	85 c0                	test   %eax,%eax
801041f9:	78 6f                	js     8010426a <create+0x156>
  iunlockput(dp);
801041fb:	83 ec 0c             	sub    $0xc,%esp
801041fe:	56                   	push   %esi
801041ff:	e8 24 d5 ff ff       	call   80101728 <iunlockput>
  return ip;
80104204:	83 c4 10             	add    $0x10,%esp
80104207:	e9 76 ff ff ff       	jmp    80104182 <create+0x6e>
    panic("create: ialloc");
8010420c:	83 ec 0c             	sub    $0xc,%esp
8010420f:	68 52 6c 10 80       	push   $0x80106c52
80104214:	e8 2f c1 ff ff       	call   80100348 <panic>
    dp->nlink++;  // for ".."
80104219:	0f b7 46 56          	movzwl 0x56(%esi),%eax
8010421d:	83 c0 01             	add    $0x1,%eax
80104220:	66 89 46 56          	mov    %ax,0x56(%esi)
    iupdate(dp);
80104224:	83 ec 0c             	sub    $0xc,%esp
80104227:	56                   	push   %esi
80104228:	e8 f3 d1 ff ff       	call   80101420 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
8010422d:	83 c4 0c             	add    $0xc,%esp
80104230:	ff 73 04             	pushl  0x4(%ebx)
80104233:	68 62 6c 10 80       	push   $0x80106c62
80104238:	53                   	push   %ebx
80104239:	e8 f2 d8 ff ff       	call   80101b30 <dirlink>
8010423e:	83 c4 10             	add    $0x10,%esp
80104241:	85 c0                	test   %eax,%eax
80104243:	78 18                	js     8010425d <create+0x149>
80104245:	83 ec 04             	sub    $0x4,%esp
80104248:	ff 76 04             	pushl  0x4(%esi)
8010424b:	68 61 6c 10 80       	push   $0x80106c61
...
8010425b:	79 87                	jns    801041e4 <create+0xd0>
      panic("create dots");
8010425d:	83 ec 0c             	sub    $0xc,%esp
80104260:	68 64 6c 10 80       	push   $0x80106c64
80104265:	e8 de c0 ff ff       	call   80100348 <panic>
    panic("create: dirlink");
8010426a:	83 ec 0c             	sub    $0xc,%esp
8010426d:	68 70 6c 10 80       	push   $0x80106c70
80104272:	e8 d1 c0 ff ff       	call   80100348 <panic>
    return 0;
80104277:	89 c3                	mov    %eax,%ebx
80104279:	e9 04 ff ff ff       	jmp    80104182 <create+0x6e>
...
80104282:	83 ec 14             	sub    $0x14,%esp
  if(argfd(0, 0, &f) < 0)
80104285:	8d 4d f4             	lea    -0xc(%ebp),%ecx
80104288:	ba 00 00 00 00       	mov    $0x0,%edx
8010428d:	b8 00 00 00 00       	mov    $0x0,%eax
80104292:	e8 88 fd ff ff       	call   8010401f <argfd>
80104297:	85 c0                	test   %eax,%eax
80104299:	78 23                	js     801042be <sys_dup+0x40>
  if((fd=fdalloc(f)) < 0)
8010429b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010429e:	e8 e3 fd ff ff       	call   80104086 <fdalloc>
801042a3:	89 c3                	mov    %eax,%ebx
801042a5:	85 c0                	test   %eax,%eax
801042a7:	78 1c                	js     801042c5 <sys_dup+0x47>
  filedup(f);
801042a9:	83 ec 0c             	sub    $0xc,%esp
801042ac:	ff 75 f4             	pushl  -0xc(%ebp)
801042af:	e8 da c9 ff ff       	call   80100c8e <filedup>
  return fd;
...
801042bd:	c3                   	ret    
    return -1;
801042be:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801042c3:	eb f2                	jmp    801042b7 <sys_dup+0x39>
    return -1;
801042c5:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801042ca:	eb eb                	jmp    801042b7 <sys_dup+0x39>
...
801042df:	e8 3b fd ff ff       	call   8010401f <argfd>
801042e4:	85 c0                	test   %eax,%eax
801042e6:	78 43                	js     8010432b <sys_read+0x5f>
801042e8:	83 ec 08             	sub    $0x8,%esp
801042eb:	8d 45 f0             	lea    -0x10(%ebp),%eax
801042ee:	50                   	push   %eax
801042ef:	6a 02                	push   $0x2
801042f1:	e8 11 fc ff ff       	call   80103f07 <argint>
801042f6:	83 c4 10             	add    $0x10,%esp
801042f9:	85 c0                	test   %eax,%eax
801042fb:	78 35                	js     80104332 <sys_read+0x66>
801042fd:	83 ec 04             	sub    $0x4,%esp
80104300:	ff 75 f0             	pushl  -0x10(%ebp)
80104303:	8d 45 ec             	lea    -0x14(%ebp),%eax
80104306:	50                   	push   %eax
80104307:	6a 01                	push   $0x1
80104309:	e8 21 fc ff ff       	call   80103f2f <argptr>
8010430e:	83 c4 10             	add    $0x10,%esp
80104311:	85 c0                	test   %eax,%eax
80104313:	78 24                	js     80104339 <sys_read+0x6d>
  return fileread(f, p, n);
80104315:	83 ec 04             	sub    $0x4,%esp
80104318:	ff 75 f0             	pushl  -0x10(%ebp)
8010431b:	ff 75 ec             	pushl  -0x14(%ebp)
8010431e:	ff 75 f4             	pushl  -0xc(%ebp)
80104321:	e8 b1 ca ff ff       	call   80100dd7 <fileread>
...
80104330:	eb f7                	jmp    80104329 <sys_read+0x5d>
80104332:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104337:	eb f0                	jmp    80104329 <sys_read+0x5d>
80104339:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010433e:	eb e9                	jmp    80104329 <sys_read+0x5d>
...
8010437d:	e8 ad fb ff ff       	call   80103f2f <argptr>
80104382:	83 c4 10             	add    $0x10,%esp
80104385:	85 c0                	test   %eax,%eax
80104387:	78 24                	js     801043ad <sys_write+0x6d>
...
80104395:	e8 c2 ca ff ff       	call   80100e5c <filewrite>
...
801043a4:	eb f7                	jmp    8010439d <sys_write+0x5d>
801043a6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801043ab:	eb f0                	jmp    8010439d <sys_write+0x5d>
801043ad:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801043b2:	eb e9                	jmp    8010439d <sys_write+0x5d>
...
801043b7:	83 ec 18             	sub    $0x18,%esp
  if(argfd(0, &fd, &f) < 0)
801043ba:	8d 4d f0             	lea    -0x10(%ebp),%ecx
801043bd:	8d 55 f4             	lea    -0xc(%ebp),%edx
801043c0:	b8 00 00 00 00       	mov    $0x0,%eax
801043c5:	e8 55 fc ff ff       	call   8010401f <argfd>
801043ca:	85 c0                	test   %eax,%eax
801043cc:	78 25                	js     801043f3 <sys_close+0x3f>
  myproc()->ofile[fd] = 0;
801043ce:	e8 23 ee ff ff       	call   801031f6 <myproc>
801043d3:	8b 55 f4             	mov    -0xc(%ebp),%edx
801043d6:	c7 44 90 28 00 00 00 	movl   $0x0,0x28(%eax,%edx,4)
801043dd:	00 
  fileclose(f);
801043de:	83 ec 0c             	sub    $0xc,%esp
801043e1:	ff 75 f0             	pushl  -0x10(%ebp)
801043e4:	e8 ea c8 ff ff       	call   80100cd3 <fileclose>
  return 0;
...
801043f8:	eb f7                	jmp    801043f1 <sys_close+0x3d>
...
8010440d:	e8 0d fc ff ff       	call   8010401f <argfd>
80104412:	85 c0                	test   %eax,%eax
80104414:	78 2a                	js     80104440 <sys_fstat+0x46>
80104416:	83 ec 04             	sub    $0x4,%esp
80104419:	6a 14                	push   $0x14
8010441b:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010441e:	50                   	push   %eax
8010441f:	6a 01                	push   $0x1
80104421:	e8 09 fb ff ff       	call   80103f2f <argptr>
80104426:	83 c4 10             	add    $0x10,%esp
80104429:	85 c0                	test   %eax,%eax
8010442b:	78 1a                	js     80104447 <sys_fstat+0x4d>
  return filestat(f, st);
8010442d:	83 ec 08             	sub    $0x8,%esp
80104430:	ff 75 f0             	pushl  -0x10(%ebp)
80104433:	ff 75 f4             	pushl  -0xc(%ebp)
80104436:	e8 55 c9 ff ff       	call   80100d90 <filestat>
...
80104445:	eb f7                	jmp    8010443e <sys_fstat+0x44>
80104447:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010444c:	eb f0                	jmp    8010443e <sys_fstat+0x44>
...
80104456:	8d 45 e0             	lea    -0x20(%ebp),%eax
80104459:	50                   	push   %eax
8010445a:	6a 00                	push   $0x0
8010445c:	e8 36 fb ff ff       	call   80103f97 <argstr>
80104461:	83 c4 10             	add    $0x10,%esp
80104464:	85 c0                	test   %eax,%eax
80104466:	0f 88 32 01 00 00    	js     8010459e <sys_link+0x150>
8010446c:	83 ec 08             	sub    $0x8,%esp
8010446f:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80104472:	50                   	push   %eax
80104473:	6a 01                	push   $0x1
80104475:	e8 1d fb ff ff       	call   80103f97 <argstr>
8010447a:	83 c4 10             	add    $0x10,%esp
8010447d:	85 c0                	test   %eax,%eax
8010447f:	0f 88 20 01 00 00    	js     801045a5 <sys_link+0x157>
  begin_op();
80104485:	e8 24 e3 ff ff       	call   801027ae <begin_op>
  if((ip = namei(old)) == 0){
8010448a:	83 ec 0c             	sub    $0xc,%esp
8010448d:	ff 75 e0             	pushl  -0x20(%ebp)
80104490:	e8 4c d7 ff ff       	call   80101be1 <namei>
80104495:	89 c3                	mov    %eax,%ebx
80104497:	83 c4 10             	add    $0x10,%esp
8010449a:	85 c0                	test   %eax,%eax
8010449c:	0f 84 99 00 00 00    	je     8010453b <sys_link+0xed>
  ilock(ip);
801044a2:	83 ec 0c             	sub    $0xc,%esp
801044a5:	50                   	push   %eax
801044a6:	e8 d6 d0 ff ff       	call   80101581 <ilock>
  if(ip->type == T_DIR){
801044ab:	83 c4 10             	add    $0x10,%esp
801044ae:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
801044b3:	0f 84 8e 00 00 00    	je     80104547 <sys_link+0xf9>
  ip->nlink++;
801044b9:	0f b7 43 56          	movzwl 0x56(%ebx),%eax
801044bd:	83 c0 01             	add    $0x1,%eax
801044c0:	66 89 43 56          	mov    %ax,0x56(%ebx)
  iupdate(ip);
801044c4:	83 ec 0c             	sub    $0xc,%esp
801044c7:	53                   	push   %ebx
801044c8:	e8 53 cf ff ff       	call   80101420 <iupdate>
  iunlock(ip);
801044cd:	89 1c 24             	mov    %ebx,(%esp)
801044d0:	e8 6e d1 ff ff       	call   80101643 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
801044d5:	83 c4 08             	add    $0x8,%esp
801044d8:	8d 45 ea             	lea    -0x16(%ebp),%eax
801044db:	50                   	push   %eax
801044dc:	ff 75 e4             	pushl  -0x1c(%ebp)
801044df:	e8 15 d7 ff ff       	call   80101bf9 <nameiparent>
801044e4:	89 c6                	mov    %eax,%esi
801044e6:	83 c4 10             	add    $0x10,%esp
801044e9:	85 c0                	test   %eax,%eax
801044eb:	74 7e                	je     8010456b <sys_link+0x11d>
  ilock(dp);
801044ed:	83 ec 0c             	sub    $0xc,%esp
801044f0:	50                   	push   %eax
801044f1:	e8 8b d0 ff ff       	call   80101581 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
801044f6:	83 c4 10             	add    $0x10,%esp
801044f9:	8b 03                	mov    (%ebx),%eax
801044fb:	39 06                	cmp    %eax,(%esi)
801044fd:	75 60                	jne    8010455f <sys_link+0x111>
801044ff:	83 ec 04             	sub    $0x4,%esp
80104502:	ff 73 04             	pushl  0x4(%ebx)
80104505:	8d 45 ea             	lea    -0x16(%ebp),%eax
80104508:	50                   	push   %eax
80104509:	56                   	push   %esi
8010450a:	e8 21 d6 ff ff       	call   80101b30 <dirlink>
8010450f:	83 c4 10             	add    $0x10,%esp
80104512:	85 c0                	test   %eax,%eax
80104514:	78 49                	js     8010455f <sys_link+0x111>
  iunlockput(dp);
...
80104522:	e8 61 d1 ff ff       	call   80101688 <iput>
  end_op();
80104527:	e8 fc e2 ff ff       	call   80102828 <end_op>
  return 0;
...
8010453a:	c3                   	ret    
    end_op();
8010453b:	e8 e8 e2 ff ff       	call   80102828 <end_op>
    return -1;
80104540:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104545:	eb ed                	jmp    80104534 <sys_link+0xe6>
    iunlockput(ip);
80104547:	83 ec 0c             	sub    $0xc,%esp
8010454a:	53                   	push   %ebx
8010454b:	e8 d8 d1 ff ff       	call   80101728 <iunlockput>
    end_op();
80104550:	e8 d3 e2 ff ff       	call   80102828 <end_op>
    return -1;
80104555:	83 c4 10             	add    $0x10,%esp
80104558:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010455d:	eb d5                	jmp    80104534 <sys_link+0xe6>
    iunlockput(dp);
...
8010456f:	e8 0d d0 ff ff       	call   80101581 <ilock>
  ip->nlink--;
80104574:	0f b7 43 56          	movzwl 0x56(%ebx),%eax
80104578:	83 e8 01             	sub    $0x1,%eax
8010457b:	66 89 43 56          	mov    %ax,0x56(%ebx)
  iupdate(ip);
8010457f:	89 1c 24             	mov    %ebx,(%esp)
80104582:	e8 99 ce ff ff       	call   80101420 <iupdate>
  iunlockput(ip);
80104587:	89 1c 24             	mov    %ebx,(%esp)
8010458a:	e8 99 d1 ff ff       	call   80101728 <iunlockput>
  end_op();
8010458f:	e8 94 e2 ff ff       	call   80102828 <end_op>
  return -1;
80104594:	83 c4 10             	add    $0x10,%esp
80104597:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010459c:	eb 96                	jmp    80104534 <sys_link+0xe6>
    return -1;
8010459e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801045a3:	eb 8f                	jmp    80104534 <sys_link+0xe6>
801045a5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801045aa:	eb 88                	jmp    80104534 <sys_link+0xe6>

801045ac <sys_unlink>:
{
801045ac:	55                   	push   %ebp
801045ad:	89 e5                	mov    %esp,%ebp
801045af:	57                   	push   %edi
801045b0:	56                   	push   %esi
801045b1:	53                   	push   %ebx
801045b2:	83 ec 44             	sub    $0x44,%esp
  if(argstr(0, &path) < 0)
801045b5:	8d 45 c4             	lea    -0x3c(%ebp),%eax
801045b8:	50                   	push   %eax
801045b9:	6a 00                	push   $0x0
801045bb:	e8 d7 f9 ff ff       	call   80103f97 <argstr>
801045c0:	83 c4 10             	add    $0x10,%esp
801045c3:	85 c0                	test   %eax,%eax
801045c5:	0f 88 83 01 00 00    	js     8010474e <sys_unlink+0x1a2>
  begin_op();
801045cb:	e8 de e1 ff ff       	call   801027ae <begin_op>
  if((dp = nameiparent(path, name)) == 0){
801045d0:	83 ec 08             	sub    $0x8,%esp
801045d3:	8d 45 ca             	lea    -0x36(%ebp),%eax
801045d6:	50                   	push   %eax
801045d7:	ff 75 c4             	pushl  -0x3c(%ebp)
801045da:	e8 1a d6 ff ff       	call   80101bf9 <nameiparent>
801045df:	89 c6                	mov    %eax,%esi
801045e1:	83 c4 10             	add    $0x10,%esp
801045e4:	85 c0                	test   %eax,%eax
801045e6:	0f 84 ed 00 00 00    	je     801046d9 <sys_unlink+0x12d>
  ilock(dp);
801045ec:	83 ec 0c             	sub    $0xc,%esp
801045ef:	50                   	push   %eax
801045f0:	e8 8c cf ff ff       	call   80101581 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
801045f5:	83 c4 08             	add    $0x8,%esp
801045f8:	68 62 6c 10 80       	push   $0x80106c62
801045fd:	8d 45 ca             	lea    -0x36(%ebp),%eax
80104600:	50                   	push   %eax
80104601:	e8 95 d3 ff ff       	call   8010199b <namecmp>
80104606:	83 c4 10             	add    $0x10,%esp
80104609:	85 c0                	test   %eax,%eax
8010460b:	0f 84 fc 00 00 00    	je     8010470d <sys_unlink+0x161>
80104611:	83 ec 08             	sub    $0x8,%esp
80104614:	68 61 6c 10 80       	push   $0x80106c61
80104619:	8d 45 ca             	lea    -0x36(%ebp),%eax
8010461c:	50                   	push   %eax
8010461d:	e8 79 d3 ff ff       	call   8010199b <namecmp>
80104622:	83 c4 10             	add    $0x10,%esp
80104625:	85 c0                	test   %eax,%eax
80104627:	0f 84 e0 00 00 00    	je     8010470d <sys_unlink+0x161>
  if((ip = dirlookup(dp, name, &off)) == 0)
8010462d:	83 ec 04             	sub    $0x4,%esp
80104630:	8d 45 c0             	lea    -0x40(%ebp),%eax
80104633:	50                   	push   %eax
80104634:	8d 45 ca             	lea    -0x36(%ebp),%eax
80104637:	50                   	push   %eax
80104638:	56                   	push   %esi
80104639:	e8 72 d3 ff ff       	call   801019b0 <dirlookup>
8010463e:	89 c3                	mov    %eax,%ebx
80104640:	83 c4 10             	add    $0x10,%esp
80104643:	85 c0                	test   %eax,%eax
80104645:	0f 84 c2 00 00 00    	je     8010470d <sys_unlink+0x161>
  ilock(ip);
8010464b:	83 ec 0c             	sub    $0xc,%esp
8010464e:	50                   	push   %eax
8010464f:	e8 2d cf ff ff       	call   80101581 <ilock>
  if(ip->nlink < 1)
80104654:	83 c4 10             	add    $0x10,%esp
80104657:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
8010465c:	0f 8e 83 00 00 00    	jle    801046e5 <sys_unlink+0x139>
  if(ip->type == T_DIR && !isdirempty(ip)){
80104662:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104667:	0f 84 85 00 00 00    	je     801046f2 <sys_unlink+0x146>
  memset(&de, 0, sizeof(de));
8010466d:	83 ec 04             	sub    $0x4,%esp
80104670:	6a 10                	push   $0x10
80104672:	6a 00                	push   $0x0
80104674:	8d 7d d8             	lea    -0x28(%ebp),%edi
80104677:	57                   	push   %edi
80104678:	e8 3f f6 ff ff       	call   80103cbc <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
8010467d:	6a 10                	push   $0x10
8010467f:	ff 75 c0             	pushl  -0x40(%ebp)
80104682:	57                   	push   %edi
80104683:	56                   	push   %esi
80104684:	e8 e7 d1 ff ff       	call   80101870 <writei>
80104689:	83 c4 20             	add    $0x20,%esp
8010468c:	83 f8 10             	cmp    $0x10,%eax
8010468f:	0f 85 90 00 00 00    	jne    80104725 <sys_unlink+0x179>
  if(ip->type == T_DIR){
80104695:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
8010469a:	0f 84 92 00 00 00    	je     80104732 <sys_unlink+0x186>
  iunlockput(dp);
801046a0:	83 ec 0c             	sub    $0xc,%esp
801046a3:	56                   	push   %esi
801046a4:	e8 7f d0 ff ff       	call   80101728 <iunlockput>
  ip->nlink--;
801046a9:	0f b7 43 56          	movzwl 0x56(%ebx),%eax
801046ad:	83 e8 01             	sub    $0x1,%eax
801046b0:	66 89 43 56          	mov    %ax,0x56(%ebx)
  iupdate(ip);
801046b4:	89 1c 24             	mov    %ebx,(%esp)
801046b7:	e8 64 cd ff ff       	call   80101420 <iupdate>
  iunlockput(ip);
801046bc:	89 1c 24             	mov    %ebx,(%esp)
801046bf:	e8 64 d0 ff ff       	call   80101728 <iunlockput>
  end_op();
801046c4:	e8 5f e1 ff ff       	call   80102828 <end_op>
  return 0;
801046c9:	83 c4 10             	add    $0x10,%esp
801046cc:	b8 00 00 00 00       	mov    $0x0,%eax
}
801046d1:	8d 65 f4             	lea    -0xc(%ebp),%esp
801046d4:	5b                   	pop    %ebx
801046d5:	5e                   	pop    %esi
801046d6:	5f                   	pop    %edi
801046d7:	5d                   	pop    %ebp
801046d8:	c3                   	ret    
    end_op();
801046d9:	e8 4a e1 ff ff       	call   80102828 <end_op>
    return -1;
801046de:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801046e3:	eb ec                	jmp    801046d1 <sys_unlink+0x125>
    panic("unlink: nlink < 1");
801046e5:	83 ec 0c             	sub    $0xc,%esp
801046e8:	68 80 6c 10 80       	push   $0x80106c80
801046ed:	e8 56 bc ff ff       	call   80100348 <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
801046f2:	89 d8                	mov    %ebx,%eax
801046f4:	e8 c4 f9 ff ff       	call   801040bd <isdirempty>
801046f9:	85 c0                	test   %eax,%eax
801046fb:	0f 85 6c ff ff ff    	jne    8010466d <sys_unlink+0xc1>
    iunlockput(ip);
80104701:	83 ec 0c             	sub    $0xc,%esp
80104704:	53                   	push   %ebx
80104705:	e8 1e d0 ff ff       	call   80101728 <iunlockput>
    goto bad;
8010470a:	83 c4 10             	add    $0x10,%esp
  iunlockput(dp);
8010470d:	83 ec 0c             	sub    $0xc,%esp
80104710:	56                   	push   %esi
80104711:	e8 12 d0 ff ff       	call   80101728 <iunlockput>
  end_op();
80104716:	e8 0d e1 ff ff       	call   80102828 <end_op>
  return -1;
8010471b:	83 c4 10             	add    $0x10,%esp
8010471e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104723:	eb ac                	jmp    801046d1 <sys_unlink+0x125>
    panic("unlink: writei");
80104725:	83 ec 0c             	sub    $0xc,%esp
80104728:	68 92 6c 10 80       	push   $0x80106c92
8010472d:	e8 16 bc ff ff       	call   80100348 <panic>
    dp->nlink--;
80104732:	0f b7 46 56          	movzwl 0x56(%esi),%eax
80104736:	83 e8 01             	sub    $0x1,%eax
...
80104749:	e9 52 ff ff ff       	jmp    801046a0 <sys_unlink+0xf4>
    return -1;
8010474e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104753:	e9 79 ff ff ff       	jmp    801046d1 <sys_unlink+0x125>
...
8010475e:	83 ec 24             	sub    $0x24,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
80104761:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80104764:	50                   	push   %eax
80104765:	6a 00                	push   $0x0
80104767:	e8 2b f8 ff ff       	call   80103f97 <argstr>
8010476c:	83 c4 10             	add    $0x10,%esp
8010476f:	85 c0                	test   %eax,%eax
80104771:	0f 88 30 01 00 00    	js     801048a7 <sys_open+0x14f>
80104777:	83 ec 08             	sub    $0x8,%esp
8010477a:	8d 45 e0             	lea    -0x20(%ebp),%eax
8010477d:	50                   	push   %eax
8010477e:	6a 01                	push   $0x1
80104780:	e8 82 f7 ff ff       	call   80103f07 <argint>
80104785:	83 c4 10             	add    $0x10,%esp
80104788:	85 c0                	test   %eax,%eax
8010478a:	0f 88 21 01 00 00    	js     801048b1 <sys_open+0x159>
    return -1;

  begin_op();
80104790:	e8 19 e0 ff ff       	call   801027ae <begin_op>

  if(omode & O_CREATE){
80104795:	f6 45 e1 02          	testb  $0x2,-0x1f(%ebp)
80104799:	0f 84 84 00 00 00    	je     80104823 <sys_open+0xcb>
    ip = create(path, T_FILE, 0, 0);
8010479f:	83 ec 0c             	sub    $0xc,%esp
801047a2:	6a 00                	push   $0x0
801047a4:	b9 00 00 00 00       	mov    $0x0,%ecx
801047a9:	ba 02 00 00 00       	mov    $0x2,%edx
801047ae:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801047b1:	e8 5e f9 ff ff       	call   80104114 <create>
801047b6:	89 c6                	mov    %eax,%esi
    if(ip == 0){
801047b8:	83 c4 10             	add    $0x10,%esp
801047bb:	85 c0                	test   %eax,%eax
801047bd:	74 58                	je     80104817 <sys_open+0xbf>
      end_op();
      return -1;
    }
  }
...
801047bf:	e8 69 c4 ff ff       	call   80100c2d <filealloc>
801047c4:	89 c3                	mov    %eax,%ebx
801047c6:	85 c0                	test   %eax,%eax
801047c8:	0f 84 ae 00 00 00    	je     8010487c <sys_open+0x124>
801047ce:	e8 b3 f8 ff ff       	call   80104086 <fdalloc>
801047d3:	89 c7                	mov    %eax,%edi
801047d5:	85 c0                	test   %eax,%eax
801047d7:	0f 88 9f 00 00 00    	js     8010487c <sys_open+0x124>
      fileclose(f);
    iunlockput(ip);
    end_op();
    return -1;
...
801047e1:	e8 5d ce ff ff       	call   80101643 <iunlock>
  end_op();
801047e6:	e8 3d e0 ff ff       	call   80102828 <end_op>

  f->type = FD_INODE;
801047eb:	c7 03 02 00 00 00    	movl   $0x2,(%ebx)
  f->ip = ip;
801047f1:	89 73 10             	mov    %esi,0x10(%ebx)
  f->off = 0;
801047f4:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
  f->readable = !(omode & O_WRONLY);
801047fb:	8b 45 e0             	mov    -0x20(%ebp),%eax
801047fe:	83 c4 10             	add    $0x10,%esp
80104801:	a8 01                	test   $0x1,%al
80104803:	0f 94 43 08          	sete   0x8(%ebx)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80104807:	a8 03                	test   $0x3,%al
80104809:	0f 95 43 09          	setne  0x9(%ebx)
  return fd;
}
8010480d:	89 f8                	mov    %edi,%eax
...
80104816:	c3                   	ret    
      end_op();
80104817:	e8 0c e0 ff ff       	call   80102828 <end_op>
      return -1;
8010481c:	bf ff ff ff ff       	mov    $0xffffffff,%edi
80104821:	eb ea                	jmp    8010480d <sys_open+0xb5>
    if((ip = namei(path)) == 0){
80104823:	83 ec 0c             	sub    $0xc,%esp
80104826:	ff 75 e4             	pushl  -0x1c(%ebp)
...
80104835:	74 39                	je     80104870 <sys_open+0x118>
    ilock(ip);
80104837:	83 ec 0c             	sub    $0xc,%esp
8010483a:	50                   	push   %eax
8010483b:	e8 41 cd ff ff       	call   80101581 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80104840:	83 c4 10             	add    $0x10,%esp
80104843:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
80104848:	0f 85 71 ff ff ff    	jne    801047bf <sys_open+0x67>
8010484e:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80104852:	0f 84 67 ff ff ff    	je     801047bf <sys_open+0x67>
      iunlockput(ip);
80104858:	83 ec 0c             	sub    $0xc,%esp
8010485b:	56                   	push   %esi
8010485c:	e8 c7 ce ff ff       	call   80101728 <iunlockput>
      end_op();
80104861:	e8 c2 df ff ff       	call   80102828 <end_op>
      return -1;
80104866:	83 c4 10             	add    $0x10,%esp
80104869:	bf ff ff ff ff       	mov    $0xffffffff,%edi
8010486e:	eb 9d                	jmp    8010480d <sys_open+0xb5>
      end_op();
80104870:	e8 b3 df ff ff       	call   80102828 <end_op>
      return -1;
80104875:	bf ff ff ff ff       	mov    $0xffffffff,%edi
8010487a:	eb 91                	jmp    8010480d <sys_open+0xb5>
    if(f)
8010487c:	85 db                	test   %ebx,%ebx
8010487e:	74 0c                	je     8010488c <sys_open+0x134>
      fileclose(f);
80104880:	83 ec 0c             	sub    $0xc,%esp
80104883:	53                   	push   %ebx
80104884:	e8 4a c4 ff ff       	call   80100cd3 <fileclose>
80104889:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
8010488c:	83 ec 0c             	sub    $0xc,%esp
8010488f:	56                   	push   %esi
80104890:	e8 93 ce ff ff       	call   80101728 <iunlockput>
    end_op();
80104895:	e8 8e df ff ff       	call   80102828 <end_op>
    return -1;
8010489a:	83 c4 10             	add    $0x10,%esp
8010489d:	bf ff ff ff ff       	mov    $0xffffffff,%edi
801048a2:	e9 66 ff ff ff       	jmp    8010480d <sys_open+0xb5>
    return -1;
801048a7:	bf ff ff ff ff       	mov    $0xffffffff,%edi
801048ac:	e9 5c ff ff ff       	jmp    8010480d <sys_open+0xb5>
801048b1:	bf ff ff ff ff       	mov    $0xffffffff,%edi
801048b6:	e9 52 ff ff ff       	jmp    8010480d <sys_open+0xb5>
...
801048cf:	e8 c3 f6 ff ff       	call   80103f97 <argstr>
801048d4:	83 c4 10             	add    $0x10,%esp
801048d7:	85 c0                	test   %eax,%eax
801048d9:	78 36                	js     80104911 <sys_mkdir+0x56>
801048db:	83 ec 0c             	sub    $0xc,%esp
801048de:	6a 00                	push   $0x0
801048e0:	b9 00 00 00 00       	mov    $0x0,%ecx
801048e5:	ba 01 00 00 00       	mov    $0x1,%edx
801048ea:	8b 45 f4             	mov    -0xc(%ebp),%eax
801048ed:	e8 22 f8 ff ff       	call   80104114 <create>
801048f2:	83 c4 10             	add    $0x10,%esp
801048f5:	85 c0                	test   %eax,%eax
801048f7:	74 18                	je     80104911 <sys_mkdir+0x56>
    end_op();
    return -1;
  }
  iunlockput(ip);
...
801048fd:	e8 26 ce ff ff       	call   80101728 <iunlockput>
  end_op();
80104902:	e8 21 df ff ff       	call   80102828 <end_op>
  return 0;
80104907:	83 c4 10             	add    $0x10,%esp
8010490a:	b8 00 00 00 00       	mov    $0x0,%eax
}
8010490f:	c9                   	leave  
80104910:	c3                   	ret    
    end_op();
...
8010491b:	eb f2                	jmp    8010490f <sys_mkdir+0x54>
...
80104920:	83 ec 18             	sub    $0x18,%esp
  struct inode *ip;
  char *path;
  int major, minor;

  begin_op();
80104923:	e8 86 de ff ff       	call   801027ae <begin_op>
  if((argstr(0, &path)) < 0 ||
80104928:	83 ec 08             	sub    $0x8,%esp
8010492b:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010492e:	50                   	push   %eax
8010492f:	6a 00                	push   $0x0
80104931:	e8 61 f6 ff ff       	call   80103f97 <argstr>
80104936:	83 c4 10             	add    $0x10,%esp
80104939:	85 c0                	test   %eax,%eax
8010493b:	78 62                	js     8010499f <sys_mknod+0x82>
     argint(1, &major) < 0 ||
8010493d:	83 ec 08             	sub    $0x8,%esp
80104940:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104943:	50                   	push   %eax
80104944:	6a 01                	push   $0x1
80104946:	e8 bc f5 ff ff       	call   80103f07 <argint>
  if((argstr(0, &path)) < 0 ||
8010494b:	83 c4 10             	add    $0x10,%esp
8010494e:	85 c0                	test   %eax,%eax
80104950:	78 4d                	js     8010499f <sys_mknod+0x82>
     argint(2, &minor) < 0 ||
80104952:	83 ec 08             	sub    $0x8,%esp
80104955:	8d 45 ec             	lea    -0x14(%ebp),%eax
80104958:	50                   	push   %eax
80104959:	6a 02                	push   $0x2
8010495b:	e8 a7 f5 ff ff       	call   80103f07 <argint>
     argint(1, &major) < 0 ||
80104960:	83 c4 10             	add    $0x10,%esp
80104963:	85 c0                	test   %eax,%eax
80104965:	78 38                	js     8010499f <sys_mknod+0x82>
     (ip = create(path, T_DEV, major, minor)) == 0){
80104967:	0f bf 45 ec          	movswl -0x14(%ebp),%eax
8010496b:	0f bf 4d f0          	movswl -0x10(%ebp),%ecx
     argint(2, &minor) < 0 ||
8010496f:	83 ec 0c             	sub    $0xc,%esp
80104972:	50                   	push   %eax
80104973:	ba 03 00 00 00       	mov    $0x3,%edx
80104978:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010497b:	e8 94 f7 ff ff       	call   80104114 <create>
80104980:	83 c4 10             	add    $0x10,%esp
80104983:	85 c0                	test   %eax,%eax
80104985:	74 18                	je     8010499f <sys_mknod+0x82>
    end_op();
    return -1;
  }
  iunlockput(ip);
...
8010498b:	e8 98 cd ff ff       	call   80101728 <iunlockput>
  end_op();
80104990:	e8 93 de ff ff       	call   80102828 <end_op>
  return 0;
...
8010499e:	c3                   	ret    
    end_op();
8010499f:	e8 84 de ff ff       	call   80102828 <end_op>
    return -1;
801049a4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801049a9:	eb f2                	jmp    8010499d <sys_mknod+0x80>
...
801049b0:	83 ec 10             	sub    $0x10,%esp
  char *path;
  struct inode *ip;
  struct proc *curproc = myproc();
801049b3:	e8 3e e8 ff ff       	call   801031f6 <myproc>
801049b8:	89 c6                	mov    %eax,%esi
  
  begin_op();
801049ba:	e8 ef dd ff ff       	call   801027ae <begin_op>
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
801049bf:	83 ec 08             	sub    $0x8,%esp
801049c2:	8d 45 f4             	lea    -0xc(%ebp),%eax
801049c5:	50                   	push   %eax
801049c6:	6a 00                	push   $0x0
801049c8:	e8 ca f5 ff ff       	call   80103f97 <argstr>
801049cd:	83 c4 10             	add    $0x10,%esp
801049d0:	85 c0                	test   %eax,%eax
801049d2:	78 52                	js     80104a26 <sys_chdir+0x7b>
801049d4:	83 ec 0c             	sub    $0xc,%esp
801049d7:	ff 75 f4             	pushl  -0xc(%ebp)
801049da:	e8 02 d2 ff ff       	call   80101be1 <namei>
801049df:	89 c3                	mov    %eax,%ebx
801049e1:	83 c4 10             	add    $0x10,%esp
801049e4:	85 c0                	test   %eax,%eax
801049e6:	74 3e                	je     80104a26 <sys_chdir+0x7b>
    end_op();
    return -1;
  }
  ilock(ip);
...
801049ec:	e8 90 cb ff ff       	call   80101581 <ilock>
  if(ip->type != T_DIR){
801049f1:	83 c4 10             	add    $0x10,%esp
801049f4:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
801049f9:	75 37                	jne    80104a32 <sys_chdir+0x87>
    iunlockput(ip);
    end_op();
    return -1;
  }
...
801049ff:	e8 3f cc ff ff       	call   80101643 <iunlock>
  iput(curproc->cwd);
80104a04:	83 c4 04             	add    $0x4,%esp
80104a07:	ff 76 68             	pushl  0x68(%esi)
80104a0a:	e8 79 cc ff ff       	call   80101688 <iput>
  end_op();
80104a0f:	e8 14 de ff ff       	call   80102828 <end_op>
  curproc->cwd = ip;
80104a14:	89 5e 68             	mov    %ebx,0x68(%esi)
  return 0;
...
80104a4e:	81 ec 9c 00 00 00    	sub    $0x9c,%esp
...
80104a5a:	e8 38 f5 ff ff       	call   80103f97 <argstr>
80104a5f:	83 c4 10             	add    $0x10,%esp
80104a62:	85 c0                	test   %eax,%eax
80104a64:	0f 88 a8 00 00 00    	js     80104b12 <sys_exec+0xc8>
80104a6a:	83 ec 08             	sub    $0x8,%esp
80104a6d:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80104a73:	50                   	push   %eax
80104a74:	6a 01                	push   $0x1
80104a76:	e8 8c f4 ff ff       	call   80103f07 <argint>
80104a7b:	83 c4 10             	add    $0x10,%esp
80104a7e:	85 c0                	test   %eax,%eax
80104a80:	0f 88 93 00 00 00    	js     80104b19 <sys_exec+0xcf>
    return -1;
  }
  memset(argv, 0, sizeof(argv));
80104a86:	83 ec 04             	sub    $0x4,%esp
80104a89:	68 80 00 00 00       	push   $0x80
80104a8e:	6a 00                	push   $0x0
80104a90:	8d 85 74 ff ff ff    	lea    -0x8c(%ebp),%eax
80104a96:	50                   	push   %eax
80104a97:	e8 20 f2 ff ff       	call   80103cbc <memset>
80104a9c:	83 c4 10             	add    $0x10,%esp
  for(i=0;; i++){
80104a9f:	bb 00 00 00 00       	mov    $0x0,%ebx
    if(i >= NELEM(argv))
80104aa4:	83 fb 1f             	cmp    $0x1f,%ebx
80104aa7:	77 77                	ja     80104b20 <sys_exec+0xd6>
      return -1;
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80104aa9:	83 ec 08             	sub    $0x8,%esp
80104aac:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
80104ab2:	50                   	push   %eax
80104ab3:	8b 85 70 ff ff ff    	mov    -0x90(%ebp),%eax
80104ab9:	8d 04 98             	lea    (%eax,%ebx,4),%eax
80104abc:	50                   	push   %eax
80104abd:	e8 c9 f3 ff ff       	call   80103e8b <fetchint>
80104ac2:	83 c4 10             	add    $0x10,%esp
80104ac5:	85 c0                	test   %eax,%eax
80104ac7:	78 5e                	js     80104b27 <sys_exec+0xdd>
      return -1;
    if(uarg == 0){
80104ac9:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
80104acf:	85 c0                	test   %eax,%eax
80104ad1:	74 1d                	je     80104af0 <sys_exec+0xa6>
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
80104ad3:	83 ec 08             	sub    $0x8,%esp
80104ad6:	8d 94 9d 74 ff ff ff 	lea    -0x8c(%ebp,%ebx,4),%edx
80104add:	52                   	push   %edx
80104ade:	50                   	push   %eax
80104adf:	e8 e3 f3 ff ff       	call   80103ec7 <fetchstr>
80104ae4:	83 c4 10             	add    $0x10,%esp
80104ae7:	85 c0                	test   %eax,%eax
80104ae9:	78 46                	js     80104b31 <sys_exec+0xe7>
  for(i=0;; i++){
80104aeb:	83 c3 01             	add    $0x1,%ebx
    if(i >= NELEM(argv))
80104aee:	eb b4                	jmp    80104aa4 <sys_exec+0x5a>
      argv[i] = 0;
80104af0:	c7 84 9d 74 ff ff ff 	movl   $0x0,-0x8c(%ebp,%ebx,4)
80104af7:	00 00 00 00 
      return -1;
  }
...
80104b05:	ff 75 f4             	pushl  -0xc(%ebp)
80104b08:	e8 c5 bd ff ff       	call   801008d2 <exec>
80104b0d:	83 c4 10             	add    $0x10,%esp
80104b10:	eb 1a                	jmp    80104b2c <sys_exec+0xe2>
    return -1;
80104b12:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104b17:	eb 13                	jmp    80104b2c <sys_exec+0xe2>
80104b19:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104b1e:	eb 0c                	jmp    80104b2c <sys_exec+0xe2>
      return -1;
80104b20:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104b25:	eb 05                	jmp    80104b2c <sys_exec+0xe2>
      return -1;
80104b27:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
80104b2c:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104b2f:	c9                   	leave  
80104b30:	c3                   	ret    
      return -1;
80104b31:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104b36:	eb f4                	jmp    80104b2c <sys_exec+0xe2>
...
80104b3f:	6a 08                	push   $0x8
80104b41:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104b44:	50                   	push   %eax
80104b45:	6a 00                	push   $0x0
80104b47:	e8 e3 f3 ff ff       	call   80103f2f <argptr>
80104b4c:	83 c4 10             	add    $0x10,%esp
80104b4f:	85 c0                	test   %eax,%eax
80104b51:	78 77                	js     80104bca <sys_pipe+0x92>
    return -1;
  if(pipealloc(&rf, &wf) < 0)
80104b53:	83 ec 08             	sub    $0x8,%esp
80104b56:	8d 45 ec             	lea    -0x14(%ebp),%eax
80104b59:	50                   	push   %eax
80104b5a:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104b5d:	50                   	push   %eax
80104b5e:	e8 d2 e1 ff ff       	call   80102d35 <pipealloc>
80104b63:	83 c4 10             	add    $0x10,%esp
80104b66:	85 c0                	test   %eax,%eax
80104b68:	78 67                	js     80104bd1 <sys_pipe+0x99>
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80104b6a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104b6d:	e8 14 f5 ff ff       	call   80104086 <fdalloc>
80104b72:	89 c3                	mov    %eax,%ebx
80104b74:	85 c0                	test   %eax,%eax
80104b76:	78 21                	js     80104b99 <sys_pipe+0x61>
80104b78:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104b7b:	e8 06 f5 ff ff       	call   80104086 <fdalloc>
80104b80:	85 c0                	test   %eax,%eax
80104b82:	78 15                	js     80104b99 <sys_pipe+0x61>
      myproc()->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
...
80104b87:	89 1a                	mov    %ebx,(%edx)
  fd[1] = fd1;
80104b89:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104b8c:	89 42 04             	mov    %eax,0x4(%edx)
  return 0;
...
80104b98:	c3                   	ret    
    if(fd0 >= 0)
80104b99:	85 db                	test   %ebx,%ebx
80104b9b:	78 0d                	js     80104baa <sys_pipe+0x72>
      myproc()->ofile[fd0] = 0;
80104b9d:	e8 54 e6 ff ff       	call   801031f6 <myproc>
80104ba2:	c7 44 98 28 00 00 00 	movl   $0x0,0x28(%eax,%ebx,4)
80104ba9:	00 
    fileclose(rf);
80104baa:	83 ec 0c             	sub    $0xc,%esp
80104bad:	ff 75 f0             	pushl  -0x10(%ebp)
80104bb0:	e8 1e c1 ff ff       	call   80100cd3 <fileclose>
    fileclose(wf);
80104bb5:	83 c4 04             	add    $0x4,%esp
80104bb8:	ff 75 ec             	pushl  -0x14(%ebp)
80104bbb:	e8 13 c1 ff ff       	call   80100cd3 <fileclose>
    return -1;
80104bc0:	83 c4 10             	add    $0x10,%esp
80104bc3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104bc8:	eb ca                	jmp    80104b94 <sys_pipe+0x5c>
    return -1;
80104bca:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104bcf:	eb c3                	jmp    80104b94 <sys_pipe+0x5c>
    return -1;
80104bd1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104bd6:	eb bc                	jmp    80104b94 <sys_pipe+0x5c>

80104bd8 <sys_getofilecnt>:
#include "proc.h"

//return # of files for proc pid
int
...
80104be4:	e8 1e f3 ff ff       	call   80103f07 <argint>
80104be9:	83 c4 10             	add    $0x10,%esp
80104bec:	85 c0                	test   %eax,%eax
80104bee:	78 10                	js     80104c00 <sys_getofilecnt+0x28>
    return -1;
  return getofilecnt(pid);
80104bf0:	83 ec 0c             	sub    $0xc,%esp
80104bf3:	ff 75 f4             	pushl  -0xc(%ebp)
80104bf6:	e8 53 ed ff ff       	call   8010394e <getofilecnt>
...
80104c05:	eb f7                	jmp    80104bfe <sys_getofilecnt+0x26>

80104c07 <sys_getofilenext>:
...
80104c34:	eb f7                	jmp    80104c2d <sys_getofilenext+0x26>
...
80104c39:	83 ec 08             	sub    $0x8,%esp
  return fork();
80104c3c:	e8 2d e7 ff ff       	call   8010336e <fork>
}
80104c41:	c9                   	leave  
80104c42:	c3                   	ret    
...
80104c46:	83 ec 08             	sub    $0x8,%esp
  exit();
80104c49:	e8 54 e9 ff ff       	call   801035a2 <exit>
...
80104c58:	83 ec 08             	sub    $0x8,%esp
  return wait();
80104c5b:	e8 cb ea ff ff       	call   8010372b <wait>
}
80104c60:	c9                   	leave  
80104c61:	c3                   	ret    
...
80104c65:	83 ec 20             	sub    $0x20,%esp
  int pid;

  if(argint(0, &pid) < 0)
80104c68:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104c6b:	50                   	push   %eax
80104c6c:	6a 00                	push   $0x0
80104c6e:	e8 94 f2 ff ff       	call   80103f07 <argint>
80104c73:	83 c4 10             	add    $0x10,%esp
80104c76:	85 c0                	test   %eax,%eax
80104c78:	78 10                	js     80104c8a <sys_kill+0x28>
    return -1;
  return kill(pid);
80104c7a:	83 ec 0c             	sub    $0xc,%esp
80104c7d:	ff 75 f4             	pushl  -0xc(%ebp)
80104c80:	e8 a3 eb ff ff       	call   80103828 <kill>
...
80104c8f:	eb f7                	jmp    80104c88 <sys_kill+0x26>
...
80104c94:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80104c97:	e8 5a e5 ff ff       	call   801031f6 <myproc>
80104c9c:	8b 40 10             	mov    0x10(%eax),%eax
}
80104c9f:	c9                   	leave  
80104ca0:	c3                   	ret    
...
80104cae:	e8 54 f2 ff ff       	call   80103f07 <argint>
80104cb3:	83 c4 10             	add    $0x10,%esp
80104cb6:	85 c0                	test   %eax,%eax
80104cb8:	78 27                	js     80104ce1 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80104cba:	e8 37 e5 ff ff       	call   801031f6 <myproc>
80104cbf:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
80104cc1:	83 ec 0c             	sub    $0xc,%esp
80104cc4:	ff 75 f4             	pushl  -0xc(%ebp)
80104cc7:	e8 35 e6 ff ff       	call   80103301 <growproc>
80104ccc:	83 c4 10             	add    $0x10,%esp
80104ccf:	85 c0                	test   %eax,%eax
80104cd1:	78 07                	js     80104cda <sys_sbrk+0x39>
    return -1;
  return addr;
}
...
80104cdf:	eb f2                	jmp    80104cd3 <sys_sbrk+0x32>
    return -1;
80104ce1:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80104ce6:	eb eb                	jmp    80104cd3 <sys_sbrk+0x32>
...
80104cec:	83 ec 1c             	sub    $0x1c,%esp
  int n;
  uint ticks0;
...
80104cf3:	6a 00                	push   $0x0
80104cf5:	e8 0d f2 ff ff       	call   80103f07 <argint>
80104cfa:	83 c4 10             	add    $0x10,%esp
80104cfd:	85 c0                	test   %eax,%eax
80104cff:	78 75                	js     80104d76 <sys_sleep+0x8e>
    return -1;
  acquire(&tickslock);
80104d01:	83 ec 0c             	sub    $0xc,%esp
80104d04:	68 60 3c 11 80       	push   $0x80113c60
80104d09:	e8 02 ef ff ff       	call   80103c10 <acquire>
  ticks0 = ticks;
80104d0e:	8b 1d a0 44 11 80    	mov    0x801144a0,%ebx
  while(ticks - ticks0 < n){
80104d14:	83 c4 10             	add    $0x10,%esp
80104d17:	a1 a0 44 11 80       	mov    0x801144a0,%eax
80104d1c:	29 d8                	sub    %ebx,%eax
80104d1e:	3b 45 f4             	cmp    -0xc(%ebp),%eax
80104d21:	73 39                	jae    80104d5c <sys_sleep+0x74>
    if(myproc()->killed){
80104d23:	e8 ce e4 ff ff       	call   801031f6 <myproc>
80104d28:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104d2c:	75 17                	jne    80104d45 <sys_sleep+0x5d>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
80104d2e:	83 ec 08             	sub    $0x8,%esp
80104d31:	68 60 3c 11 80       	push   $0x80113c60
80104d36:	68 a0 44 11 80       	push   $0x801144a0
80104d3b:	e8 5a e9 ff ff       	call   8010369a <sleep>
80104d40:	83 c4 10             	add    $0x10,%esp
80104d43:	eb d2                	jmp    80104d17 <sys_sleep+0x2f>
      release(&tickslock);
80104d45:	83 ec 0c             	sub    $0xc,%esp
80104d48:	68 60 3c 11 80       	push   $0x80113c60
80104d4d:	e8 23 ef ff ff       	call   80103c75 <release>
      return -1;
80104d52:	83 c4 10             	add    $0x10,%esp
80104d55:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104d5a:	eb 15                	jmp    80104d71 <sys_sleep+0x89>
  }
  release(&tickslock);
80104d5c:	83 ec 0c             	sub    $0xc,%esp
80104d5f:	68 60 3c 11 80       	push   $0x80113c60
80104d64:	e8 0c ef ff ff       	call   80103c75 <release>
  return 0;
...
80104d7b:	eb f4                	jmp    80104d71 <sys_sleep+0x89>
...
80104d81:	83 ec 10             	sub    $0x10,%esp
  uint xticks;

  acquire(&tickslock);
80104d84:	68 60 3c 11 80       	push   $0x80113c60
80104d89:	e8 82 ee ff ff       	call   80103c10 <acquire>
  xticks = ticks;
80104d8e:	8b 1d a0 44 11 80    	mov    0x801144a0,%ebx
  release(&tickslock);
80104d94:	c7 04 24 60 3c 11 80 	movl   $0x80113c60,(%esp)
80104d9b:	e8 d5 ee ff ff       	call   80103c75 <release>
  return xticks;
}
...
80104da8:	06                   	push   %es
  pushl %fs
80104da9:	0f a0                	push   %fs
  pushl %gs
80104dab:	0f a8                	push   %gs
  pushal
80104dad:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80104dae:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80104db2:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80104db4:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80104db6:	54                   	push   %esp
  call trap
80104db7:	e8 e3 00 00 00       	call   80104e9f <trap>
  addl $4, %esp
...
80104dbf:	61                   	popa   
  popl %gs
80104dc0:	0f a9                	pop    %gs
  popl %fs
80104dc2:	0f a1                	pop    %fs
  popl %es
80104dc4:	07                   	pop    %es
  popl %ds
80104dc5:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80104dc6:	83 c4 08             	add    $0x8,%esp
  iret
80104dc9:	cf                   	iret   
...
80104dd5:	eb 4a                	jmp    80104e21 <tvinit+0x57>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80104dd7:	8b 0c 85 08 90 10 80 	mov    -0x7fef6ff8(,%eax,4),%ecx
80104dde:	66 89 0c c5 a0 3c 11 	mov    %cx,-0x7feec360(,%eax,8)
80104de5:	80 
80104de6:	66 c7 04 c5 a2 3c 11 	movw   $0x8,-0x7feec35e(,%eax,8)
80104ded:	80 08 00 
80104df0:	c6 04 c5 a4 3c 11 80 	movb   $0x0,-0x7feec35c(,%eax,8)
80104df7:	00 
80104df8:	0f b6 14 c5 a5 3c 11 	movzbl -0x7feec35b(,%eax,8),%edx
80104dff:	80 
80104e00:	83 e2 f0             	and    $0xfffffff0,%edx
80104e03:	83 ca 0e             	or     $0xe,%edx
80104e06:	83 e2 8f             	and    $0xffffff8f,%edx
80104e09:	83 ca 80             	or     $0xffffff80,%edx
80104e0c:	88 14 c5 a5 3c 11 80 	mov    %dl,-0x7feec35b(,%eax,8)
80104e13:	c1 e9 10             	shr    $0x10,%ecx
80104e16:	66 89 0c c5 a6 3c 11 	mov    %cx,-0x7feec35a(,%eax,8)
80104e1d:	80 
  for(i = 0; i < 256; i++)
80104e1e:	83 c0 01             	add    $0x1,%eax
80104e21:	3d ff 00 00 00       	cmp    $0xff,%eax
80104e26:	7e af                	jle    80104dd7 <tvinit+0xd>
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80104e28:	8b 15 08 91 10 80    	mov    0x80109108,%edx
80104e2e:	66 89 15 a0 3e 11 80 	mov    %dx,0x80113ea0
80104e35:	66 c7 05 a2 3e 11 80 	movw   $0x8,0x80113ea2
80104e3c:	08 00 
80104e3e:	c6 05 a4 3e 11 80 00 	movb   $0x0,0x80113ea4
80104e45:	0f b6 05 a5 3e 11 80 	movzbl 0x80113ea5,%eax
...
80104e67:	68 a1 6c 10 80       	push   $0x80106ca1
80104e6c:	68 60 3c 11 80       	push   $0x80113c60
80104e71:	e8 5e ec ff ff       	call   80103ad4 <initlock>
}
...
80104e7e:	83 ec 10             	sub    $0x10,%esp
  pd[0] = size-1;
80104e81:	66 c7 45 fa ff 07    	movw   $0x7ff,-0x6(%ebp)
  pd[1] = (uint)p;
80104e87:	b8 a0 3c 11 80       	mov    $0x80113ca0,%eax
80104e8c:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80104e90:	c1 e8 10             	shr    $0x10,%eax
80104e93:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lidt (%0)" : : "r" (pd));
80104e97:	8d 45 fa             	lea    -0x6(%ebp),%eax
80104e9a:	0f 01 18             	lidtl  (%eax)
  lidt(idt, sizeof(idt));
}
80104e9d:	c9                   	leave  
80104e9e:	c3                   	ret    
...
80104ea5:	83 ec 1c             	sub    $0x1c,%esp
80104ea8:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(tf->trapno == T_SYSCALL){
80104eab:	8b 43 30             	mov    0x30(%ebx),%eax
80104eae:	83 f8 40             	cmp    $0x40,%eax
80104eb1:	74 13                	je     80104ec6 <trap+0x27>
    if(myproc()->killed)
      exit();
    return;
  }
  ...
  switch(tf->trapno){
80104eb3:	83 e8 20             	sub    $0x20,%eax
80104eb6:	83 f8 1f             	cmp    $0x1f,%eax
80104eb9:	0f 87 3a 01 00 00    	ja     80104ff9 <trap+0x15a>
80104ebf:	ff 24 85 48 6d 10 80 	jmp    *-0x7fef92b8(,%eax,4)
    if(myproc()->killed)
80104ec6:	e8 2b e3 ff ff       	call   801031f6 <myproc>
80104ecb:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104ecf:	75 1f                	jne    80104ef0 <trap+0x51>
    myproc()->tf = tf;
80104ed1:	e8 20 e3 ff ff       	call   801031f6 <myproc>
80104ed6:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80104ed9:	e8 ec f0 ff ff       	call   80103fca <syscall>
    if(myproc()->killed)
80104ede:	e8 13 e3 ff ff       	call   801031f6 <myproc>
80104ee3:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104ee7:	74 7e                	je     80104f67 <trap+0xc8>
      exit();
80104ee9:	e8 b4 e6 ff ff       	call   801035a2 <exit>
80104eee:	eb 77                	jmp    80104f67 <trap+0xc8>
      exit();
80104ef0:	e8 ad e6 ff ff       	call   801035a2 <exit>
80104ef5:	eb da                	jmp    80104ed1 <trap+0x32>
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80104ef7:	e8 df e2 ff ff       	call   801031db <cpuid>
80104efc:	85 c0                	test   %eax,%eax
80104efe:	74 6f                	je     80104f6f <trap+0xd0>
      acquire(&tickslock);
      ticks++;
      wakeup(&ticks);
      release(&tickslock);
    ...
    lapiceoi();
80104f00:	e8 94 d4 ff ff       	call   80102399 <lapiceoi>
  }
...
80104f0c:	74 1c                	je     80104f2a <trap+0x8b>
80104f0e:	e8 e3 e2 ff ff       	call   801031f6 <myproc>
80104f13:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104f17:	74 11                	je     80104f2a <trap+0x8b>
80104f19:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80104f1d:	83 e0 03             	and    $0x3,%eax
80104f20:	66 83 f8 03          	cmp    $0x3,%ax
80104f24:	0f 84 62 01 00 00    	je     8010508c <trap+0x1ed>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80104f2a:	e8 c7 e2 ff ff       	call   801031f6 <myproc>
80104f2f:	85 c0                	test   %eax,%eax
80104f31:	74 0f                	je     80104f42 <trap+0xa3>
80104f33:	e8 be e2 ff ff       	call   801031f6 <myproc>
80104f38:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80104f3c:	0f 84 54 01 00 00    	je     80105096 <trap+0x1f7>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80104f42:	e8 af e2 ff ff       	call   801031f6 <myproc>
80104f47:	85 c0                	test   %eax,%eax
80104f49:	74 1c                	je     80104f67 <trap+0xc8>
80104f4b:	e8 a6 e2 ff ff       	call   801031f6 <myproc>
80104f50:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104f54:	74 11                	je     80104f67 <trap+0xc8>
80104f56:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80104f5a:	83 e0 03             	and    $0x3,%eax
80104f5d:	66 83 f8 03          	cmp    $0x3,%ax
80104f61:	0f 84 43 01 00 00    	je     801050aa <trap+0x20b>
    exit();
}
...
80104f72:	68 60 3c 11 80       	push   $0x80113c60
80104f77:	e8 94 ec ff ff       	call   80103c10 <acquire>
      ticks++;
80104f7c:	83 05 a0 44 11 80 01 	addl   $0x1,0x801144a0
      wakeup(&ticks);
80104f83:	c7 04 24 a0 44 11 80 	movl   $0x801144a0,(%esp)
80104f8a:	e8 70 e8 ff ff       	call   801037ff <wakeup>
      release(&tickslock);
80104f8f:	c7 04 24 60 3c 11 80 	movl   $0x80113c60,(%esp)
80104f96:	e8 da ec ff ff       	call   80103c75 <release>
80104f9b:	83 c4 10             	add    $0x10,%esp
80104f9e:	e9 5d ff ff ff       	jmp    80104f00 <trap+0x61>
    ideintr();
80104fa3:	e8 cb cd ff ff       	call   80101d73 <ideintr>
    lapiceoi();
80104fa8:	e8 ec d3 ff ff       	call   80102399 <lapiceoi>
    break;
80104fad:	e9 53 ff ff ff       	jmp    80104f05 <trap+0x66>
    kbdintr();
80104fb2:	e8 26 d2 ff ff       	call   801021dd <kbdintr>
    lapiceoi();
80104fb7:	e8 dd d3 ff ff       	call   80102399 <lapiceoi>
    break;
80104fbc:	e9 44 ff ff ff       	jmp    80104f05 <trap+0x66>
    uartintr();
80104fc1:	e8 05 02 00 00       	call   801051cb <uartintr>
    lapiceoi();
80104fc6:	e8 ce d3 ff ff       	call   80102399 <lapiceoi>
    break;
80104fcb:	e9 35 ff ff ff       	jmp    80104f05 <trap+0x66>
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80104fd0:	8b 7b 38             	mov    0x38(%ebx),%edi
            cpuid(), tf->cs, tf->eip);
80104fd3:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80104fd7:	e8 ff e1 ff ff       	call   801031db <cpuid>
80104fdc:	57                   	push   %edi
80104fdd:	0f b7 f6             	movzwl %si,%esi
80104fe0:	56                   	push   %esi
80104fe1:	50                   	push   %eax
80104fe2:	68 ac 6c 10 80       	push   $0x80106cac
80104fe7:	e8 1f b6 ff ff       	call   8010060b <cprintf>
    lapiceoi();
80104fec:	e8 a8 d3 ff ff       	call   80102399 <lapiceoi>
    break;
80104ff1:	83 c4 10             	add    $0x10,%esp
80104ff4:	e9 0c ff ff ff       	jmp    80104f05 <trap+0x66>
    if(myproc() == 0 || (tf->cs&3) == 0){
80104ff9:	e8 f8 e1 ff ff       	call   801031f6 <myproc>
80104ffe:	85 c0                	test   %eax,%eax
80105000:	74 5f                	je     80105061 <trap+0x1c2>
80105002:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105006:	74 59                	je     80105061 <trap+0x1c2>
...
80105008:	0f 20 d7             	mov    %cr2,%edi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010500b:	8b 43 38             	mov    0x38(%ebx),%eax
8010500e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80105011:	e8 c5 e1 ff ff       	call   801031db <cpuid>
80105016:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105019:	8b 53 34             	mov    0x34(%ebx),%edx
8010501c:	89 55 dc             	mov    %edx,-0x24(%ebp)
8010501f:	8b 73 30             	mov    0x30(%ebx),%esi
            myproc()->pid, myproc()->name, tf->trapno,
80105022:	e8 cf e1 ff ff       	call   801031f6 <myproc>
80105027:	8d 48 6c             	lea    0x6c(%eax),%ecx
8010502a:	89 4d d8             	mov    %ecx,-0x28(%ebp)
8010502d:	e8 c4 e1 ff ff       	call   801031f6 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105032:	57                   	push   %edi
80105033:	ff 75 e4             	pushl  -0x1c(%ebp)
80105036:	ff 75 e0             	pushl  -0x20(%ebp)
80105039:	ff 75 dc             	pushl  -0x24(%ebp)
8010503c:	56                   	push   %esi
8010503d:	ff 75 d8             	pushl  -0x28(%ebp)
80105040:	ff 70 10             	pushl  0x10(%eax)
80105043:	68 04 6d 10 80       	push   $0x80106d04
80105048:	e8 be b5 ff ff       	call   8010060b <cprintf>
    myproc()->killed = 1;
8010504d:	83 c4 20             	add    $0x20,%esp
80105050:	e8 a1 e1 ff ff       	call   801031f6 <myproc>
80105055:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
8010505c:	e9 a4 fe ff ff       	jmp    80104f05 <trap+0x66>
80105061:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105064:	8b 73 38             	mov    0x38(%ebx),%esi
80105067:	e8 6f e1 ff ff       	call   801031db <cpuid>
8010506c:	83 ec 0c             	sub    $0xc,%esp
8010506f:	57                   	push   %edi
80105070:	56                   	push   %esi
80105071:	50                   	push   %eax
80105072:	ff 73 30             	pushl  0x30(%ebx)
80105075:	68 d0 6c 10 80       	push   $0x80106cd0
8010507a:	e8 8c b5 ff ff       	call   8010060b <cprintf>
      panic("trap");
8010507f:	83 c4 14             	add    $0x14,%esp
80105082:	68 a6 6c 10 80       	push   $0x80106ca6
80105087:	e8 bc b2 ff ff       	call   80100348 <panic>
    exit();
8010508c:	e8 11 e5 ff ff       	call   801035a2 <exit>
80105091:	e9 94 fe ff ff       	jmp    80104f2a <trap+0x8b>
  if(myproc() && myproc()->state == RUNNING &&
80105096:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
8010509a:	0f 85 a2 fe ff ff    	jne    80104f42 <trap+0xa3>
    yield();
801050a0:	e8 c3 e5 ff ff       	call   80103668 <yield>
801050a5:	e9 98 fe ff ff       	jmp    80104f42 <trap+0xa3>
    exit();
801050aa:	e8 f3 e4 ff ff       	call   801035a2 <exit>
801050af:	e9 b3 fe ff ff       	jmp    80104f67 <trap+0xc8>
...
801050b5:	89 e5                	mov    %esp,%ebp
  if(!uart)
801050b7:	83 3d bc 95 10 80 00 	cmpl   $0x0,0x801095bc
801050be:	74 15                	je     801050d5 <uartgetc+0x21>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
801050c0:	ba fd 03 00 00       	mov    $0x3fd,%edx
801050c5:	ec                   	in     (%dx),%al
    return -1;
  if(!(inb(COM1+5) & 0x01))
801050c6:	a8 01                	test   $0x1,%al
801050c8:	74 12                	je     801050dc <uartgetc+0x28>
801050ca:	ba f8 03 00 00       	mov    $0x3f8,%edx
801050cf:	ec                   	in     (%dx),%al
    return -1;
  return inb(COM1+0);
801050d0:	0f b6 c0             	movzbl %al,%eax
}
801050d3:	5d                   	pop    %ebp
801050d4:	c3                   	ret    
    return -1;
801050d5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801050da:	eb f7                	jmp    801050d3 <uartgetc+0x1f>
    return -1;
801050dc:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801050e1:	eb f0                	jmp    801050d3 <uartgetc+0x1f>

801050e3 <uartputc>:
  if(!uart)
801050e3:	83 3d bc 95 10 80 00 	cmpl   $0x0,0x801095bc
801050ea:	74 3b                	je     80105127 <uartputc+0x44>
{
...
801050f3:	bb 00 00 00 00       	mov    $0x0,%ebx
801050f8:	eb 10                	jmp    8010510a <uartputc+0x27>
    microdelay(10);
801050fa:	83 ec 0c             	sub    $0xc,%esp
801050fd:	6a 0a                	push   $0xa
801050ff:	e8 b4 d2 ff ff       	call   801023b8 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80105104:	83 c3 01             	add    $0x1,%ebx
80105107:	83 c4 10             	add    $0x10,%esp
8010510a:	83 fb 7f             	cmp    $0x7f,%ebx
8010510d:	7f 0a                	jg     80105119 <uartputc+0x36>
8010510f:	ba fd 03 00 00       	mov    $0x3fd,%edx
80105114:	ec                   	in     (%dx),%al
80105115:	a8 20                	test   $0x20,%al
80105117:	74 e1                	je     801050fa <uartputc+0x17>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105119:	8b 45 08             	mov    0x8(%ebp),%eax
8010511c:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105121:	ee                   	out    %al,(%dx)
}
80105122:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80105125:	c9                   	leave  
80105126:	c3                   	ret    
80105127:	f3 c3                	repz ret 
...
8010517d:	74 45                	je     801051c4 <uartinit+0x9b>
  uart = 1;
8010517f:	c7 05 bc 95 10 80 01 	movl   $0x1,0x801095bc
80105186:	00 00 00 
...
8010519c:	e8 dd cd ff ff       	call   80101f7e <ioapicenable>
  for(p="xv6...\n"; *p; p++)
801051a1:	83 c4 10             	add    $0x10,%esp
801051a4:	bb c8 6d 10 80       	mov    $0x80106dc8,%ebx
...
801051b2:	e8 2c ff ff ff       	call   801050e3 <uartputc>
  for(p="xv6...\n"; *p; p++)
...
801051d1:	68 b4 50 10 80       	push   $0x801050b4
801051d6:	e8 63 b5 ff ff       	call   8010073e <consoleintr>
}
...
801051e2:	6a 00                	push   $0x0
  jmp alltraps
801051e4:	e9 be fb ff ff       	jmp    80104da7 <alltraps>
...
801051eb:	6a 01                	push   $0x1
  jmp alltraps
801051ed:	e9 b5 fb ff ff       	jmp    80104da7 <alltraps>
...
801051f4:	6a 02                	push   $0x2
  jmp alltraps
801051f6:	e9 ac fb ff ff       	jmp    80104da7 <alltraps>
...
801051fd:	6a 03                	push   $0x3
  jmp alltraps
801051ff:	e9 a3 fb ff ff       	jmp    80104da7 <alltraps>
...
80105206:	6a 04                	push   $0x4
  jmp alltraps
80105208:	e9 9a fb ff ff       	jmp    80104da7 <alltraps>
...
8010520f:	6a 05                	push   $0x5
  jmp alltraps
80105211:	e9 91 fb ff ff       	jmp    80104da7 <alltraps>
...
80105218:	6a 06                	push   $0x6
  jmp alltraps
8010521a:	e9 88 fb ff ff       	jmp    80104da7 <alltraps>
...
80105221:	6a 07                	push   $0x7
  jmp alltraps
80105223:	e9 7f fb ff ff       	jmp    80104da7 <alltraps>
...
80105228:	6a 08                	push   $0x8
  jmp alltraps
8010522a:	e9 78 fb ff ff       	jmp    80104da7 <alltraps>
...
80105231:	6a 09                	push   $0x9
  jmp alltraps
80105233:	e9 6f fb ff ff       	jmp    80104da7 <alltraps>
...
80105238:	6a 0a                	push   $0xa
  jmp alltraps
8010523a:	e9 68 fb ff ff       	jmp    80104da7 <alltraps>
...
8010523f:	6a 0b                	push   $0xb
  jmp alltraps
80105241:	e9 61 fb ff ff       	jmp    80104da7 <alltraps>
...
80105246:	6a 0c                	push   $0xc
  jmp alltraps
80105248:	e9 5a fb ff ff       	jmp    80104da7 <alltraps>
...
8010524d:	6a 0d                	push   $0xd
  jmp alltraps
8010524f:	e9 53 fb ff ff       	jmp    80104da7 <alltraps>
...
80105254:	6a 0e                	push   $0xe
  jmp alltraps
80105256:	e9 4c fb ff ff       	jmp    80104da7 <alltraps>
...
8010525d:	6a 0f                	push   $0xf
  jmp alltraps
8010525f:	e9 43 fb ff ff       	jmp    80104da7 <alltraps>
...
80105266:	6a 10                	push   $0x10
  jmp alltraps
80105268:	e9 3a fb ff ff       	jmp    80104da7 <alltraps>
...
8010526d:	6a 11                	push   $0x11
  jmp alltraps
8010526f:	e9 33 fb ff ff       	jmp    80104da7 <alltraps>
...
80105276:	6a 12                	push   $0x12
  jmp alltraps
80105278:	e9 2a fb ff ff       	jmp    80104da7 <alltraps>
...
8010527f:	6a 13                	push   $0x13
  jmp alltraps
80105281:	e9 21 fb ff ff       	jmp    80104da7 <alltraps>
...
80105288:	6a 14                	push   $0x14
  jmp alltraps
8010528a:	e9 18 fb ff ff       	jmp    80104da7 <alltraps>
...
80105291:	6a 15                	push   $0x15
  jmp alltraps
80105293:	e9 0f fb ff ff       	jmp    80104da7 <alltraps>
...
8010529a:	6a 16                	push   $0x16
  jmp alltraps
8010529c:	e9 06 fb ff ff       	jmp    80104da7 <alltraps>
...
801052a3:	6a 17                	push   $0x17
  jmp alltraps
801052a5:	e9 fd fa ff ff       	jmp    80104da7 <alltraps>
...
801052ac:	6a 18                	push   $0x18
  jmp alltraps
801052ae:	e9 f4 fa ff ff       	jmp    80104da7 <alltraps>
...
801052b5:	6a 19                	push   $0x19
  jmp alltraps
801052b7:	e9 eb fa ff ff       	jmp    80104da7 <alltraps>
...
801052be:	6a 1a                	push   $0x1a
  jmp alltraps
801052c0:	e9 e2 fa ff ff       	jmp    80104da7 <alltraps>
...
801052c7:	6a 1b                	push   $0x1b
  jmp alltraps
801052c9:	e9 d9 fa ff ff       	jmp    80104da7 <alltraps>
...
801052d0:	6a 1c                	push   $0x1c
  jmp alltraps
801052d2:	e9 d0 fa ff ff       	jmp    80104da7 <alltraps>
...
801052d9:	6a 1d                	push   $0x1d
  jmp alltraps
801052db:	e9 c7 fa ff ff       	jmp    80104da7 <alltraps>
...
801052e2:	6a 1e                	push   $0x1e
  jmp alltraps
801052e4:	e9 be fa ff ff       	jmp    80104da7 <alltraps>
...
801052eb:	6a 1f                	push   $0x1f
  jmp alltraps
801052ed:	e9 b5 fa ff ff       	jmp    80104da7 <alltraps>
...
801052f4:	6a 20                	push   $0x20
  jmp alltraps
801052f6:	e9 ac fa ff ff       	jmp    80104da7 <alltraps>
...
801052fd:	6a 21                	push   $0x21
  jmp alltraps
801052ff:	e9 a3 fa ff ff       	jmp    80104da7 <alltraps>
...
80105306:	6a 22                	push   $0x22
  jmp alltraps
80105308:	e9 9a fa ff ff       	jmp    80104da7 <alltraps>
...
8010530f:	6a 23                	push   $0x23
  jmp alltraps
80105311:	e9 91 fa ff ff       	jmp    80104da7 <alltraps>
...
80105318:	6a 24                	push   $0x24
  jmp alltraps
8010531a:	e9 88 fa ff ff       	jmp    80104da7 <alltraps>
...
80105321:	6a 25                	push   $0x25
  jmp alltraps
80105323:	e9 7f fa ff ff       	jmp    80104da7 <alltraps>
...
8010532a:	6a 26                	push   $0x26
  jmp alltraps
8010532c:	e9 76 fa ff ff       	jmp    80104da7 <alltraps>
...
80105333:	6a 27                	push   $0x27
  jmp alltraps
80105335:	e9 6d fa ff ff       	jmp    80104da7 <alltraps>
...
8010533c:	6a 28                	push   $0x28
  jmp alltraps
8010533e:	e9 64 fa ff ff       	jmp    80104da7 <alltraps>
...
80105345:	6a 29                	push   $0x29
  jmp alltraps
80105347:	e9 5b fa ff ff       	jmp    80104da7 <alltraps>
...
8010534e:	6a 2a                	push   $0x2a
  jmp alltraps
80105350:	e9 52 fa ff ff       	jmp    80104da7 <alltraps>
...
80105357:	6a 2b                	push   $0x2b
  jmp alltraps
80105359:	e9 49 fa ff ff       	jmp    80104da7 <alltraps>
...
80105360:	6a 2c                	push   $0x2c
  jmp alltraps
80105362:	e9 40 fa ff ff       	jmp    80104da7 <alltraps>
...
80105369:	6a 2d                	push   $0x2d
  jmp alltraps
8010536b:	e9 37 fa ff ff       	jmp    80104da7 <alltraps>
...
80105372:	6a 2e                	push   $0x2e
  jmp alltraps
80105374:	e9 2e fa ff ff       	jmp    80104da7 <alltraps>
...
8010537b:	6a 2f                	push   $0x2f
  jmp alltraps
8010537d:	e9 25 fa ff ff       	jmp    80104da7 <alltraps>
...
80105384:	6a 30                	push   $0x30
  jmp alltraps
80105386:	e9 1c fa ff ff       	jmp    80104da7 <alltraps>
...
8010538d:	6a 31                	push   $0x31
  jmp alltraps
8010538f:	e9 13 fa ff ff       	jmp    80104da7 <alltraps>
...
80105396:	6a 32                	push   $0x32
  jmp alltraps
80105398:	e9 0a fa ff ff       	jmp    80104da7 <alltraps>
...
8010539f:	6a 33                	push   $0x33
  jmp alltraps
801053a1:	e9 01 fa ff ff       	jmp    80104da7 <alltraps>
...
801053a8:	6a 34                	push   $0x34
  jmp alltraps
801053aa:	e9 f8 f9 ff ff       	jmp    80104da7 <alltraps>
...
801053b1:	6a 35                	push   $0x35
  jmp alltraps
801053b3:	e9 ef f9 ff ff       	jmp    80104da7 <alltraps>
...
801053ba:	6a 36                	push   $0x36
  jmp alltraps
801053bc:	e9 e6 f9 ff ff       	jmp    80104da7 <alltraps>
...
801053c3:	6a 37                	push   $0x37
  jmp alltraps
801053c5:	e9 dd f9 ff ff       	jmp    80104da7 <alltraps>
...
801053cc:	6a 38                	push   $0x38
  jmp alltraps
801053ce:	e9 d4 f9 ff ff       	jmp    80104da7 <alltraps>
...
801053d5:	6a 39                	push   $0x39
  jmp alltraps
801053d7:	e9 cb f9 ff ff       	jmp    80104da7 <alltraps>
...
801053de:	6a 3a                	push   $0x3a
  jmp alltraps
801053e0:	e9 c2 f9 ff ff       	jmp    80104da7 <alltraps>
...
801053e7:	6a 3b                	push   $0x3b
  jmp alltraps
801053e9:	e9 b9 f9 ff ff       	jmp    80104da7 <alltraps>
...
801053f0:	6a 3c                	push   $0x3c
  jmp alltraps
801053f2:	e9 b0 f9 ff ff       	jmp    80104da7 <alltraps>
...
801053f9:	6a 3d                	push   $0x3d
  jmp alltraps
801053fb:	e9 a7 f9 ff ff       	jmp    80104da7 <alltraps>
...
80105402:	6a 3e                	push   $0x3e
  jmp alltraps
80105404:	e9 9e f9 ff ff       	jmp    80104da7 <alltraps>
...
8010540b:	6a 3f                	push   $0x3f
  jmp alltraps
8010540d:	e9 95 f9 ff ff       	jmp    80104da7 <alltraps>
...
80105414:	6a 40                	push   $0x40
  jmp alltraps
80105416:	e9 8c f9 ff ff       	jmp    80104da7 <alltraps>
...
8010541d:	6a 41                	push   $0x41
  jmp alltraps
8010541f:	e9 83 f9 ff ff       	jmp    80104da7 <alltraps>
...
80105426:	6a 42                	push   $0x42
  jmp alltraps
80105428:	e9 7a f9 ff ff       	jmp    80104da7 <alltraps>
...
8010542f:	6a 43                	push   $0x43
  jmp alltraps
80105431:	e9 71 f9 ff ff       	jmp    80104da7 <alltraps>
...
80105438:	6a 44                	push   $0x44
  jmp alltraps
8010543a:	e9 68 f9 ff ff       	jmp    80104da7 <alltraps>
...
80105441:	6a 45                	push   $0x45
  jmp alltraps
80105443:	e9 5f f9 ff ff       	jmp    80104da7 <alltraps>
...
8010544a:	6a 46                	push   $0x46
  jmp alltraps
8010544c:	e9 56 f9 ff ff       	jmp    80104da7 <alltraps>
...
80105453:	6a 47                	push   $0x47
  jmp alltraps
80105455:	e9 4d f9 ff ff       	jmp    80104da7 <alltraps>
...
8010545c:	6a 48                	push   $0x48
  jmp alltraps
8010545e:	e9 44 f9 ff ff       	jmp    80104da7 <alltraps>
...
80105465:	6a 49                	push   $0x49
  jmp alltraps
80105467:	e9 3b f9 ff ff       	jmp    80104da7 <alltraps>
...
8010546e:	6a 4a                	push   $0x4a
  jmp alltraps
80105470:	e9 32 f9 ff ff       	jmp    80104da7 <alltraps>
...
80105477:	6a 4b                	push   $0x4b
  jmp alltraps
80105479:	e9 29 f9 ff ff       	jmp    80104da7 <alltraps>
...
80105480:	6a 4c                	push   $0x4c
  jmp alltraps
80105482:	e9 20 f9 ff ff       	jmp    80104da7 <alltraps>
...
80105489:	6a 4d                	push   $0x4d
  jmp alltraps
8010548b:	e9 17 f9 ff ff       	jmp    80104da7 <alltraps>
...
80105492:	6a 4e                	push   $0x4e
  jmp alltraps
80105494:	e9 0e f9 ff ff       	jmp    80104da7 <alltraps>
...
8010549b:	6a 4f                	push   $0x4f
  jmp alltraps
8010549d:	e9 05 f9 ff ff       	jmp    80104da7 <alltraps>
...
801054a4:	6a 50                	push   $0x50
  jmp alltraps
801054a6:	e9 fc f8 ff ff       	jmp    80104da7 <alltraps>
...
801054ad:	6a 51                	push   $0x51
  jmp alltraps
801054af:	e9 f3 f8 ff ff       	jmp    80104da7 <alltraps>
...
801054b6:	6a 52                	push   $0x52
  jmp alltraps
801054b8:	e9 ea f8 ff ff       	jmp    80104da7 <alltraps>
...
801054bf:	6a 53                	push   $0x53
  jmp alltraps
801054c1:	e9 e1 f8 ff ff       	jmp    80104da7 <alltraps>
...
801054c8:	6a 54                	push   $0x54
  jmp alltraps
801054ca:	e9 d8 f8 ff ff       	jmp    80104da7 <alltraps>
...
801054d1:	6a 55                	push   $0x55
  jmp alltraps
801054d3:	e9 cf f8 ff ff       	jmp    80104da7 <alltraps>
...
801054da:	6a 56                	push   $0x56
  jmp alltraps
801054dc:	e9 c6 f8 ff ff       	jmp    80104da7 <alltraps>
...
801054e3:	6a 57                	push   $0x57
  jmp alltraps
801054e5:	e9 bd f8 ff ff       	jmp    80104da7 <alltraps>
...
801054ec:	6a 58                	push   $0x58
  jmp alltraps
801054ee:	e9 b4 f8 ff ff       	jmp    80104da7 <alltraps>
...
801054f5:	6a 59                	push   $0x59
  jmp alltraps
801054f7:	e9 ab f8 ff ff       	jmp    80104da7 <alltraps>
...
801054fe:	6a 5a                	push   $0x5a
  jmp alltraps
80105500:	e9 a2 f8 ff ff       	jmp    80104da7 <alltraps>
...
80105507:	6a 5b                	push   $0x5b
  jmp alltraps
80105509:	e9 99 f8 ff ff       	jmp    80104da7 <alltraps>
...
80105510:	6a 5c                	push   $0x5c
  jmp alltraps
80105512:	e9 90 f8 ff ff       	jmp    80104da7 <alltraps>
...
80105519:	6a 5d                	push   $0x5d
  jmp alltraps
8010551b:	e9 87 f8 ff ff       	jmp    80104da7 <alltraps>
...
80105522:	6a 5e                	push   $0x5e
  jmp alltraps
80105524:	e9 7e f8 ff ff       	jmp    80104da7 <alltraps>
...
8010552b:	6a 5f                	push   $0x5f
  jmp alltraps
8010552d:	e9 75 f8 ff ff       	jmp    80104da7 <alltraps>
...
80105534:	6a 60                	push   $0x60
  jmp alltraps
80105536:	e9 6c f8 ff ff       	jmp    80104da7 <alltraps>
...
8010553d:	6a 61                	push   $0x61
  jmp alltraps
8010553f:	e9 63 f8 ff ff       	jmp    80104da7 <alltraps>
...
80105546:	6a 62                	push   $0x62
  jmp alltraps
80105548:	e9 5a f8 ff ff       	jmp    80104da7 <alltraps>
...
8010554f:	6a 63                	push   $0x63
  jmp alltraps
80105551:	e9 51 f8 ff ff       	jmp    80104da7 <alltraps>
...
80105558:	6a 64                	push   $0x64
  jmp alltraps
8010555a:	e9 48 f8 ff ff       	jmp    80104da7 <alltraps>
...
80105561:	6a 65                	push   $0x65
  jmp alltraps
80105563:	e9 3f f8 ff ff       	jmp    80104da7 <alltraps>
...
8010556a:	6a 66                	push   $0x66
  jmp alltraps
8010556c:	e9 36 f8 ff ff       	jmp    80104da7 <alltraps>
...
80105573:	6a 67                	push   $0x67
  jmp alltraps
80105575:	e9 2d f8 ff ff       	jmp    80104da7 <alltraps>
...
8010557c:	6a 68                	push   $0x68
  jmp alltraps
8010557e:	e9 24 f8 ff ff       	jmp    80104da7 <alltraps>
...
80105585:	6a 69                	push   $0x69
  jmp alltraps
80105587:	e9 1b f8 ff ff       	jmp    80104da7 <alltraps>
...
8010558e:	6a 6a                	push   $0x6a
  jmp alltraps
80105590:	e9 12 f8 ff ff       	jmp    80104da7 <alltraps>
...
80105597:	6a 6b                	push   $0x6b
  jmp alltraps
80105599:	e9 09 f8 ff ff       	jmp    80104da7 <alltraps>
...
801055a0:	6a 6c                	push   $0x6c
  jmp alltraps
801055a2:	e9 00 f8 ff ff       	jmp    80104da7 <alltraps>
...
801055a9:	6a 6d                	push   $0x6d
  jmp alltraps
801055ab:	e9 f7 f7 ff ff       	jmp    80104da7 <alltraps>
...
801055b2:	6a 6e                	push   $0x6e
  jmp alltraps
801055b4:	e9 ee f7 ff ff       	jmp    80104da7 <alltraps>
...
801055bb:	6a 6f                	push   $0x6f
  jmp alltraps
801055bd:	e9 e5 f7 ff ff       	jmp    80104da7 <alltraps>
...
801055c4:	6a 70                	push   $0x70
  jmp alltraps
801055c6:	e9 dc f7 ff ff       	jmp    80104da7 <alltraps>
...
801055cd:	6a 71                	push   $0x71
  jmp alltraps
801055cf:	e9 d3 f7 ff ff       	jmp    80104da7 <alltraps>
...
801055d6:	6a 72                	push   $0x72
  jmp alltraps
801055d8:	e9 ca f7 ff ff       	jmp    80104da7 <alltraps>
...
801055df:	6a 73                	push   $0x73
  jmp alltraps
801055e1:	e9 c1 f7 ff ff       	jmp    80104da7 <alltraps>
...
801055e8:	6a 74                	push   $0x74
  jmp alltraps
801055ea:	e9 b8 f7 ff ff       	jmp    80104da7 <alltraps>
...
801055f1:	6a 75                	push   $0x75
  jmp alltraps
801055f3:	e9 af f7 ff ff       	jmp    80104da7 <alltraps>
...
801055fa:	6a 76                	push   $0x76
  jmp alltraps
801055fc:	e9 a6 f7 ff ff       	jmp    80104da7 <alltraps>
...
80105603:	6a 77                	push   $0x77
  jmp alltraps
80105605:	e9 9d f7 ff ff       	jmp    80104da7 <alltraps>
...
8010560c:	6a 78                	push   $0x78
  jmp alltraps
8010560e:	e9 94 f7 ff ff       	jmp    80104da7 <alltraps>
...
80105615:	6a 79                	push   $0x79
  jmp alltraps
80105617:	e9 8b f7 ff ff       	jmp    80104da7 <alltraps>
...
8010561e:	6a 7a                	push   $0x7a
  jmp alltraps
80105620:	e9 82 f7 ff ff       	jmp    80104da7 <alltraps>
...
80105627:	6a 7b                	push   $0x7b
  jmp alltraps
80105629:	e9 79 f7 ff ff       	jmp    80104da7 <alltraps>
...
80105630:	6a 7c                	push   $0x7c
  jmp alltraps
80105632:	e9 70 f7 ff ff       	jmp    80104da7 <alltraps>
...
80105639:	6a 7d                	push   $0x7d
  jmp alltraps
8010563b:	e9 67 f7 ff ff       	jmp    80104da7 <alltraps>
...
80105642:	6a 7e                	push   $0x7e
  jmp alltraps
80105644:	e9 5e f7 ff ff       	jmp    80104da7 <alltraps>
...
8010564b:	6a 7f                	push   $0x7f
  jmp alltraps
8010564d:	e9 55 f7 ff ff       	jmp    80104da7 <alltraps>
...
80105654:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105659:	e9 49 f7 ff ff       	jmp    80104da7 <alltraps>
...
80105660:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105665:	e9 3d f7 ff ff       	jmp    80104da7 <alltraps>
...
8010566c:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105671:	e9 31 f7 ff ff       	jmp    80104da7 <alltraps>
...
80105678:	68 83 00 00 00       	push   $0x83
  jmp alltraps
8010567d:	e9 25 f7 ff ff       	jmp    80104da7 <alltraps>
...
80105684:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105689:	e9 19 f7 ff ff       	jmp    80104da7 <alltraps>
...
80105690:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80105695:	e9 0d f7 ff ff       	jmp    80104da7 <alltraps>
...
8010569c:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801056a1:	e9 01 f7 ff ff       	jmp    80104da7 <alltraps>
...
801056a8:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801056ad:	e9 f5 f6 ff ff       	jmp    80104da7 <alltraps>
...
801056b4:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801056b9:	e9 e9 f6 ff ff       	jmp    80104da7 <alltraps>
...
801056c0:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801056c5:	e9 dd f6 ff ff       	jmp    80104da7 <alltraps>
...
801056cc:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801056d1:	e9 d1 f6 ff ff       	jmp    80104da7 <alltraps>
...
801056d8:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801056dd:	e9 c5 f6 ff ff       	jmp    80104da7 <alltraps>
...
801056e4:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801056e9:	e9 b9 f6 ff ff       	jmp    80104da7 <alltraps>
...
801056f0:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801056f5:	e9 ad f6 ff ff       	jmp    80104da7 <alltraps>
...
801056fc:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80105701:	e9 a1 f6 ff ff       	jmp    80104da7 <alltraps>
...
80105708:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
8010570d:	e9 95 f6 ff ff       	jmp    80104da7 <alltraps>
...
80105714:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80105719:	e9 89 f6 ff ff       	jmp    80104da7 <alltraps>
...
80105720:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80105725:	e9 7d f6 ff ff       	jmp    80104da7 <alltraps>
...
8010572c:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80105731:	e9 71 f6 ff ff       	jmp    80104da7 <alltraps>
...
80105738:	68 93 00 00 00       	push   $0x93
  jmp alltraps
8010573d:	e9 65 f6 ff ff       	jmp    80104da7 <alltraps>
...
80105744:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80105749:	e9 59 f6 ff ff       	jmp    80104da7 <alltraps>
...
80105750:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80105755:	e9 4d f6 ff ff       	jmp    80104da7 <alltraps>
...
8010575c:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80105761:	e9 41 f6 ff ff       	jmp    80104da7 <alltraps>
...
80105768:	68 97 00 00 00       	push   $0x97
  jmp alltraps
8010576d:	e9 35 f6 ff ff       	jmp    80104da7 <alltraps>
...
80105774:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80105779:	e9 29 f6 ff ff       	jmp    80104da7 <alltraps>
...
80105780:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80105785:	e9 1d f6 ff ff       	jmp    80104da7 <alltraps>
...
8010578c:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80105791:	e9 11 f6 ff ff       	jmp    80104da7 <alltraps>
...
80105798:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
8010579d:	e9 05 f6 ff ff       	jmp    80104da7 <alltraps>
...
801057a4:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801057a9:	e9 f9 f5 ff ff       	jmp    80104da7 <alltraps>
...
801057b0:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801057b5:	e9 ed f5 ff ff       	jmp    80104da7 <alltraps>
...
801057bc:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801057c1:	e9 e1 f5 ff ff       	jmp    80104da7 <alltraps>
...
801057c8:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801057cd:	e9 d5 f5 ff ff       	jmp    80104da7 <alltraps>
...
801057d4:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801057d9:	e9 c9 f5 ff ff       	jmp    80104da7 <alltraps>
...
801057e0:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801057e5:	e9 bd f5 ff ff       	jmp    80104da7 <alltraps>
...
801057ec:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801057f1:	e9 b1 f5 ff ff       	jmp    80104da7 <alltraps>
...
801057f8:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801057fd:	e9 a5 f5 ff ff       	jmp    80104da7 <alltraps>
...
80105804:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80105809:	e9 99 f5 ff ff       	jmp    80104da7 <alltraps>
...
80105810:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80105815:	e9 8d f5 ff ff       	jmp    80104da7 <alltraps>
...
8010581c:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80105821:	e9 81 f5 ff ff       	jmp    80104da7 <alltraps>
...
80105828:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
8010582d:	e9 75 f5 ff ff       	jmp    80104da7 <alltraps>
...
80105834:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80105839:	e9 69 f5 ff ff       	jmp    80104da7 <alltraps>
...
80105840:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80105845:	e9 5d f5 ff ff       	jmp    80104da7 <alltraps>
...
8010584c:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80105851:	e9 51 f5 ff ff       	jmp    80104da7 <alltraps>
...
80105858:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
8010585d:	e9 45 f5 ff ff       	jmp    80104da7 <alltraps>
...
80105864:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80105869:	e9 39 f5 ff ff       	jmp    80104da7 <alltraps>
...
80105870:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80105875:	e9 2d f5 ff ff       	jmp    80104da7 <alltraps>
...
8010587c:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80105881:	e9 21 f5 ff ff       	jmp    80104da7 <alltraps>
...
80105888:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
8010588d:	e9 15 f5 ff ff       	jmp    80104da7 <alltraps>
...
80105894:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80105899:	e9 09 f5 ff ff       	jmp    80104da7 <alltraps>
...
801058a0:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801058a5:	e9 fd f4 ff ff       	jmp    80104da7 <alltraps>
...
801058ac:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801058b1:	e9 f1 f4 ff ff       	jmp    80104da7 <alltraps>
...
801058b8:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801058bd:	e9 e5 f4 ff ff       	jmp    80104da7 <alltraps>
...
801058c4:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801058c9:	e9 d9 f4 ff ff       	jmp    80104da7 <alltraps>
...
801058d0:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801058d5:	e9 cd f4 ff ff       	jmp    80104da7 <alltraps>
...
801058dc:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801058e1:	e9 c1 f4 ff ff       	jmp    80104da7 <alltraps>
...
801058e8:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801058ed:	e9 b5 f4 ff ff       	jmp    80104da7 <alltraps>
...
801058f4:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801058f9:	e9 a9 f4 ff ff       	jmp    80104da7 <alltraps>
...
80105900:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80105905:	e9 9d f4 ff ff       	jmp    80104da7 <alltraps>
...
8010590c:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80105911:	e9 91 f4 ff ff       	jmp    80104da7 <alltraps>
...
80105918:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
8010591d:	e9 85 f4 ff ff       	jmp    80104da7 <alltraps>
...
80105924:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80105929:	e9 79 f4 ff ff       	jmp    80104da7 <alltraps>
...
80105930:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80105935:	e9 6d f4 ff ff       	jmp    80104da7 <alltraps>
...
8010593c:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80105941:	e9 61 f4 ff ff       	jmp    80104da7 <alltraps>
...
80105948:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
8010594d:	e9 55 f4 ff ff       	jmp    80104da7 <alltraps>
...
80105954:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80105959:	e9 49 f4 ff ff       	jmp    80104da7 <alltraps>
...
80105960:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80105965:	e9 3d f4 ff ff       	jmp    80104da7 <alltraps>
...
8010596c:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80105971:	e9 31 f4 ff ff       	jmp    80104da7 <alltraps>
...
80105978:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
8010597d:	e9 25 f4 ff ff       	jmp    80104da7 <alltraps>
...
80105984:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80105989:	e9 19 f4 ff ff       	jmp    80104da7 <alltraps>
...
80105990:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80105995:	e9 0d f4 ff ff       	jmp    80104da7 <alltraps>
...
8010599c:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801059a1:	e9 01 f4 ff ff       	jmp    80104da7 <alltraps>
...
801059a8:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801059ad:	e9 f5 f3 ff ff       	jmp    80104da7 <alltraps>
...
801059b4:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801059b9:	e9 e9 f3 ff ff       	jmp    80104da7 <alltraps>
...
801059c0:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801059c5:	e9 dd f3 ff ff       	jmp    80104da7 <alltraps>
...
801059cc:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801059d1:	e9 d1 f3 ff ff       	jmp    80104da7 <alltraps>
...
801059d8:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801059dd:	e9 c5 f3 ff ff       	jmp    80104da7 <alltraps>
...
801059e4:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801059e9:	e9 b9 f3 ff ff       	jmp    80104da7 <alltraps>
...
801059f0:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801059f5:	e9 ad f3 ff ff       	jmp    80104da7 <alltraps>
...
801059fc:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80105a01:	e9 a1 f3 ff ff       	jmp    80104da7 <alltraps>
...
80105a08:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80105a0d:	e9 95 f3 ff ff       	jmp    80104da7 <alltraps>
...
80105a14:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80105a19:	e9 89 f3 ff ff       	jmp    80104da7 <alltraps>
...
80105a20:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80105a25:	e9 7d f3 ff ff       	jmp    80104da7 <alltraps>
...
80105a2c:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80105a31:	e9 71 f3 ff ff       	jmp    80104da7 <alltraps>
...
80105a38:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80105a3d:	e9 65 f3 ff ff       	jmp    80104da7 <alltraps>
...
80105a44:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80105a49:	e9 59 f3 ff ff       	jmp    80104da7 <alltraps>
...
80105a50:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80105a55:	e9 4d f3 ff ff       	jmp    80104da7 <alltraps>
...
80105a5c:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80105a61:	e9 41 f3 ff ff       	jmp    80104da7 <alltraps>
...
80105a68:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80105a6d:	e9 35 f3 ff ff       	jmp    80104da7 <alltraps>
...
80105a74:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80105a79:	e9 29 f3 ff ff       	jmp    80104da7 <alltraps>
...
80105a80:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80105a85:	e9 1d f3 ff ff       	jmp    80104da7 <alltraps>
...
80105a8c:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80105a91:	e9 11 f3 ff ff       	jmp    80104da7 <alltraps>
...
80105a98:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80105a9d:	e9 05 f3 ff ff       	jmp    80104da7 <alltraps>
...
80105aa4:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80105aa9:	e9 f9 f2 ff ff       	jmp    80104da7 <alltraps>
...
80105ab0:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80105ab5:	e9 ed f2 ff ff       	jmp    80104da7 <alltraps>
...
80105abc:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80105ac1:	e9 e1 f2 ff ff       	jmp    80104da7 <alltraps>
...
80105ac8:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80105acd:	e9 d5 f2 ff ff       	jmp    80104da7 <alltraps>
...
80105ad4:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80105ad9:	e9 c9 f2 ff ff       	jmp    80104da7 <alltraps>
...
80105ae0:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80105ae5:	e9 bd f2 ff ff       	jmp    80104da7 <alltraps>
...
80105aec:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80105af1:	e9 b1 f2 ff ff       	jmp    80104da7 <alltraps>
...
80105af8:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80105afd:	e9 a5 f2 ff ff       	jmp    80104da7 <alltraps>
...
80105b04:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80105b09:	e9 99 f2 ff ff       	jmp    80104da7 <alltraps>
...
80105b10:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80105b15:	e9 8d f2 ff ff       	jmp    80104da7 <alltraps>
...
80105b1c:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80105b21:	e9 81 f2 ff ff       	jmp    80104da7 <alltraps>
...
80105b28:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80105b2d:	e9 75 f2 ff ff       	jmp    80104da7 <alltraps>
...
80105b34:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80105b39:	e9 69 f2 ff ff       	jmp    80104da7 <alltraps>
...
80105b40:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80105b45:	e9 5d f2 ff ff       	jmp    80104da7 <alltraps>
...
80105b4c:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80105b51:	e9 51 f2 ff ff       	jmp    80104da7 <alltraps>
...
80105b58:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80105b5d:	e9 45 f2 ff ff       	jmp    80104da7 <alltraps>
...
80105b64:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80105b69:	e9 39 f2 ff ff       	jmp    80104da7 <alltraps>
...
80105b70:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80105b75:	e9 2d f2 ff ff       	jmp    80104da7 <alltraps>
...
80105b7c:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80105b81:	e9 21 f2 ff ff       	jmp    80104da7 <alltraps>
...
80105b88:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80105b8d:	e9 15 f2 ff ff       	jmp    80104da7 <alltraps>
...
80105b94:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80105b99:	e9 09 f2 ff ff       	jmp    80104da7 <alltraps>
...
80105ba0:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80105ba5:	e9 fd f1 ff ff       	jmp    80104da7 <alltraps>
...
80105bac:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80105bb1:	e9 f1 f1 ff ff       	jmp    80104da7 <alltraps>
...
80105bb8:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80105bbd:	e9 e5 f1 ff ff       	jmp    80104da7 <alltraps>
...
80105bc4:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80105bc9:	e9 d9 f1 ff ff       	jmp    80104da7 <alltraps>
...
80105bd0:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80105bd5:	e9 cd f1 ff ff       	jmp    80104da7 <alltraps>
...
80105bdc:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80105be1:	e9 c1 f1 ff ff       	jmp    80104da7 <alltraps>
...
80105be8:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80105bed:	e9 b5 f1 ff ff       	jmp    80104da7 <alltraps>
...
80105bf4:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80105bf9:	e9 a9 f1 ff ff       	jmp    80104da7 <alltraps>
...
80105c00:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80105c05:	e9 9d f1 ff ff       	jmp    80104da7 <alltraps>
...
80105c0c:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80105c11:	e9 91 f1 ff ff       	jmp    80104da7 <alltraps>
...
80105c18:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80105c1d:	e9 85 f1 ff ff       	jmp    80104da7 <alltraps>
...
80105c24:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80105c29:	e9 79 f1 ff ff       	jmp    80104da7 <alltraps>
...
80105c30:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80105c35:	e9 6d f1 ff ff       	jmp    80104da7 <alltraps>
...
80105c3c:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80105c41:	e9 61 f1 ff ff       	jmp    80104da7 <alltraps>
...
80105c48:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80105c4d:	e9 55 f1 ff ff       	jmp    80104da7 <alltraps>
...
80105c60:	8d 3c 90             	lea    (%eax,%edx,4),%edi
  if(*pde & PTE_P){
80105c63:	8b 1f                	mov    (%edi),%ebx
80105c65:	f6 c3 01             	test   $0x1,%bl
80105c68:	74 22                	je     80105c8c <walkpgdir+0x3a>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80105c6a:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
80105c70:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
  ...
  return &pgtab[PTX(va)];
80105c76:	c1 ee 0c             	shr    $0xc,%esi
80105c79:	81 e6 ff 03 00 00    	and    $0x3ff,%esi
80105c7f:	8d 1c b3             	lea    (%ebx,%esi,4),%ebx
}
...
80105c8e:	74 2b                	je     80105cbb <walkpgdir+0x69>
80105c90:	e8 26 c4 ff ff       	call   801020bb <kalloc>
80105c95:	89 c3                	mov    %eax,%ebx
80105c97:	85 c0                	test   %eax,%eax
80105c99:	74 e7                	je     80105c82 <walkpgdir+0x30>
    memset(pgtab, 0, PGSIZE);
80105c9b:	83 ec 04             	sub    $0x4,%esp
80105c9e:	68 00 10 00 00       	push   $0x1000
80105ca3:	6a 00                	push   $0x0
80105ca5:	50                   	push   %eax
80105ca6:	e8 11 e0 ff ff       	call   80103cbc <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80105cab:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80105cb1:	83 c8 07             	or     $0x7,%eax
80105cb4:	89 07                	mov    %eax,(%edi)
80105cb6:	83 c4 10             	add    $0x10,%esp
80105cb9:	eb bb                	jmp    80105c76 <walkpgdir+0x24>
      return 0;
80105cbb:	bb 00 00 00 00       	mov    $0x0,%ebx
80105cc0:	eb c0                	jmp    80105c82 <walkpgdir+0x30>
...
80105cc8:	83 ec 1c             	sub    $0x1c,%esp
80105ccb:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80105cce:	8b 75 08             	mov    0x8(%ebp),%esi
  char *a, *last;
  pte_t *pte;

  a = (char*)PGROUNDDOWN((uint)va);
80105cd1:	89 d3                	mov    %edx,%ebx
80105cd3:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80105cd9:	8d 7c 0a ff          	lea    -0x1(%edx,%ecx,1),%edi
80105cdd:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80105ce3:	b9 01 00 00 00       	mov    $0x1,%ecx
80105ce8:	89 da                	mov    %ebx,%edx
80105cea:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105ced:	e8 60 ff ff ff       	call   80105c52 <walkpgdir>
80105cf2:	85 c0                	test   %eax,%eax
80105cf4:	74 2e                	je     80105d24 <mappages+0x62>
      return -1;
    if(*pte & PTE_P)
80105cf6:	f6 00 01             	testb  $0x1,(%eax)
80105cf9:	75 1c                	jne    80105d17 <mappages+0x55>
      panic("remap");
    *pte = pa | perm | PTE_P;
80105cfb:	89 f2                	mov    %esi,%edx
80105cfd:	0b 55 0c             	or     0xc(%ebp),%edx
80105d00:	83 ca 01             	or     $0x1,%edx
80105d03:	89 10                	mov    %edx,(%eax)
    if(a == last)
80105d05:	39 fb                	cmp    %edi,%ebx
80105d07:	74 28                	je     80105d31 <mappages+0x6f>
      break;
    a += PGSIZE;
80105d09:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    pa += PGSIZE;
80105d0f:	81 c6 00 10 00 00    	add    $0x1000,%esi
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80105d15:	eb cc                	jmp    80105ce3 <mappages+0x21>
      panic("remap");
80105d17:	83 ec 0c             	sub    $0xc,%esp
80105d1a:	68 d0 6d 10 80       	push   $0x80106dd0
80105d1f:	e8 24 a6 ff ff       	call   80100348 <panic>
      return -1;
...
80105d36:	eb f1                	jmp    80105d29 <mappages+0x67>
...
80105d3c:	83 ec 14             	sub    $0x14,%esp
  c = &cpus[cpuid()];
80105d3f:	e8 97 d4 ff ff       	call   801031db <cpuid>
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80105d44:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
80105d4a:	66 c7 80 f8 17 11 80 	movw   $0xffff,-0x7feee808(%eax)
80105d51:	ff ff 
80105d53:	66 c7 80 fa 17 11 80 	movw   $0x0,-0x7feee806(%eax)
80105d5a:	00 00 
80105d5c:	c6 80 fc 17 11 80 00 	movb   $0x0,-0x7feee804(%eax)
80105d63:	0f b6 88 fd 17 11 80 	movzbl -0x7feee803(%eax),%ecx
80105d6a:	83 e1 f0             	and    $0xfffffff0,%ecx
80105d6d:	83 c9 1a             	or     $0x1a,%ecx
80105d70:	83 e1 9f             	and    $0xffffff9f,%ecx
80105d73:	83 c9 80             	or     $0xffffff80,%ecx
80105d76:	88 88 fd 17 11 80    	mov    %cl,-0x7feee803(%eax)
80105d7c:	0f b6 88 fe 17 11 80 	movzbl -0x7feee802(%eax),%ecx
80105d83:	83 c9 0f             	or     $0xf,%ecx
80105d86:	83 e1 cf             	and    $0xffffffcf,%ecx
80105d89:	83 c9 c0             	or     $0xffffffc0,%ecx
80105d8c:	88 88 fe 17 11 80    	mov    %cl,-0x7feee802(%eax)
80105d92:	c6 80 ff 17 11 80 00 	movb   $0x0,-0x7feee801(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80105d99:	66 c7 80 00 18 11 80 	movw   $0xffff,-0x7feee800(%eax)
80105da0:	ff ff 
80105da2:	66 c7 80 02 18 11 80 	movw   $0x0,-0x7feee7fe(%eax)
80105da9:	00 00 
80105dab:	c6 80 04 18 11 80 00 	movb   $0x0,-0x7feee7fc(%eax)
80105db2:	0f b6 88 05 18 11 80 	movzbl -0x7feee7fb(%eax),%ecx
80105db9:	83 e1 f0             	and    $0xfffffff0,%ecx
80105dbc:	83 c9 12             	or     $0x12,%ecx
80105dbf:	83 e1 9f             	and    $0xffffff9f,%ecx
80105dc2:	83 c9 80             	or     $0xffffff80,%ecx
80105dc5:	88 88 05 18 11 80    	mov    %cl,-0x7feee7fb(%eax)
80105dcb:	0f b6 88 06 18 11 80 	movzbl -0x7feee7fa(%eax),%ecx
80105dd2:	83 c9 0f             	or     $0xf,%ecx
80105dd5:	83 e1 cf             	and    $0xffffffcf,%ecx
80105dd8:	83 c9 c0             	or     $0xffffffc0,%ecx
80105ddb:	88 88 06 18 11 80    	mov    %cl,-0x7feee7fa(%eax)
80105de1:	c6 80 07 18 11 80 00 	movb   $0x0,-0x7feee7f9(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80105de8:	66 c7 80 08 18 11 80 	movw   $0xffff,-0x7feee7f8(%eax)
80105def:	ff ff 
80105df1:	66 c7 80 0a 18 11 80 	movw   $0x0,-0x7feee7f6(%eax)
80105df8:	00 00 
80105dfa:	c6 80 0c 18 11 80 00 	movb   $0x0,-0x7feee7f4(%eax)
80105e01:	c6 80 0d 18 11 80 fa 	movb   $0xfa,-0x7feee7f3(%eax)
80105e08:	0f b6 88 0e 18 11 80 	movzbl -0x7feee7f2(%eax),%ecx
80105e0f:	83 c9 0f             	or     $0xf,%ecx
80105e12:	83 e1 cf             	and    $0xffffffcf,%ecx
80105e15:	83 c9 c0             	or     $0xffffffc0,%ecx
80105e18:	88 88 0e 18 11 80    	mov    %cl,-0x7feee7f2(%eax)
80105e1e:	c6 80 0f 18 11 80 00 	movb   $0x0,-0x7feee7f1(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80105e25:	66 c7 80 10 18 11 80 	movw   $0xffff,-0x7feee7f0(%eax)
80105e2c:	ff ff 
80105e2e:	66 c7 80 12 18 11 80 	movw   $0x0,-0x7feee7ee(%eax)
80105e35:	00 00 
80105e37:	c6 80 14 18 11 80 00 	movb   $0x0,-0x7feee7ec(%eax)
80105e3e:	c6 80 15 18 11 80 f2 	movb   $0xf2,-0x7feee7eb(%eax)
80105e45:	0f b6 88 16 18 11 80 	movzbl -0x7feee7ea(%eax),%ecx
80105e4c:	83 c9 0f             	or     $0xf,%ecx
80105e4f:	83 e1 cf             	and    $0xffffffcf,%ecx
80105e52:	83 c9 c0             	or     $0xffffffc0,%ecx
80105e55:	88 88 16 18 11 80    	mov    %cl,-0x7feee7ea(%eax)
80105e5b:	c6 80 17 18 11 80 00 	movb   $0x0,-0x7feee7e9(%eax)
  lgdt(c->gdt, sizeof(c->gdt));
80105e62:	05 f0 17 11 80       	add    $0x801117f0,%eax
  pd[0] = size-1;
80105e67:	66 c7 45 f2 2f 00    	movw   $0x2f,-0xe(%ebp)
  pd[1] = (uint)p;
80105e6d:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
80105e71:	c1 e8 10             	shr    $0x10,%eax
80105e74:	66 89 45 f6          	mov    %ax,-0xa(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
80105e78:	8d 45 f2             	lea    -0xe(%ebp),%eax
80105e7b:	0f 01 10             	lgdtl  (%eax)
}
80105e7e:	83 c4 14             	add    $0x14,%esp
80105e81:	5b                   	pop    %ebx
80105e82:	5d                   	pop    %ebp
80105e83:	c3                   	ret    
...
80105e87:	a1 a4 44 11 80       	mov    0x801144a4,%eax
80105e8c:	05 00 00 00 80       	add    $0x80000000,%eax
}
...
80105e9c:	83 ec 1c             	sub    $0x1c,%esp
80105e9f:	8b 75 08             	mov    0x8(%ebp),%esi
  if(p == 0)
80105ea2:	85 f6                	test   %esi,%esi
80105ea4:	0f 84 dd 00 00 00    	je     80105f87 <switchuvm+0xf1>
    panic("switchuvm: no process");
  if(p->kstack == 0)
80105eaa:	83 7e 08 00          	cmpl   $0x0,0x8(%esi)
80105eae:	0f 84 e0 00 00 00    	je     80105f94 <switchuvm+0xfe>
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
80105eb4:	83 7e 04 00          	cmpl   $0x0,0x4(%esi)
80105eb8:	0f 84 e3 00 00 00    	je     80105fa1 <switchuvm+0x10b>
    panic("switchuvm: no pgdir");

  pushcli();
80105ebe:	e8 70 dc ff ff       	call   80103b33 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80105ec3:	e8 b7 d2 ff ff       	call   8010317f <mycpu>
80105ec8:	89 c3                	mov    %eax,%ebx
80105eca:	e8 b0 d2 ff ff       	call   8010317f <mycpu>
80105ecf:	8d 78 08             	lea    0x8(%eax),%edi
80105ed2:	e8 a8 d2 ff ff       	call   8010317f <mycpu>
80105ed7:	83 c0 08             	add    $0x8,%eax
80105eda:	c1 e8 10             	shr    $0x10,%eax
80105edd:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80105ee0:	e8 9a d2 ff ff       	call   8010317f <mycpu>
80105ee5:	83 c0 08             	add    $0x8,%eax
80105ee8:	c1 e8 18             	shr    $0x18,%eax
80105eeb:	66 c7 83 98 00 00 00 	movw   $0x67,0x98(%ebx)
80105ef2:	67 00 
80105ef4:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80105efb:	0f b6 4d e4          	movzbl -0x1c(%ebp),%ecx
80105eff:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
80105f05:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
80105f0c:	83 e2 f0             	and    $0xfffffff0,%edx
80105f0f:	83 ca 19             	or     $0x19,%edx
80105f12:	83 e2 9f             	and    $0xffffff9f,%edx
80105f15:	83 ca 80             	or     $0xffffff80,%edx
80105f18:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80105f1e:	c6 83 9e 00 00 00 40 	movb   $0x40,0x9e(%ebx)
80105f25:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
80105f2b:	e8 4f d2 ff ff       	call   8010317f <mycpu>
80105f30:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80105f37:	83 e2 ef             	and    $0xffffffef,%edx
80105f3a:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80105f40:	e8 3a d2 ff ff       	call   8010317f <mycpu>
80105f45:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80105f4b:	8b 5e 08             	mov    0x8(%esi),%ebx
80105f4e:	e8 2c d2 ff ff       	call   8010317f <mycpu>
80105f53:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80105f59:	89 58 0c             	mov    %ebx,0xc(%eax)
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80105f5c:	e8 1e d2 ff ff       	call   8010317f <mycpu>
80105f61:	66 c7 40 6e ff ff    	movw   $0xffff,0x6e(%eax)
  asm volatile("ltr %0" : : "r" (sel));
80105f67:	b8 28 00 00 00       	mov    $0x28,%eax
80105f6c:	0f 00 d8             	ltr    %ax
  ltr(SEG_TSS << 3);
  lcr3(V2P(p->pgdir));  // switch to process's address space
80105f6f:	8b 46 04             	mov    0x4(%esi),%eax
80105f72:	05 00 00 00 80       	add    $0x80000000,%eax
  asm volatile("movl %0,%%cr3" : : "r" (val));
80105f77:	0f 22 d8             	mov    %eax,%cr3
  popcli();
80105f7a:	e8 f1 db ff ff       	call   80103b70 <popcli>
}
...
80105f8a:	68 d6 6d 10 80       	push   $0x80106dd6
80105f8f:	e8 b4 a3 ff ff       	call   80100348 <panic>
    panic("switchuvm: no kstack");
80105f94:	83 ec 0c             	sub    $0xc,%esp
80105f97:	68 ec 6d 10 80       	push   $0x80106dec
80105f9c:	e8 a7 a3 ff ff       	call   80100348 <panic>
    panic("switchuvm: no pgdir");
80105fa1:	83 ec 0c             	sub    $0xc,%esp
80105fa4:	68 01 6e 10 80       	push   $0x80106e01
80105fa9:	e8 9a a3 ff ff       	call   80100348 <panic>
...
80105fb3:	8b 75 10             	mov    0x10(%ebp),%esi
  char *mem;

  if(sz >= PGSIZE)
80105fb6:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
80105fbc:	77 4c                	ja     8010600a <inituvm+0x5c>
    panic("inituvm: more than a page");
  mem = kalloc();
80105fbe:	e8 f8 c0 ff ff       	call   801020bb <kalloc>
80105fc3:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
80105fc5:	83 ec 04             	sub    $0x4,%esp
80105fc8:	68 00 10 00 00       	push   $0x1000
80105fcd:	6a 00                	push   $0x0
80105fcf:	50                   	push   %eax
80105fd0:	e8 e7 dc ff ff       	call   80103cbc <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80105fd5:	83 c4 08             	add    $0x8,%esp
80105fd8:	6a 06                	push   $0x6
80105fda:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80105fe0:	50                   	push   %eax
80105fe1:	b9 00 10 00 00       	mov    $0x1000,%ecx
80105fe6:	ba 00 00 00 00       	mov    $0x0,%edx
80105feb:	8b 45 08             	mov    0x8(%ebp),%eax
80105fee:	e8 cf fc ff ff       	call   80105cc2 <mappages>
  memmove(mem, init, sz);
80105ff3:	83 c4 0c             	add    $0xc,%esp
80105ff6:	56                   	push   %esi
80105ff7:	ff 75 0c             	pushl  0xc(%ebp)
80105ffa:	53                   	push   %ebx
80105ffb:	e8 37 dd ff ff       	call   80103d37 <memmove>
}
80106000:	83 c4 10             	add    $0x10,%esp
80106003:	8d 65 f8             	lea    -0x8(%ebp),%esp
80106006:	5b                   	pop    %ebx
80106007:	5e                   	pop    %esi
80106008:	5d                   	pop    %ebp
80106009:	c3                   	ret    
...
8010600d:	68 15 6e 10 80       	push   $0x80106e15
80106012:	e8 31 a3 ff ff       	call   80100348 <panic>
...
80106020:	8b 7d 18             	mov    0x18(%ebp),%edi
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
80106023:	f7 45 0c ff 0f 00 00 	testl  $0xfff,0xc(%ebp)
8010602a:	75 07                	jne    80106033 <loaduvm+0x1c>
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
8010602c:	bb 00 00 00 00       	mov    $0x0,%ebx
80106031:	eb 3c                	jmp    8010606f <loaduvm+0x58>
    panic("loaduvm: addr must be page aligned");
80106033:	83 ec 0c             	sub    $0xc,%esp
80106036:	68 d0 6e 10 80       	push   $0x80106ed0
8010603b:	e8 08 a3 ff ff       	call   80100348 <panic>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
80106040:	83 ec 0c             	sub    $0xc,%esp
80106043:	68 2f 6e 10 80       	push   $0x80106e2f
...
8010604d:	05 00 00 00 80       	add    $0x80000000,%eax
80106052:	56                   	push   %esi
80106053:	89 da                	mov    %ebx,%edx
80106055:	03 55 14             	add    0x14(%ebp),%edx
80106058:	52                   	push   %edx
80106059:	50                   	push   %eax
8010605a:	ff 75 10             	pushl  0x10(%ebp)
8010605d:	e8 11 b7 ff ff       	call   80101773 <readi>
80106062:	83 c4 10             	add    $0x10,%esp
80106065:	39 f0                	cmp    %esi,%eax
80106067:	75 47                	jne    801060b0 <loaduvm+0x99>
  for(i = 0; i < sz; i += PGSIZE){
80106069:	81 c3 00 10 00 00    	add    $0x1000,%ebx
8010606f:	39 fb                	cmp    %edi,%ebx
80106071:	73 30                	jae    801060a3 <loaduvm+0x8c>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80106073:	89 da                	mov    %ebx,%edx
80106075:	03 55 0c             	add    0xc(%ebp),%edx
80106078:	b9 00 00 00 00       	mov    $0x0,%ecx
8010607d:	8b 45 08             	mov    0x8(%ebp),%eax
80106080:	e8 cd fb ff ff       	call   80105c52 <walkpgdir>
80106085:	85 c0                	test   %eax,%eax
80106087:	74 b7                	je     80106040 <loaduvm+0x29>
    pa = PTE_ADDR(*pte);
80106089:	8b 00                	mov    (%eax),%eax
8010608b:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(sz - i < PGSIZE)
80106090:	89 fe                	mov    %edi,%esi
80106092:	29 de                	sub    %ebx,%esi
80106094:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
8010609a:	76 b1                	jbe    8010604d <loaduvm+0x36>
      n = PGSIZE;
8010609c:	be 00 10 00 00       	mov    $0x1000,%esi
801060a1:	eb aa                	jmp    8010604d <loaduvm+0x36>
      return -1;
  }
  return 0;
...
801060b5:	eb f1                	jmp    801060a8 <loaduvm+0x91>
...
801060ba:	57                   	push   %edi
801060bb:	56                   	push   %esi
801060bc:	53                   	push   %ebx
801060bd:	83 ec 0c             	sub    $0xc,%esp
801060c0:	8b 7d 0c             	mov    0xc(%ebp),%edi
  pte_t *pte;
  uint a, pa;

  if(newsz >= oldsz)
801060c3:	39 7d 10             	cmp    %edi,0x10(%ebp)
801060c6:	73 11                	jae    801060d9 <deallocuvm+0x22>
    return oldsz;

  a = PGROUNDUP(newsz);
801060c8:	8b 45 10             	mov    0x10(%ebp),%eax
801060cb:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
801060d1:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a  < oldsz; a += PGSIZE){
801060d7:	eb 19                	jmp    801060f2 <deallocuvm+0x3b>
    return oldsz;
801060d9:	89 f8                	mov    %edi,%eax
801060db:	eb 64                	jmp    80106141 <deallocuvm+0x8a>
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
801060dd:	c1 eb 16             	shr    $0x16,%ebx
801060e0:	83 c3 01             	add    $0x1,%ebx
801060e3:	c1 e3 16             	shl    $0x16,%ebx
801060e6:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
  for(; a  < oldsz; a += PGSIZE){
801060ec:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801060f2:	39 fb                	cmp    %edi,%ebx
801060f4:	73 48                	jae    8010613e <deallocuvm+0x87>
    pte = walkpgdir(pgdir, (char*)a, 0);
801060f6:	b9 00 00 00 00       	mov    $0x0,%ecx
801060fb:	89 da                	mov    %ebx,%edx
801060fd:	8b 45 08             	mov    0x8(%ebp),%eax
80106100:	e8 4d fb ff ff       	call   80105c52 <walkpgdir>
80106105:	89 c6                	mov    %eax,%esi
    if(!pte)
80106107:	85 c0                	test   %eax,%eax
80106109:	74 d2                	je     801060dd <deallocuvm+0x26>
    else if((*pte & PTE_P) != 0){
8010610b:	8b 00                	mov    (%eax),%eax
8010610d:	a8 01                	test   $0x1,%al
8010610f:	74 db                	je     801060ec <deallocuvm+0x35>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
80106111:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106116:	74 19                	je     80106131 <deallocuvm+0x7a>
        panic("kfree");
      char *v = P2V(pa);
80106118:	05 00 00 00 80       	add    $0x80000000,%eax
      kfree(v);
8010611d:	83 ec 0c             	sub    $0xc,%esp
80106120:	50                   	push   %eax
80106121:	e8 7e be ff ff       	call   80101fa4 <kfree>
      *pte = 0;
80106126:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
8010612c:	83 c4 10             	add    $0x10,%esp
8010612f:	eb bb                	jmp    801060ec <deallocuvm+0x35>
        panic("kfree");
80106131:	83 ec 0c             	sub    $0xc,%esp
80106134:	68 66 67 10 80       	push   $0x80106766
...
8010614c:	57                   	push   %edi
8010614d:	56                   	push   %esi
8010614e:	53                   	push   %ebx
8010614f:	83 ec 1c             	sub    $0x1c,%esp
80106152:	8b 7d 10             	mov    0x10(%ebp),%edi
  if(newsz >= KERNBASE)
80106155:	89 7d e4             	mov    %edi,-0x1c(%ebp)
80106158:	85 ff                	test   %edi,%edi
8010615a:	0f 88 c1 00 00 00    	js     80106221 <allocuvm+0xd8>
  if(newsz < oldsz)
80106160:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106163:	72 5c                	jb     801061c1 <allocuvm+0x78>
  a = PGROUNDUP(oldsz);
80106165:	8b 45 0c             	mov    0xc(%ebp),%eax
80106168:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
8010616e:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a < newsz; a += PGSIZE){
80106174:	39 fb                	cmp    %edi,%ebx
80106176:	0f 83 ac 00 00 00    	jae    80106228 <allocuvm+0xdf>
    mem = kalloc();
8010617c:	e8 3a bf ff ff       	call   801020bb <kalloc>
80106181:	89 c6                	mov    %eax,%esi
    if(mem == 0){
80106183:	85 c0                	test   %eax,%eax
80106185:	74 42                	je     801061c9 <allocuvm+0x80>
    memset(mem, 0, PGSIZE);
80106187:	83 ec 04             	sub    $0x4,%esp
8010618a:	68 00 10 00 00       	push   $0x1000
8010618f:	6a 00                	push   $0x0
80106191:	50                   	push   %eax
80106192:	e8 25 db ff ff       	call   80103cbc <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80106197:	83 c4 08             	add    $0x8,%esp
8010619a:	6a 06                	push   $0x6
8010619c:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
801061a2:	50                   	push   %eax
801061a3:	b9 00 10 00 00       	mov    $0x1000,%ecx
801061a8:	89 da                	mov    %ebx,%edx
801061aa:	8b 45 08             	mov    0x8(%ebp),%eax
801061ad:	e8 10 fb ff ff       	call   80105cc2 <mappages>
801061b2:	83 c4 10             	add    $0x10,%esp
801061b5:	85 c0                	test   %eax,%eax
801061b7:	78 38                	js     801061f1 <allocuvm+0xa8>
  for(; a < newsz; a += PGSIZE){
801061b9:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801061bf:	eb b3                	jmp    80106174 <allocuvm+0x2b>
    return oldsz;
801061c1:	8b 45 0c             	mov    0xc(%ebp),%eax
801061c4:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801061c7:	eb 5f                	jmp    80106228 <allocuvm+0xdf>
      cprintf("allocuvm out of memory\n");
801061c9:	83 ec 0c             	sub    $0xc,%esp
801061cc:	68 4d 6e 10 80       	push   $0x80106e4d
801061d1:	e8 35 a4 ff ff       	call   8010060b <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
801061d6:	83 c4 0c             	add    $0xc,%esp
801061d9:	ff 75 0c             	pushl  0xc(%ebp)
801061dc:	57                   	push   %edi
801061dd:	ff 75 08             	pushl  0x8(%ebp)
801061e0:	e8 d2 fe ff ff       	call   801060b7 <deallocuvm>
      return 0;
801061e5:	83 c4 10             	add    $0x10,%esp
801061e8:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
801061ef:	eb 37                	jmp    80106228 <allocuvm+0xdf>
      cprintf("allocuvm out of memory (2)\n");
801061f1:	83 ec 0c             	sub    $0xc,%esp
801061f4:	68 65 6e 10 80       	push   $0x80106e65
801061f9:	e8 0d a4 ff ff       	call   8010060b <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
801061fe:	83 c4 0c             	add    $0xc,%esp
80106201:	ff 75 0c             	pushl  0xc(%ebp)
80106204:	57                   	push   %edi
80106205:	ff 75 08             	pushl  0x8(%ebp)
80106208:	e8 aa fe ff ff       	call   801060b7 <deallocuvm>
      kfree(mem);
8010620d:	89 34 24             	mov    %esi,(%esp)
80106210:	e8 8f bd ff ff       	call   80101fa4 <kfree>
      return 0;
80106215:	83 c4 10             	add    $0x10,%esp
80106218:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
8010621f:	eb 07                	jmp    80106228 <allocuvm+0xdf>
    return 0;
80106221:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
}
...
80106238:	8b 75 08             	mov    0x8(%ebp),%esi
  uint i;

  if(pgdir == 0)
8010623b:	85 f6                	test   %esi,%esi
8010623d:	74 1a                	je     80106259 <freevm+0x26>
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
8010623f:	83 ec 04             	sub    $0x4,%esp
80106242:	6a 00                	push   $0x0
80106244:	68 00 00 00 80       	push   $0x80000000
80106249:	56                   	push   %esi
8010624a:	e8 68 fe ff ff       	call   801060b7 <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
8010624f:	83 c4 10             	add    $0x10,%esp
80106252:	bb 00 00 00 00       	mov    $0x0,%ebx
80106257:	eb 10                	jmp    80106269 <freevm+0x36>
    panic("freevm: no pgdir");
80106259:	83 ec 0c             	sub    $0xc,%esp
8010625c:	68 81 6e 10 80       	push   $0x80106e81
80106261:	e8 e2 a0 ff ff       	call   80100348 <panic>
  for(i = 0; i < NPDENTRIES; i++){
80106266:	83 c3 01             	add    $0x1,%ebx
80106269:	81 fb ff 03 00 00    	cmp    $0x3ff,%ebx
8010626f:	77 1f                	ja     80106290 <freevm+0x5d>
    if(pgdir[i] & PTE_P){
80106271:	8b 04 9e             	mov    (%esi,%ebx,4),%eax
80106274:	a8 01                	test   $0x1,%al
80106276:	74 ee                	je     80106266 <freevm+0x33>
      char * v = P2V(PTE_ADDR(pgdir[i]));
80106278:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010627d:	05 00 00 00 80       	add    $0x80000000,%eax
      kfree(v);
80106282:	83 ec 0c             	sub    $0xc,%esp
80106285:	50                   	push   %eax
80106286:	e8 19 bd ff ff       	call   80101fa4 <kfree>
8010628b:	83 c4 10             	add    $0x10,%esp
8010628e:	eb d6                	jmp    80106266 <freevm+0x33>
    }
  }
  kfree((char*)pgdir);
80106290:	83 ec 0c             	sub    $0xc,%esp
80106293:	56                   	push   %esi
80106294:	e8 0b bd ff ff       	call   80101fa4 <kfree>
}
...
801062a8:	e8 0e be ff ff       	call   801020bb <kalloc>
801062ad:	89 c6                	mov    %eax,%esi
801062af:	85 c0                	test   %eax,%eax
801062b1:	74 55                	je     80106308 <setupkvm+0x65>
  memset(pgdir, 0, PGSIZE);
801062b3:	83 ec 04             	sub    $0x4,%esp
801062b6:	68 00 10 00 00       	push   $0x1000
801062bb:	6a 00                	push   $0x0
801062bd:	50                   	push   %eax
801062be:	e8 f9 d9 ff ff       	call   80103cbc <memset>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
801062c3:	83 c4 10             	add    $0x10,%esp
801062c6:	bb 20 94 10 80       	mov    $0x80109420,%ebx
801062cb:	81 fb 60 94 10 80    	cmp    $0x80109460,%ebx
801062d1:	73 35                	jae    80106308 <setupkvm+0x65>
                (uint)k->phys_start, k->perm) < 0) {
801062d3:	8b 43 04             	mov    0x4(%ebx),%eax
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
801062d6:	8b 4b 08             	mov    0x8(%ebx),%ecx
801062d9:	29 c1                	sub    %eax,%ecx
801062db:	83 ec 08             	sub    $0x8,%esp
801062de:	ff 73 0c             	pushl  0xc(%ebx)
801062e1:	50                   	push   %eax
801062e2:	8b 13                	mov    (%ebx),%edx
801062e4:	89 f0                	mov    %esi,%eax
801062e6:	e8 d7 f9 ff ff       	call   80105cc2 <mappages>
801062eb:	83 c4 10             	add    $0x10,%esp
801062ee:	85 c0                	test   %eax,%eax
801062f0:	78 05                	js     801062f7 <setupkvm+0x54>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
801062f2:	83 c3 10             	add    $0x10,%ebx
801062f5:	eb d4                	jmp    801062cb <setupkvm+0x28>
      freevm(pgdir);
801062f7:	83 ec 0c             	sub    $0xc,%esp
801062fa:	56                   	push   %esi
801062fb:	e8 33 ff ff ff       	call   80106233 <freevm>
      return 0;
80106300:	83 c4 10             	add    $0x10,%esp
80106303:	be 00 00 00 00       	mov    $0x0,%esi
}
80106308:	89 f0                	mov    %esi,%eax
8010630a:	8d 65 f8             	lea    -0x8(%ebp),%esp
8010630d:	5b                   	pop    %ebx
8010630e:	5e                   	pop    %esi
8010630f:	5d                   	pop    %ebp
80106310:	c3                   	ret    
...
80106314:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80106317:	e8 87 ff ff ff       	call   801062a3 <setupkvm>
8010631c:	a3 a4 44 11 80       	mov    %eax,0x801144a4
  switchkvm();
80106321:	e8 5e fb ff ff       	call   80105e84 <switchkvm>
}
80106326:	c9                   	leave  
80106327:	c3                   	ret    
...
80106333:	8b 55 0c             	mov    0xc(%ebp),%edx
80106336:	8b 45 08             	mov    0x8(%ebp),%eax
80106339:	e8 14 f9 ff ff       	call   80105c52 <walkpgdir>
  if(pte == 0)
8010633e:	85 c0                	test   %eax,%eax
80106340:	74 05                	je     80106347 <clearpteu+0x1f>
    panic("clearpteu");
  *pte &= ~PTE_U;
80106342:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
80106345:	c9                   	leave  
80106346:	c3                   	ret    
    panic("clearpteu");
80106347:	83 ec 0c             	sub    $0xc,%esp
8010634a:	68 92 6e 10 80       	push   $0x80106e92
8010634f:	e8 f4 9f ff ff       	call   80100348 <panic>
...
8010635a:	83 ec 1c             	sub    $0x1c,%esp
  ...
  if((d = setupkvm()) == 0)
8010635d:	e8 41 ff ff ff       	call   801062a3 <setupkvm>
80106362:	89 45 dc             	mov    %eax,-0x24(%ebp)
80106365:	85 c0                	test   %eax,%eax
80106367:	0f 84 c4 00 00 00    	je     80106431 <copyuvm+0xdd>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
8010636d:	bf 00 00 00 00       	mov    $0x0,%edi
80106372:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106375:	0f 83 b6 00 00 00    	jae    80106431 <copyuvm+0xdd>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
8010637b:	89 7d e4             	mov    %edi,-0x1c(%ebp)
8010637e:	b9 00 00 00 00       	mov    $0x0,%ecx
80106383:	89 fa                	mov    %edi,%edx
80106385:	8b 45 08             	mov    0x8(%ebp),%eax
80106388:	e8 c5 f8 ff ff       	call   80105c52 <walkpgdir>
8010638d:	85 c0                	test   %eax,%eax
8010638f:	74 65                	je     801063f6 <copyuvm+0xa2>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80106391:	8b 00                	mov    (%eax),%eax
80106393:	a8 01                	test   $0x1,%al
80106395:	74 6c                	je     80106403 <copyuvm+0xaf>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106397:	89 c6                	mov    %eax,%esi
80106399:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    flags = PTE_FLAGS(*pte);
8010639f:	25 ff 0f 00 00       	and    $0xfff,%eax
801063a4:	89 45 e0             	mov    %eax,-0x20(%ebp)
    if((mem = kalloc()) == 0)
801063a7:	e8 0f bd ff ff       	call   801020bb <kalloc>
801063ac:	89 c3                	mov    %eax,%ebx
801063ae:	85 c0                	test   %eax,%eax
801063b0:	74 6a                	je     8010641c <copyuvm+0xc8>
      goto bad;
    memmove(mem, (char*)P2V(pa), PGSIZE);
801063b2:	81 c6 00 00 00 80    	add    $0x80000000,%esi
801063b8:	83 ec 04             	sub    $0x4,%esp
801063bb:	68 00 10 00 00       	push   $0x1000
801063c0:	56                   	push   %esi
801063c1:	50                   	push   %eax
801063c2:	e8 70 d9 ff ff       	call   80103d37 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
801063c7:	83 c4 08             	add    $0x8,%esp
801063ca:	ff 75 e0             	pushl  -0x20(%ebp)
801063cd:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
801063d3:	50                   	push   %eax
801063d4:	b9 00 10 00 00       	mov    $0x1000,%ecx
801063d9:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801063dc:	8b 45 dc             	mov    -0x24(%ebp),%eax
801063df:	e8 de f8 ff ff       	call   80105cc2 <mappages>
801063e4:	83 c4 10             	add    $0x10,%esp
801063e7:	85 c0                	test   %eax,%eax
801063e9:	78 25                	js     80106410 <copyuvm+0xbc>
  for(i = 0; i < sz; i += PGSIZE){
801063eb:	81 c7 00 10 00 00    	add    $0x1000,%edi
801063f1:	e9 7c ff ff ff       	jmp    80106372 <copyuvm+0x1e>
      panic("copyuvm: pte should exist");
801063f6:	83 ec 0c             	sub    $0xc,%esp
801063f9:	68 9c 6e 10 80       	push   $0x80106e9c
801063fe:	e8 45 9f ff ff       	call   80100348 <panic>
      panic("copyuvm: page not present");
80106403:	83 ec 0c             	sub    $0xc,%esp
80106406:	68 b6 6e 10 80       	push   $0x80106eb6
8010640b:	e8 38 9f ff ff       	call   80100348 <panic>
      kfree(mem);
80106410:	83 ec 0c             	sub    $0xc,%esp
80106413:	53                   	push   %ebx
80106414:	e8 8b bb ff ff       	call   80101fa4 <kfree>
      goto bad;
...
8010641f:	ff 75 dc             	pushl  -0x24(%ebp)
80106422:	e8 0c fe ff ff       	call   80106233 <freevm>
  return 0;
80106427:	83 c4 10             	add    $0x10,%esp
8010642a:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%ebp)
}
...
8010643f:	83 ec 08             	sub    $0x8,%esp
  ...
  pte = walkpgdir(pgdir, uva, 0);
80106442:	b9 00 00 00 00       	mov    $0x0,%ecx
80106447:	8b 55 0c             	mov    0xc(%ebp),%edx
8010644a:	8b 45 08             	mov    0x8(%ebp),%eax
8010644d:	e8 00 f8 ff ff       	call   80105c52 <walkpgdir>
  if((*pte & PTE_P) == 0)
80106452:	8b 00                	mov    (%eax),%eax
80106454:	a8 01                	test   $0x1,%al
80106456:	74 10                	je     80106468 <uva2ka+0x2c>
    return 0;
  if((*pte & PTE_U) == 0)
80106458:	a8 04                	test   $0x4,%al
8010645a:	74 13                	je     8010646f <uva2ka+0x33>
    return 0;
  return (char*)P2V(PTE_ADDR(*pte));
8010645c:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106461:	05 00 00 00 80       	add    $0x80000000,%eax
}
80106466:	c9                   	leave  
80106467:	c3                   	ret    
    return 0;
80106468:	b8 00 00 00 00       	mov    $0x0,%eax
8010646d:	eb f7                	jmp    80106466 <uva2ka+0x2a>
    return 0;
8010646f:	b8 00 00 00 00       	mov    $0x0,%eax
80106474:	eb f0                	jmp    80106466 <uva2ka+0x2a>
...
8010647f:	8b 7d 14             	mov    0x14(%ebp),%edi
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
  while(len > 0){
80106482:	eb 25                	jmp    801064a9 <copyout+0x33>
    if(pa0 == 0)
      return -1;
    n = PGSIZE - (va - va0);
    if(n > len)
...
80106484:	8b 55 0c             	mov    0xc(%ebp),%edx
80106487:	29 f2                	sub    %esi,%edx
80106489:	01 d0                	add    %edx,%eax
8010648b:	83 ec 04             	sub    $0x4,%esp
8010648e:	53                   	push   %ebx
8010648f:	ff 75 10             	pushl  0x10(%ebp)
80106492:	50                   	push   %eax
80106493:	e8 9f d8 ff ff       	call   80103d37 <memmove>
    len -= n;
80106498:	29 df                	sub    %ebx,%edi
    buf += n;
8010649a:	01 5d 10             	add    %ebx,0x10(%ebp)
    va = va0 + PGSIZE;
8010649d:	8d 86 00 10 00 00    	lea    0x1000(%esi),%eax
801064a3:	89 45 0c             	mov    %eax,0xc(%ebp)
801064a6:	83 c4 10             	add    $0x10,%esp
  while(len > 0){
801064a9:	85 ff                	test   %edi,%edi
801064ab:	74 2f                	je     801064dc <copyout+0x66>
    va0 = (uint)PGROUNDDOWN(va);
801064ad:	8b 75 0c             	mov    0xc(%ebp),%esi
801064b0:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    pa0 = uva2ka(pgdir, (char*)va0);
801064b6:	83 ec 08             	sub    $0x8,%esp
801064b9:	56                   	push   %esi
801064ba:	ff 75 08             	pushl  0x8(%ebp)
801064bd:	e8 7a ff ff ff       	call   8010643c <uva2ka>
    if(pa0 == 0)
801064c2:	83 c4 10             	add    $0x10,%esp
801064c5:	85 c0                	test   %eax,%eax
801064c7:	74 20                	je     801064e9 <copyout+0x73>
    n = PGSIZE - (va - va0);
801064c9:	89 f3                	mov    %esi,%ebx
801064cb:	2b 5d 0c             	sub    0xc(%ebp),%ebx
801064ce:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    if(n > len)
801064d4:	39 df                	cmp    %ebx,%edi
801064d6:	73 ac                	jae    80106484 <copyout+0xe>
      n = len;
801064d8:	89 fb                	mov    %edi,%ebx
801064da:	eb a8                	jmp    80106484 <copyout+0xe>
  }
  return 0;
...
801064ee:	eb f1                	jmp    801064e1 <copyout+0x6b>
